...
func (*GetKeywordPlanNegativeKeywordRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2704c37385d6e1d, []int{0}
}
...
func (*MutateKeywordPlanNegativeKeywordsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2704c37385d6e1d, []int{1}
}
...
func (*KeywordPlanNegativeKeywordOperation) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2704c37385d6e1d, []int{2}
}
...
func (*MutateKeywordPlanNegativeKeywordResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2704c37385d6e1d, []int{4}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/services/keyword_plan_negative_keyword_service.proto", fileDescriptor_c2704c37385d6e1d)
}

var fileDescriptor_c2704c37385d6e1d = []byte{
