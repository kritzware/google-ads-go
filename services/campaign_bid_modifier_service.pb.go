...
func (*GetCampaignBidModifierRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_227574695be179d3, []int{0}
}
...
func (*MutateCampaignBidModifiersRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_227574695be179d3, []int{1}
}
...
func (*CampaignBidModifierOperation) Descriptor() ([]byte, []int) {
	return fileDescriptor_227574695be179d3, []int{2}
}
...
func (*MutateCampaignBidModifiersResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_227574695be179d3, []int{3}
}
...
func (*MutateCampaignBidModifierResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_227574695be179d3, []int{4}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/services/campaign_bid_modifier_service.proto", fileDescriptor_227574695be179d3)
}

var fileDescriptor_227574695be179d3 = []byte{
	...
	0xa8, 0xb2, 0xb0, 0xa3, 0x20, 0x55, 0xe0, 0xaa, 0x45, 0x49, 0x43, 0x5a, 0x16, 0xa5, 0x95, 0x2b,
	...
	0x48, 0x9d, 0x9a, 0xab, 0x8c, 0x07, 0x00, 0x00,
}
