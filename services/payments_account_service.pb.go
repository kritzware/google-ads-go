...
func (*ListPaymentsAccountsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_96814700bec85f02, []int{0}
}
...
func (*ListPaymentsAccountsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_96814700bec85f02, []int{1}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/services/payments_account_service.proto", fileDescriptor_96814700bec85f02)
}

var fileDescriptor_96814700bec85f02 = []byte{
