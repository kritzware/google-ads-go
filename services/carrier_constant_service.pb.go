...
func (*GetCarrierConstantRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_164c2a8d453c09ac, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/services/carrier_constant_service.proto", fileDescriptor_164c2a8d453c09ac)
}

var fileDescriptor_164c2a8d453c09ac = []byte{
