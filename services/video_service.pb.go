...
func (*GetVideoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2ee6a22992bacdf1, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/services/video_service.proto", fileDescriptor_2ee6a22992bacdf1)
}

var fileDescriptor_2ee6a22992bacdf1 = []byte{
