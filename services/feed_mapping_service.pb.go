...
func (*GetFeedMappingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_d7c84dba701fbea6, []int{0}
}
...
func (*MutateFeedMappingsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_d7c84dba701fbea6, []int{1}
}
...
func (*FeedMappingOperation) Descriptor() ([]byte, []int) {
	return fileDescriptor_d7c84dba701fbea6, []int{2}
}
...
func (*MutateFeedMappingsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_d7c84dba701fbea6, []int{3}
}
...
func (*MutateFeedMappingResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_d7c84dba701fbea6, []int{4}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/services/feed_mapping_service.proto", fileDescriptor_d7c84dba701fbea6)
}

var fileDescriptor_d7c84dba701fbea6 = []byte{
