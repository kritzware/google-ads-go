...
func (*SuggestGeoTargetConstantsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_23d864cb9b62df7f, []int{1}
}
...
func (*SuggestGeoTargetConstantsRequest_LocationNames) Descriptor() ([]byte, []int) {
	return fileDescriptor_23d864cb9b62df7f, []int{1, 0}
}
...
func (*SuggestGeoTargetConstantsRequest_GeoTargets) Descriptor() ([]byte, []int) {
	return fileDescriptor_23d864cb9b62df7f, []int{1, 1}
}
...
func (*SuggestGeoTargetConstantsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_23d864cb9b62df7f, []int{2}
}
...
func (*GeoTargetConstantSuggestion) Descriptor() ([]byte, []int) {
	return fileDescriptor_23d864cb9b62df7f, []int{3}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/services/geo_target_constant_service.proto", fileDescriptor_23d864cb9b62df7f)
}
