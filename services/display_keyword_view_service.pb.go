...
func (*GetDisplayKeywordViewRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_6b85310d2a54b119, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/services/display_keyword_view_service.proto", fileDescriptor_6b85310d2a54b119)
}

var fileDescriptor_6b85310d2a54b119 = []byte{
