...
func (*GetConversionActionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd4d3c7256f86493, []int{0}
}
...
func (*MutateConversionActionsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd4d3c7256f86493, []int{1}
}
...
func (*ConversionActionOperation) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd4d3c7256f86493, []int{2}
}
...
func (*MutateConversionActionsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd4d3c7256f86493, []int{3}
}
...
func (*MutateConversionActionResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_cd4d3c7256f86493, []int{4}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/services/conversion_action_service.proto", fileDescriptor_cd4d3c7256f86493)
}

var fileDescriptor_cd4d3c7256f86493 = []byte{
