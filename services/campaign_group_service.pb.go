...
func (*GetCampaignGroupRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_6a272eaae6a7e6ab, []int{0}
}
...
func (m *GetCampaignGroupRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetCampaignGroupRequest.Merge(m, src)
}
...
func (*MutateCampaignGroupsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_6a272eaae6a7e6ab, []int{1}
}
...
func (m *MutateCampaignGroupsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MutateCampaignGroupsRequest.Merge(m, src)
}
...
func (*CampaignGroupOperation) Descriptor() ([]byte, []int) {
	return fileDescriptor_6a272eaae6a7e6ab, []int{2}
}
...
func (m *CampaignGroupOperation) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CampaignGroupOperation.Merge(m, src)
}
...
func (*CampaignGroupOperation) XXX_OneofWrappers() []interface{} {
	return []interface{}{
...
func (*MutateCampaignGroupsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_6a272eaae6a7e6ab, []int{3}
}
...
func (m *MutateCampaignGroupsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MutateCampaignGroupsResponse.Merge(m, src)
}
...
func (*MutateCampaignGroupResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_6a272eaae6a7e6ab, []int{4}
}
...
func (m *MutateCampaignGroupResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MutateCampaignGroupResult.Merge(m, src)
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/services/campaign_group_service.proto", fileDescriptor_6a272eaae6a7e6ab)
}

var fileDescriptor_6a272eaae6a7e6ab = []byte{
