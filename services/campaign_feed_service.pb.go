...
func (*GetCampaignFeedRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_69b5d88eaf42f828, []int{0}
}
...
func (*MutateCampaignFeedsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_69b5d88eaf42f828, []int{1}
}
...
func (*CampaignFeedOperation) Descriptor() ([]byte, []int) {
	return fileDescriptor_69b5d88eaf42f828, []int{2}
}
...
func (*MutateCampaignFeedsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_69b5d88eaf42f828, []int{3}
}
...
func (*MutateCampaignFeedResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_69b5d88eaf42f828, []int{4}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/services/campaign_feed_service.proto", fileDescriptor_69b5d88eaf42f828)
}

var fileDescriptor_69b5d88eaf42f828 = []byte{
