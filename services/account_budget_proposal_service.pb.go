...
func (*GetAccountBudgetProposalRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2e2341ef83736973, []int{0}
}
...
func (*MutateAccountBudgetProposalRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2e2341ef83736973, []int{1}
}
...
func (*AccountBudgetProposalOperation) Descriptor() ([]byte, []int) {
	return fileDescriptor_2e2341ef83736973, []int{2}
}
...
func (*MutateAccountBudgetProposalResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2e2341ef83736973, []int{3}
}
...
func (*MutateAccountBudgetProposalResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_2e2341ef83736973, []int{4}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/services/account_budget_proposal_service.proto", fileDescriptor_2e2341ef83736973)
}

var fileDescriptor_2e2341ef83736973 = []byte{
