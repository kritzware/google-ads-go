...
func (*GetManagedPlacementViewRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_c976472217c9816d, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/services/managed_placement_view_service.proto", fileDescriptor_c976472217c9816d)
}

var fileDescriptor_c976472217c9816d = []byte{
