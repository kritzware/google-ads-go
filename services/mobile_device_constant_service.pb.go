...
func (*GetMobileDeviceConstantRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_b4998404df0bc53d, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/services/mobile_device_constant_service.proto", fileDescriptor_b4998404df0bc53d)
}

var fileDescriptor_b4998404df0bc53d = []byte{
