...
func (*GetMediaFileRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_63ec2e89ded4bf2d, []int{0}
}
...
func (*MutateMediaFilesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_63ec2e89ded4bf2d, []int{1}
}
...
func (*MediaFileOperation) Descriptor() ([]byte, []int) {
	return fileDescriptor_63ec2e89ded4bf2d, []int{2}
}
...
func (*MutateMediaFilesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_63ec2e89ded4bf2d, []int{3}
}
...
func (*MutateMediaFileResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_63ec2e89ded4bf2d, []int{4}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/services/media_file_service.proto", fileDescriptor_63ec2e89ded4bf2d)
}

var fileDescriptor_63ec2e89ded4bf2d = []byte{
	...
	0xaa, 0xa8, 0x1a, 0x47, 0xa1, 0x08, 0x75, 0xa0, 0x8b, 0x54, 0x22, 0x2d, 0x8b, 0xd2, 0xe2, 0xa2,
	...
	0x8c, 0x0d, 0x6c, 0x7f, 0xaa, 0xd0, 0xf9, 0xe8, 0x6f, 0x00, 0x00, 0x00, 0xff, 0xff, 0xab, 0x4d,
	0x6f, 0xab, 0xf6, 0x05, 0x00, 0x00,
}
