...
func (*GetKeywordPlanCampaignRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_8220678e6fd79d75, []int{0}
}
...
func (*MutateKeywordPlanCampaignsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_8220678e6fd79d75, []int{1}
}
...
func (*KeywordPlanCampaignOperation) Descriptor() ([]byte, []int) {
	return fileDescriptor_8220678e6fd79d75, []int{2}
}
...
func (*MutateKeywordPlanCampaignsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_8220678e6fd79d75, []int{3}
}
...
func (*MutateKeywordPlanCampaignResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_8220678e6fd79d75, []int{4}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/services/keyword_plan_campaign_service.proto", fileDescriptor_8220678e6fd79d75)
}

var fileDescriptor_8220678e6fd79d75 = []byte{
