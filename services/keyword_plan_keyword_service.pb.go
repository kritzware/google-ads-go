...
func (*GetKeywordPlanKeywordRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_dca713fb41d8bdf4, []int{0}
}
...
func (*MutateKeywordPlanKeywordsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_dca713fb41d8bdf4, []int{1}
}
...
func (*KeywordPlanKeywordOperation) Descriptor() ([]byte, []int) {
	return fileDescriptor_dca713fb41d8bdf4, []int{2}
}
...
func (*MutateKeywordPlanKeywordsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_dca713fb41d8bdf4, []int{3}
}
...
func (*MutateKeywordPlanKeywordResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_dca713fb41d8bdf4, []int{4}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/services/keyword_plan_keyword_service.proto", fileDescriptor_dca713fb41d8bdf4)
}

var fileDescriptor_dca713fb41d8bdf4 = []byte{
