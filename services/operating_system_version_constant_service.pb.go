...
func (*GetOperatingSystemVersionConstantRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ad4f6e4a90acd1fa, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/services/operating_system_version_constant_service.proto", fileDescriptor_ad4f6e4a90acd1fa)
}

var fileDescriptor_ad4f6e4a90acd1fa = []byte{
