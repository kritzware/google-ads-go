...
func (*MutateGoogleAdsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_faa7999714db141e, []int{3}
}
...
func (*MutateGoogleAdsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_faa7999714db141e, []int{4}
}
...
func (*MutateOperation) Descriptor() ([]byte, []int) {
	return fileDescriptor_faa7999714db141e, []int{5}
}
...
func (*MutateOperationResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_faa7999714db141e, []int{6}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/services/google_ads_service.proto", fileDescriptor_faa7999714db141e)
}
