...
func (*GetCustomerClientRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_2b33c9cfe3e4a708, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/services/customer_client_service.proto", fileDescriptor_2b33c9cfe3e4a708)
}

var fileDescriptor_2b33c9cfe3e4a708 = []byte{
