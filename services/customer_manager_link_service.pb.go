...
func (*GetCustomerManagerLinkRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_d050eece4407d018, []int{0}
}
...
func (*MutateCustomerManagerLinkRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_d050eece4407d018, []int{1}
}
...
func (*CustomerManagerLinkOperation) Descriptor() ([]byte, []int) {
	return fileDescriptor_d050eece4407d018, []int{2}
}
...
func (*MutateCustomerManagerLinkResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_d050eece4407d018, []int{3}
}
...
func (*MutateCustomerManagerLinkResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_d050eece4407d018, []int{4}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/services/customer_manager_link_service.proto", fileDescriptor_d050eece4407d018)
}

var fileDescriptor_d050eece4407d018 = []byte{
	...
	0x93, 0x52, 0x61, 0xd1, 0x2c, 0xad, 0xa4, 0x5b, 0xb6, 0x2b, 0x58, 0x2d, 0x11, 0x7a, 0xd0, 0x62,
	...
	0x29, 0xd3, 0x4e, 0x77, 0x32, 0x9e, 0x8f, 0xfe, 0x04, 0x00, 0x00, 0xff, 0xff, 0xeb, 0x83, 0x9a,
	0xe4, 0x4c, 0x06, 0x00, 0x00,
}
