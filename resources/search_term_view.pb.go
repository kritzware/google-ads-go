...
func (*SearchTermView) Descriptor() ([]byte, []int) {
	return fileDescriptor_44c47ef1e53d88b1, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/resources/search_term_view.proto", fileDescriptor_44c47ef1e53d88b1)
}

var fileDescriptor_44c47ef1e53d88b1 = []byte{
