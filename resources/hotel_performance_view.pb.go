...
func (*HotelPerformanceView) Descriptor() ([]byte, []int) {
	return fileDescriptor_52df0ab1166e0bdf, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/resources/hotel_performance_view.proto", fileDescriptor_52df0ab1166e0bdf)
}

var fileDescriptor_52df0ab1166e0bdf = []byte{
