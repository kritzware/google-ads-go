...
func (*CampaignSharedSet) Descriptor() ([]byte, []int) {
	return fileDescriptor_b4aed57a5a46faa4, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/resources/campaign_shared_set.proto", fileDescriptor_b4aed57a5a46faa4)
}

var fileDescriptor_b4aed57a5a46faa4 = []byte{
