...
func (*CampaignGroup) Descriptor() ([]byte, []int) {
	return fileDescriptor_1f3f3cdee3ac4c68, []int{0}
}
...
func (m *CampaignGroup) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CampaignGroup.Merge(m, src)
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/resources/campaign_group.proto", fileDescriptor_1f3f3cdee3ac4c68)
}

var fileDescriptor_1f3f3cdee3ac4c68 = []byte{
