...
func (*ProductGroupView) Descriptor() ([]byte, []int) {
	return fileDescriptor_a1f6f8d3b3fdbada, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/resources/product_group_view.proto", fileDescriptor_a1f6f8d3b3fdbada)
}

var fileDescriptor_a1f6f8d3b3fdbada = []byte{
