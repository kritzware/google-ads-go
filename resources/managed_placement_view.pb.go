...
func (*ManagedPlacementView) Descriptor() ([]byte, []int) {
	return fileDescriptor_b66b40c4713c533c, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/resources/managed_placement_view.proto", fileDescriptor_b66b40c4713c533c)
}

var fileDescriptor_b66b40c4713c533c = []byte{
