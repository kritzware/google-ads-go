...
func (*MobileAppCategoryConstant) Descriptor() ([]byte, []int) {
	return fileDescriptor_900bf8ccc40dca73, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/resources/mobile_app_category_constant.proto", fileDescriptor_900bf8ccc40dca73)
}

var fileDescriptor_900bf8ccc40dca73 = []byte{
