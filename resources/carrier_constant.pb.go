...
func (*CarrierConstant) Descriptor() ([]byte, []int) {
	return fileDescriptor_50a29f5128b2c415, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/resources/carrier_constant.proto", fileDescriptor_50a29f5128b2c415)
}

var fileDescriptor_50a29f5128b2c415 = []byte{
