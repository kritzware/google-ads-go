...
func (*TopicView) Descriptor() ([]byte, []int) {
	return fileDescriptor_4ca8d4429105b54b, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/resources/topic_view.proto", fileDescriptor_4ca8d4429105b54b)
}

var fileDescriptor_4ca8d4429105b54b = []byte{
