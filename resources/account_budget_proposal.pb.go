...
func (*AccountBudgetProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_cb6985c08ac24958, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/resources/account_budget_proposal.proto", fileDescriptor_cb6985c08ac24958)
}

var fileDescriptor_cb6985c08ac24958 = []byte{
