...
func (*BillingSetup) Descriptor() ([]byte, []int) {
	return fileDescriptor_1b091bf330203108, []int{0}
}
...
func (*BillingSetup_PaymentsAccountInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_1b091bf330203108, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/resources/billing_setup.proto", fileDescriptor_1b091bf330203108)
}

var fileDescriptor_1b091bf330203108 = []byte{
