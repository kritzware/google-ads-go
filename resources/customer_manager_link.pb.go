...
func (*CustomerManagerLink) Descriptor() ([]byte, []int) {
	return fileDescriptor_c8877a11674449b3, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/resources/customer_manager_link.proto", fileDescriptor_c8877a11674449b3)
}

var fileDescriptor_c8877a11674449b3 = []byte{
