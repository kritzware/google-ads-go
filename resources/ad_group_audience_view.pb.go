...
func (*AdGroupAudienceView) Descriptor() ([]byte, []int) {
	return fileDescriptor_a94b3f24f2b801e0, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/resources/ad_group_audience_view.proto", fileDescriptor_a94b3f24f2b801e0)
}

var fileDescriptor_a94b3f24f2b801e0 = []byte{
