...
func (*UserInterest) Descriptor() ([]byte, []int) {
	return fileDescriptor_0e4da83d83489504, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/resources/user_interest.proto", fileDescriptor_0e4da83d83489504)
}

var fileDescriptor_0e4da83d83489504 = []byte{
