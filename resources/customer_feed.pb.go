...
func (*CustomerFeed) Descriptor() ([]byte, []int) {
	return fileDescriptor_afed318f4e69406c, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/resources/customer_feed.proto", fileDescriptor_afed318f4e69406c)
}

var fileDescriptor_afed318f4e69406c = []byte{
