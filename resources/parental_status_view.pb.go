...
func (*ParentalStatusView) Descriptor() ([]byte, []int) {
	return fileDescriptor_ae1d6e6376638f3a, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/resources/parental_status_view.proto", fileDescriptor_ae1d6e6376638f3a)
}

var fileDescriptor_ae1d6e6376638f3a = []byte{
