...
func (*CampaignAudienceView) Descriptor() ([]byte, []int) {
	return fileDescriptor_b049d416bcdf58b4, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/resources/campaign_audience_view.proto", fileDescriptor_b049d416bcdf58b4)
}

var fileDescriptor_b049d416bcdf58b4 = []byte{
