...
func (*AccountBudget) Descriptor() ([]byte, []int) {
	return fileDescriptor_a27ed199db7c45f7, []int{0}
}
...
func (*AccountBudget_PendingAccountBudgetProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_a27ed199db7c45f7, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/resources/account_budget.proto", fileDescriptor_a27ed199db7c45f7)
}

var fileDescriptor_a27ed199db7c45f7 = []byte{
