...
func (*CustomerClientLink) Descriptor() ([]byte, []int) {
	return fileDescriptor_6e191a1cccf74f17, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/resources/customer_client_link.proto", fileDescriptor_6e191a1cccf74f17)
}

var fileDescriptor_6e191a1cccf74f17 = []byte{
