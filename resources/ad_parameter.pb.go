...
func (*AdParameter) Descriptor() ([]byte, []int) {
	return fileDescriptor_dc33b01602969f49, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/resources/ad_parameter.proto", fileDescriptor_dc33b01602969f49)
}

var fileDescriptor_dc33b01602969f49 = []byte{
