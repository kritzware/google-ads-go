...
func (*CustomerClient) Descriptor() ([]byte, []int) {
	return fileDescriptor_c6a5e5c5ac31fc14, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/resources/customer_client.proto", fileDescriptor_c6a5e5c5ac31fc14)
}

var fileDescriptor_c6a5e5c5ac31fc14 = []byte{
