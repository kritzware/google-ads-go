...
func (*PaymentsAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_cfd44d4d083315de, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/resources/payments_account.proto", fileDescriptor_cfd44d4d083315de)
}

var fileDescriptor_cfd44d4d083315de = []byte{
