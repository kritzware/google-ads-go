...
func (*TopicConstant) Descriptor() ([]byte, []int) {
	return fileDescriptor_67dc355fa52c6708, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/resources/topic_constant.proto", fileDescriptor_67dc355fa52c6708)
}

var fileDescriptor_67dc355fa52c6708 = []byte{
