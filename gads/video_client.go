...
var newVideoClientHook clientHook
...
func defaultVideoCallOptions() *VideoCallOptions {
	return &VideoCallOptions{
		GetVideo: []gax.CallOption{
...
func (c *videoGRPCClient) GetVideo(ctx context.Context, req *servicespb.GetVideoRequest, opts ...gax.CallOption) (*resourcespb.Video, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.videoClient.GetVideo(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
