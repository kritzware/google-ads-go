...
func ExampleNewConversionUploadClient() {
	ctx := context.Background()
	c, err := gads.NewConversionUploadClient(ctx)
	if err != nil {
		// TODO: Handle error.
	}
	defer c.Close()
...
func ExampleConversionUploadClient_UploadClickConversions() {
	ctx := context.Background()
	c, err := gads.NewConversionUploadClient(ctx)
	if err != nil {
		// TODO: Handle error.
...
func ExampleConversionUploadClient_UploadCallConversions() {
	ctx := context.Background()
	c, err := gads.NewConversionUploadClient(ctx)
	if err != nil {
		// TODO: Handle error.
	...
	resp, err := c.UploadCallConversions(ctx, req)
	if err != nil {
		// TODO: Handle error.
	}
	// TODO: Use resp.
