...
func ExampleNewAccessibleBiddingStrategyClient() {
	ctx := context.Background()
	c, err := gads.NewAccessibleBiddingStrategyClient(ctx)
	if err != nil {
		// TODO: Handle error.
	}
	defer c.Close()
...
func ExampleAccessibleBiddingStrategyClient_GetAccessibleBiddingStrategy() {
	ctx := context.Background()
	c, err := gads.NewAccessibleBiddingStrategyClient(ctx)
	if err != nil {
		// TODO: Handle error.
