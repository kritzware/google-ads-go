...
var newCampaignBudgetClientHook clientHook
...
func defaultCampaignBudgetGRPCClientOptions() []option.ClientOption {
...
// internalCampaignBudgetClient is an interface that defines the methods availaible from Google Ads API.
type internalCampaignBudgetClient interface {
	Close() error
...
// CampaignBudgetClient is a client for interacting with Google Ads API.
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
//
// Service to manage campaign budgets.
type CampaignBudgetClient struct {
	// The internal transport-dependent client.
	internalClient internalCampaignBudgetClient
...
func (c *CampaignBudgetClient) setGoogleClientInfo(keyval ...string) {
...
func (c *CampaignBudgetClient) MutateCampaignBudgets(ctx context.Context, req *servicespb.MutateCampaignBudgetsRequest, opts ...gax.CallOption) (*servicespb.MutateCampaignBudgetsResponse, error) {
	return c.internalClient.MutateCampaignBudgets(ctx, req, opts...)
}

// campaignBudgetGRPCClient is a client for interacting with Google Ads API over gRPC transport.
//
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
type campaignBudgetGRPCClient struct {
	...
	// The gRPC API client.
	campaignBudgetClient servicespb.CampaignBudgetServiceClient

	// The x-goog-* metadata to be sent with each request.
	xGoogMetadata metadata.MD
}

// NewCampaignBudgetClient creates a new campaign budget service client based on gRPC.
// The returned client must be Closed when it is done being used to clean up its underlying connections.
//
// Service to manage campaign budgets.
func NewCampaignBudgetClient(ctx context.Context, opts ...option.ClientOption) (*CampaignBudgetClient, error) {
	clientOpts := defaultCampaignBudgetGRPCClientOptions()
	if newCampaignBudgetClientHook != nil {
		hookOpts, err := newCampaignBudgetClientHook(ctx, clientHookParams{})
		if err != nil {
			return nil, err
		}
	...
	client := CampaignBudgetClient{CallOptions: defaultCampaignBudgetCallOptions()}
...
//
// Deprecated.
func (c *campaignBudgetGRPCClient) Connection() *grpc.ClientConn {
...
func (c *campaignBudgetGRPCClient) MutateCampaignBudgets(ctx context.Context, req *servicespb.MutateCampaignBudgetsRequest, opts ...gax.CallOption) (*servicespb.MutateCampaignBudgetsResponse, error) {
	...
	ctx = insertMetadata(ctx, c.xGoogMetadata, md)
	opts = append((*c.CallOptions).MutateCampaignBudgets[0:len((*c.CallOptions).MutateCampaignBudgets):len((*c.CallOptions).MutateCampaignBudgets)], opts...)
	var resp *servicespb.MutateCampaignBudgetsResponse
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.campaignBudgetClient.MutateCampaignBudgets(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
