...
func ExampleLabelClient_GetLabel() {
	...
	req := &servicespb.GetLabelRequest{
...
func ExampleLabelClient_MutateLabels() {
	ctx := context.Background()
	c, err := gads.NewLabelClient(ctx)
	if err != nil {
		// TODO: Handle error.
	...
	req := &servicespb.MutateLabelsRequest{
		// TODO: Fill request struct fields.
	}
	resp, err := c.MutateLabels(ctx, req)
	if err != nil {
		// TODO: Handle error.
	}
	// TODO: Use resp.
