...
var newDetailPlacementViewClientHook clientHook
...
func defaultDetailPlacementViewCallOptions() *DetailPlacementViewCallOptions {
	return &DetailPlacementViewCallOptions{
		GetDetailPlacementView: []gax.CallOption{
...
func (c *detailPlacementViewGRPCClient) GetDetailPlacementView(ctx context.Context, req *servicespb.GetDetailPlacementViewRequest, opts ...gax.CallOption) (*resourcespb.DetailPlacementView, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.detailPlacementViewClient.GetDetailPlacementView(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
