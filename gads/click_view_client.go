...
var newClickViewClientHook clientHook
...
func defaultClickViewCallOptions() *ClickViewCallOptions {
	return &ClickViewCallOptions{
		GetClickView: []gax.CallOption{
...
func (c *clickViewGRPCClient) GetClickView(ctx context.Context, req *servicespb.GetClickViewRequest, opts ...gax.CallOption) (*resourcespb.ClickView, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.clickViewClient.GetClickView(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
