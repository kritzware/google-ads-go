...
func ExampleNewGoogleAdsClient() {
	ctx := context.Background()
	c, err := gads.NewGoogleAdsClient(ctx)
	if err != nil {
		// TODO: Handle error.
	}
	defer c.Close()
...
func ExampleGoogleAdsClient_Search() {
	ctx := context.Background()
	c, err := gads.NewGoogleAdsClient(ctx)
	if err != nil {
		// TODO: Handle error.
...
func ExampleGoogleAdsClient_Mutate() {
	ctx := context.Background()
	c, err := gads.NewGoogleAdsClient(ctx)
	if err != nil {
		// TODO: Handle error.
	...
	req := &servicespb.MutateGoogleAdsRequest{
		// TODO: Fill request struct fields.
	}
