...
// internalAdGroupAssetClient is an interface that defines the methods availaible from Google Ads API.
type internalAdGroupAssetClient interface {
	Close() error
	setGoogleClientInfo(...string)
	Connection() *grpc.ClientConn
	GetAdGroupAsset(context.Context, *servicespb.GetAdGroupAssetRequest, ...gax.CallOption) (*resourcespb.AdGroupAsset, error)
...
// QuotaError (at )
// RequestError (at )
func (c *AdGroupAssetClient) GetAdGroupAsset(ctx context.Context, req *servicespb.GetAdGroupAssetRequest, opts ...gax.CallOption) (*resourcespb.AdGroupAsset, error) {
	return c.internalClient.GetAdGroupAsset(ctx, req, opts...)
}
...
func (c *adGroupAssetGRPCClient) GetAdGroupAsset(ctx context.Context, req *servicespb.GetAdGroupAssetRequest, opts ...gax.CallOption) (*resourcespb.AdGroupAsset, error) {
	...
	opts = append((*c.CallOptions).GetAdGroupAsset[0:len((*c.CallOptions).GetAdGroupAsset):len((*c.CallOptions).GetAdGroupAsset)], opts...)
	var resp *resourcespb.AdGroupAsset
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.adGroupAssetClient.GetAdGroupAsset(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
