...
func defaultOperatingSystemVersionConstantGRPCClientOptions() []option.ClientOption {
...
// internalOperatingSystemVersionConstantClient is an interface that defines the methods availaible from Google Ads API.
type internalOperatingSystemVersionConstantClient interface {
	Close() error
	setGoogleClientInfo(...string)
	Connection() *grpc.ClientConn
	GetOperatingSystemVersionConstant(context.Context, *servicespb.GetOperatingSystemVersionConstantRequest, ...gax.CallOption) (*resourcespb.OperatingSystemVersionConstant, error)
}
...
type OperatingSystemVersionConstantClient struct {
	...
	internalClient internalOperatingSystemVersionConstantClient
...
func (c *OperatingSystemVersionConstantClient) GetOperatingSystemVersionConstant(ctx context.Context, req *servicespb.GetOperatingSystemVersionConstantRequest, opts ...gax.CallOption) (*resourcespb.OperatingSystemVersionConstant, error) {
	return c.internalClient.GetOperatingSystemVersionConstant(ctx, req, opts...)
}

// operatingSystemVersionConstantGRPCClient is a client for interacting with Google Ads API over gRPC transport.
//
// Methods, except Close, may be called concurrently. However, fields must not be modified concurrently with method calls.
type operatingSystemVersionConstantGRPCClient struct {
	...
	// Points back to the CallOptions field of the containing OperatingSystemVersionConstantClient
	CallOptions **OperatingSystemVersionConstantCallOptions
...
// NewOperatingSystemVersionConstantClient creates a new operating system version constant service client based on gRPC.
...
func NewOperatingSystemVersionConstantClient(ctx context.Context, opts ...option.ClientOption) (*OperatingSystemVersionConstantClient, error) {
	clientOpts := defaultOperatingSystemVersionConstantGRPCClientOptions()
	...
	client := OperatingSystemVersionConstantClient{CallOptions: defaultOperatingSystemVersionConstantCallOptions()}

	c := &operatingSystemVersionConstantGRPCClient{
		connPool:    connPool,
...
//
// Deprecated.
func (c *operatingSystemVersionConstantGRPCClient) Connection() *grpc.ClientConn {
...
// the `x-goog-api-client` header passed on each request. Intended for
// use by Google-written clients.
func (c *operatingSystemVersionConstantGRPCClient) setGoogleClientInfo(keyval ...string) {
...
// Close closes the connection to the API service. The user should invoke this when
// the client is no longer required.
func (c *operatingSystemVersionConstantGRPCClient) Close() error {
	return c.connPool.Close()
}

func (c *operatingSystemVersionConstantGRPCClient) GetOperatingSystemVersionConstant(ctx context.Context, req *servicespb.GetOperatingSystemVersionConstantRequest, opts ...gax.CallOption) (*resourcespb.OperatingSystemVersionConstant, error) {
