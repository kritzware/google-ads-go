...
var newGeographicViewClientHook clientHook
...
func defaultGeographicViewCallOptions() *GeographicViewCallOptions {
	return &GeographicViewCallOptions{
		GetGeographicView: []gax.CallOption{
...
func (c *geographicViewGRPCClient) GetGeographicView(ctx context.Context, req *servicespb.GetGeographicViewRequest, opts ...gax.CallOption) (*resourcespb.GeographicView, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.geographicViewClient.GetGeographicView(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
