...
var newGenderViewClientHook clientHook
...
func defaultGenderViewCallOptions() *GenderViewCallOptions {
	return &GenderViewCallOptions{
		GetGenderView: []gax.CallOption{
...
func (c *genderViewGRPCClient) GetGenderView(ctx context.Context, req *servicespb.GetGenderViewRequest, opts ...gax.CallOption) (*resourcespb.GenderView, error) {
	...
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.genderViewClient.GetGenderView(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
