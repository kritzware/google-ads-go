...
func (AdvertisingChannelSubTypeEnum_AdvertisingChannelSubType) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_enumTypes[0].Descriptor()
}

func (AdvertisingChannelSubTypeEnum_AdvertisingChannelSubType) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_enumTypes[0]
}
...
func (AdvertisingChannelSubTypeEnum_AdvertisingChannelSubType) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AdvertisingChannelSubTypeEnum) Reset() {
	*x = AdvertisingChannelSubTypeEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_msgTypes[0]
...
func (*AdvertisingChannelSubTypeEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_rawDesc = []byte{
	...
	0xd1, 0x03, 0x0a, 0x1d, 0x41, 0x64, 0x76, 0x65, 0x72, 0x74, 0x69, 0x73, 0x69, 0x6e, 0x67, 0x43,
	0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x53, 0x75, 0x62, 0x54, 0x79, 0x70, 0x65, 0x45, 0x6e, 0x75,
	0x6d, 0x22, 0xaf, 0x03, 0x0a, 0x19, 0x41, 0x64, 0x76, 0x65, 0x72, 0x74, 0x69, 0x73, 0x69, 0x6e,
	...
	0x45, 0x10, 0x11, 0x42, 0xf3, 0x01, 0x0a, 0x21, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2e, 0x76, 0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x1e, 0x41, 0x64, 0x76, 0x65, 0x72,
...
var (
	file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_rawDescData = file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_rawDesc
)

func file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_rawDescData
}

var file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_goTypes = []interface{}{
	(AdvertisingChannelSubTypeEnum_AdvertisingChannelSubType)(0), // 0: google.ads.googleads.v8.enums.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType
	(*AdvertisingChannelSubTypeEnum)(nil),                        // 1: google.ads.googleads.v8.enums.AdvertisingChannelSubTypeEnum
}
var file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_init() }
func file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_init() {
	if File_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_depIdxs,
		EnumInfos:         file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_enumTypes,
		MessageInfos:      file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto = out.File
	file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_rawDesc = nil
	file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_goTypes = nil
	file_google_ads_googleads_v8_enums_advertising_channel_sub_type_proto_depIdxs = nil
}
