...
func (AccountBudgetProposalStatusEnum_AccountBudgetProposalStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_enumTypes[0].Descriptor()
}

func (AccountBudgetProposalStatusEnum_AccountBudgetProposalStatus) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_enumTypes[0]
}
...
func (AccountBudgetProposalStatusEnum_AccountBudgetProposalStatus) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AccountBudgetProposalStatusEnum) Reset() {
	*x = AccountBudgetProposalStatusEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_msgTypes[0]
...
func (*AccountBudgetProposalStatusEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v8_enums_account_budget_proposal_status_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_rawDescData = file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_rawDesc
)

func file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_rawDescData
}

var file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_goTypes = []interface{}{
	(AccountBudgetProposalStatusEnum_AccountBudgetProposalStatus)(0), // 0: google.ads.googleads.v8.enums.AccountBudgetProposalStatusEnum.AccountBudgetProposalStatus
	(*AccountBudgetProposalStatusEnum)(nil),                          // 1: google.ads.googleads.v8.enums.AccountBudgetProposalStatusEnum
}
var file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_init() }
func file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_init() {
	if File_google_ads_googleads_v8_enums_account_budget_proposal_status_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_depIdxs,
		EnumInfos:         file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_enumTypes,
		MessageInfos:      file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_enums_account_budget_proposal_status_proto = out.File
	file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_rawDesc = nil
	file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_goTypes = nil
	file_google_ads_googleads_v8_enums_account_budget_proposal_status_proto_depIdxs = nil
}
