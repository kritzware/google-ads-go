...
type AdGroupAdAssetView struct {
	...
	FieldType enums.AssetFieldTypeEnum_AssetFieldType `protobuf:"varint,2,opt,name=field_type,json=fieldType,proto3,enum=google.ads.googleads.v8.enums.AssetFieldTypeEnum_AssetFieldType" json:"field_type,omitempty"`
	...
	PerformanceLabel enums.AssetPerformanceLabelEnum_AssetPerformanceLabel `protobuf:"varint,4,opt,name=performance_label,json=performanceLabel,proto3,enum=google.ads.googleads.v8.enums.AssetPerformanceLabelEnum_AssetPerformanceLabel" json:"performance_label,omitempty"`
}

func (x *AdGroupAdAssetView) Reset() {
	*x = AdGroupAdAssetView{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_msgTypes[0]
...
func (*AdGroupAdAssetView) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_rawDescGZIP(), []int{0}
}
...
func (x *AdGroupAdAssetPolicySummary) Reset() {
	*x = AdGroupAdAssetPolicySummary{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdGroupAdAssetPolicySummary) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_rawDescGZIP(), []int{1}
}
...
var File_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x61, 0x64, 0x73, 0x2f, 0x76, 0x38, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x70,
	...
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x41, 0x73, 0x73,
	...
	0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64,
	0x73, 0x2e, 0x76, 0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x41, 0x73, 0x73, 0x65, 0x74,
...
var (
	file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_rawDescData = file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_rawDesc
)

func file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_rawDescData
}

var file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_goTypes = []interface{}{
	(*AdGroupAdAssetView)(nil),                                 // 0: google.ads.googleads.v8.resources.AdGroupAdAssetView
	(*AdGroupAdAssetPolicySummary)(nil),                        // 1: google.ads.googleads.v8.resources.AdGroupAdAssetPolicySummary
	(enums.AssetFieldTypeEnum_AssetFieldType)(0),               // 2: google.ads.googleads.v8.enums.AssetFieldTypeEnum.AssetFieldType
	(enums.AssetPerformanceLabelEnum_AssetPerformanceLabel)(0), // 3: google.ads.googleads.v8.enums.AssetPerformanceLabelEnum.AssetPerformanceLabel
	(*common.PolicyTopicEntry)(nil),                            // 4: google.ads.googleads.v8.common.PolicyTopicEntry
	(enums.PolicyReviewStatusEnum_PolicyReviewStatus)(0),       // 5: google.ads.googleads.v8.enums.PolicyReviewStatusEnum.PolicyReviewStatus
	(enums.PolicyApprovalStatusEnum_PolicyApprovalStatus)(0),   // 6: google.ads.googleads.v8.enums.PolicyApprovalStatusEnum.PolicyApprovalStatus
}
var file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v8.resources.AdGroupAdAssetView.field_type:type_name -> google.ads.googleads.v8.enums.AssetFieldTypeEnum.AssetFieldType
	1, // 1: google.ads.googleads.v8.resources.AdGroupAdAssetView.policy_summary:type_name -> google.ads.googleads.v8.resources.AdGroupAdAssetPolicySummary
	3, // 2: google.ads.googleads.v8.resources.AdGroupAdAssetView.performance_label:type_name -> google.ads.googleads.v8.enums.AssetPerformanceLabelEnum.AssetPerformanceLabel
	4, // 3: google.ads.googleads.v8.resources.AdGroupAdAssetPolicySummary.policy_topic_entries:type_name -> google.ads.googleads.v8.common.PolicyTopicEntry
	5, // 4: google.ads.googleads.v8.resources.AdGroupAdAssetPolicySummary.review_status:type_name -> google.ads.googleads.v8.enums.PolicyReviewStatusEnum.PolicyReviewStatus
	6, // 5: google.ads.googleads.v8.resources.AdGroupAdAssetPolicySummary.approval_status:type_name -> google.ads.googleads.v8.enums.PolicyApprovalStatusEnum.PolicyApprovalStatus
...
func init() { file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_init() }
func file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_init() {
	if File_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto = out.File
	file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_rawDesc = nil
	file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_goTypes = nil
	file_google_ads_googleads_v8_resources_ad_group_ad_asset_view_proto_depIdxs = nil
}
