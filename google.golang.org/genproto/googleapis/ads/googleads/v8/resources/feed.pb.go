...
func (FeedAttributeOperation_Operator) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v8_resources_feed_proto_enumTypes[0].Descriptor()
}

func (FeedAttributeOperation_Operator) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v8_resources_feed_proto_enumTypes[0]
}
...
func (FeedAttributeOperation_Operator) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_resources_feed_proto_rawDescGZIP(), []int{2, 0}
}
...
type Feed struct {
	...
	Origin enums.FeedOriginEnum_FeedOrigin `protobuf:"varint,5,opt,name=origin,proto3,enum=google.ads.googleads.v8.enums.FeedOriginEnum_FeedOrigin" json:"origin,omitempty"`
	// Output only. Status of the feed.
	// This field is read-only.
	Status enums.FeedStatusEnum_FeedStatus `protobuf:"varint,8,opt,name=status,proto3,enum=google.ads.googleads.v8.enums.FeedStatusEnum_FeedStatus" json:"status,omitempty"`
...
func (x *Feed) Reset() {
	*x = Feed{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_resources_feed_proto_msgTypes[0]
...
func (*Feed) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_resources_feed_proto_rawDescGZIP(), []int{0}
}
...
type FeedAttribute struct {
	...
	Type enums.FeedAttributeTypeEnum_FeedAttributeType `protobuf:"varint,3,opt,name=type,proto3,enum=google.ads.googleads.v8.enums.FeedAttributeTypeEnum_FeedAttributeType" json:"type,omitempty"`
...
func (x *FeedAttribute) Reset() {
	*x = FeedAttribute{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_resources_feed_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FeedAttribute) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_resources_feed_proto_rawDescGZIP(), []int{1}
}
...
type FeedAttributeOperation struct {
	...
	Operator FeedAttributeOperation_Operator `protobuf:"varint,1,opt,name=operator,proto3,enum=google.ads.googleads.v8.resources.FeedAttributeOperation_Operator" json:"operator,omitempty"`
...
func (x *FeedAttributeOperation) Reset() {
	*x = FeedAttributeOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_resources_feed_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FeedAttributeOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_resources_feed_proto_rawDescGZIP(), []int{2}
}
...
func (x *Feed_PlacesLocationFeedData) Reset() {
	*x = Feed_PlacesLocationFeedData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_resources_feed_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Feed_PlacesLocationFeedData) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_resources_feed_proto_rawDescGZIP(), []int{0, 0}
}
...
func (*Feed_AffiliateLocationFeedData) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_resources_feed_proto_rawDescGZIP(), []int{0, 1}
}
...
func (x *Feed_PlacesLocationFeedData_OAuthInfo) Reset() {
	*x = Feed_PlacesLocationFeedData_OAuthInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_resources_feed_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Feed_PlacesLocationFeedData_OAuthInfo) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_resources_feed_proto_rawDescGZIP(), []int{0, 0, 0}
}
...
var File_google_ads_googleads_v8_resources_feed_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v8_resources_feed_proto_rawDesc = []byte{
	...
	0x76, 0x38, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x66, 0x65, 0x65, 0x64, 0x5f, 0x6f, 0x72,
	0x69, 0x67, 0x69, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x2f, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2f, 0x76, 0x38, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x66, 0x65, 0x65, 0x64, 0x5f, 0x73,
	...
	0x2e, 0x76, 0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x46, 0x65, 0x65, 0x64, 0x53, 0x74,
	...
	0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x41, 0x66, 0x66, 0x69, 0x6c, 0x69, 0x61, 0x74,
...
var (
	file_google_ads_googleads_v8_resources_feed_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_resources_feed_proto_rawDescData = file_google_ads_googleads_v8_resources_feed_proto_rawDesc
)

func file_google_ads_googleads_v8_resources_feed_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_resources_feed_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_resources_feed_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_resources_feed_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_resources_feed_proto_rawDescData
}

var file_google_ads_googleads_v8_resources_feed_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v8_resources_feed_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_google_ads_googleads_v8_resources_feed_proto_goTypes = []interface{}{
	(FeedAttributeOperation_Operator)(0),               // 0: google.ads.googleads.v8.resources.FeedAttributeOperation.Operator
	(*Feed)(nil),                                       // 1: google.ads.googleads.v8.resources.Feed
	(*FeedAttribute)(nil),                              // 2: google.ads.googleads.v8.resources.FeedAttribute
	(*FeedAttributeOperation)(nil),                     // 3: google.ads.googleads.v8.resources.FeedAttributeOperation
	(*Feed_PlacesLocationFeedData)(nil),                // 4: google.ads.googleads.v8.resources.Feed.PlacesLocationFeedData
	(*Feed_AffiliateLocationFeedData)(nil),             // 5: google.ads.googleads.v8.resources.Feed.AffiliateLocationFeedData
	(*Feed_PlacesLocationFeedData_OAuthInfo)(nil),      // 6: google.ads.googleads.v8.resources.Feed.PlacesLocationFeedData.OAuthInfo
	(enums.FeedOriginEnum_FeedOrigin)(0),               // 7: google.ads.googleads.v8.enums.FeedOriginEnum.FeedOrigin
	(enums.FeedStatusEnum_FeedStatus)(0),               // 8: google.ads.googleads.v8.enums.FeedStatusEnum.FeedStatus
	(enums.FeedAttributeTypeEnum_FeedAttributeType)(0), // 9: google.ads.googleads.v8.enums.FeedAttributeTypeEnum.FeedAttributeType
	(enums.AffiliateLocationFeedRelationshipTypeEnum_AffiliateLocationFeedRelationshipType)(0), // 10: google.ads.googleads.v8.enums.AffiliateLocationFeedRelationshipTypeEnum.AffiliateLocationFeedRelationshipType
}
var file_google_ads_googleads_v8_resources_feed_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v8.resources.Feed.attributes:type_name -> google.ads.googleads.v8.resources.FeedAttribute
	3,  // 1: google.ads.googleads.v8.resources.Feed.attribute_operations:type_name -> google.ads.googleads.v8.resources.FeedAttributeOperation
	7,  // 2: google.ads.googleads.v8.resources.Feed.origin:type_name -> google.ads.googleads.v8.enums.FeedOriginEnum.FeedOrigin
	8,  // 3: google.ads.googleads.v8.resources.Feed.status:type_name -> google.ads.googleads.v8.enums.FeedStatusEnum.FeedStatus
	4,  // 4: google.ads.googleads.v8.resources.Feed.places_location_feed_data:type_name -> google.ads.googleads.v8.resources.Feed.PlacesLocationFeedData
	5,  // 5: google.ads.googleads.v8.resources.Feed.affiliate_location_feed_data:type_name -> google.ads.googleads.v8.resources.Feed.AffiliateLocationFeedData
	9,  // 6: google.ads.googleads.v8.resources.FeedAttribute.type:type_name -> google.ads.googleads.v8.enums.FeedAttributeTypeEnum.FeedAttributeType
	0,  // 7: google.ads.googleads.v8.resources.FeedAttributeOperation.operator:type_name -> google.ads.googleads.v8.resources.FeedAttributeOperation.Operator
	2,  // 8: google.ads.googleads.v8.resources.FeedAttributeOperation.value:type_name -> google.ads.googleads.v8.resources.FeedAttribute
	6,  // 9: google.ads.googleads.v8.resources.Feed.PlacesLocationFeedData.oauth_info:type_name -> google.ads.googleads.v8.resources.Feed.PlacesLocationFeedData.OAuthInfo
	10, // 10: google.ads.googleads.v8.resources.Feed.AffiliateLocationFeedData.relationship_type:type_name -> google.ads.googleads.v8.enums.AffiliateLocationFeedRelationshipTypeEnum.AffiliateLocationFeedRelationshipType
...
func init() { file_google_ads_googleads_v8_resources_feed_proto_init() }
func file_google_ads_googleads_v8_resources_feed_proto_init() {
	if File_google_ads_googleads_v8_resources_feed_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_resources_feed_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Feed); i {
			case 0:
				return &v.state
			case 1:
		...
		file_google_ads_googleads_v8_resources_feed_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_resources_feed_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_resources_feed_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_resources_feed_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_resources_feed_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_resources_feed_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*Feed_PlacesLocationFeedData_)(nil),
		(*Feed_AffiliateLocationFeedData_)(nil),
	}
	file_google_ads_googleads_v8_resources_feed_proto_msgTypes[1].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v8_resources_feed_proto_msgTypes[3].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v8_resources_feed_proto_msgTypes[5].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v8_resources_feed_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v8_resources_feed_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_resources_feed_proto_depIdxs,
		EnumInfos:         file_google_ads_googleads_v8_resources_feed_proto_enumTypes,
		MessageInfos:      file_google_ads_googleads_v8_resources_feed_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_resources_feed_proto = out.File
	file_google_ads_googleads_v8_resources_feed_proto_rawDesc = nil
	file_google_ads_googleads_v8_resources_feed_proto_goTypes = nil
	file_google_ads_googleads_v8_resources_feed_proto_depIdxs = nil
}
