...
type SharedCriterion struct {
	...
	Type enums.CriterionTypeEnum_CriterionType `protobuf:"varint,4,opt,name=type,proto3,enum=google.ads.googleads.v8.enums.CriterionTypeEnum_CriterionType" json:"type,omitempty"`
	// The criterion.
	//
...
func (x *SharedCriterion) Reset() {
	*x = SharedCriterion{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_resources_shared_criterion_proto_msgTypes[0]
...
func (*SharedCriterion) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_resources_shared_criterion_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v8_resources_shared_criterion_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v8_resources_shared_criterion_proto_rawDesc = []byte{
	...
	0x64, 0x73, 0x2f, 0x76, 0x38, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x63, 0x72, 0x69, 0x74,
	...
	0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2e, 0x76, 0x38, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x4d, 0x6f, 0x62, 0x69, 0x6c,
	...
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x41, 0x64, 0x73, 0x2e, 0x56, 0x38, 0x2e, 0x52, 0x65, 0x73, 0x6f,
	...
	0x64, 0x73, 0x3a, 0x3a, 0x56, 0x38, 0x3a, 0x3a, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_google_ads_googleads_v8_resources_shared_criterion_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_resources_shared_criterion_proto_rawDescData = file_google_ads_googleads_v8_resources_shared_criterion_proto_rawDesc
)

func file_google_ads_googleads_v8_resources_shared_criterion_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_resources_shared_criterion_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_resources_shared_criterion_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_resources_shared_criterion_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_resources_shared_criterion_proto_rawDescData
}

var file_google_ads_googleads_v8_resources_shared_criterion_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v8_resources_shared_criterion_proto_goTypes = []interface{}{
	(*SharedCriterion)(nil),                    // 0: google.ads.googleads.v8.resources.SharedCriterion
	(enums.CriterionTypeEnum_CriterionType)(0), // 1: google.ads.googleads.v8.enums.CriterionTypeEnum.CriterionType
	(*common.KeywordInfo)(nil),                 // 2: google.ads.googleads.v8.common.KeywordInfo
	(*common.YouTubeVideoInfo)(nil),            // 3: google.ads.googleads.v8.common.YouTubeVideoInfo
	(*common.YouTubeChannelInfo)(nil),          // 4: google.ads.googleads.v8.common.YouTubeChannelInfo
	(*common.PlacementInfo)(nil),               // 5: google.ads.googleads.v8.common.PlacementInfo
	(*common.MobileAppCategoryInfo)(nil),       // 6: google.ads.googleads.v8.common.MobileAppCategoryInfo
	(*common.MobileApplicationInfo)(nil),       // 7: google.ads.googleads.v8.common.MobileApplicationInfo
}
var file_google_ads_googleads_v8_resources_shared_criterion_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v8.resources.SharedCriterion.type:type_name -> google.ads.googleads.v8.enums.CriterionTypeEnum.CriterionType
	2, // 1: google.ads.googleads.v8.resources.SharedCriterion.keyword:type_name -> google.ads.googleads.v8.common.KeywordInfo
	3, // 2: google.ads.googleads.v8.resources.SharedCriterion.youtube_video:type_name -> google.ads.googleads.v8.common.YouTubeVideoInfo
	4, // 3: google.ads.googleads.v8.resources.SharedCriterion.youtube_channel:type_name -> google.ads.googleads.v8.common.YouTubeChannelInfo
	5, // 4: google.ads.googleads.v8.resources.SharedCriterion.placement:type_name -> google.ads.googleads.v8.common.PlacementInfo
	6, // 5: google.ads.googleads.v8.resources.SharedCriterion.mobile_app_category:type_name -> google.ads.googleads.v8.common.MobileAppCategoryInfo
	7, // 6: google.ads.googleads.v8.resources.SharedCriterion.mobile_application:type_name -> google.ads.googleads.v8.common.MobileApplicationInfo
...
func init() { file_google_ads_googleads_v8_resources_shared_criterion_proto_init() }
func file_google_ads_googleads_v8_resources_shared_criterion_proto_init() {
	if File_google_ads_googleads_v8_resources_shared_criterion_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_resources_shared_criterion_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_resources_shared_criterion_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_resources_shared_criterion_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v8_resources_shared_criterion_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_resources_shared_criterion_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_resources_shared_criterion_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_resources_shared_criterion_proto = out.File
	file_google_ads_googleads_v8_resources_shared_criterion_proto_rawDesc = nil
	file_google_ads_googleads_v8_resources_shared_criterion_proto_goTypes = nil
	file_google_ads_googleads_v8_resources_shared_criterion_proto_depIdxs = nil
}
