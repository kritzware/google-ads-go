...
type CustomInterest struct {
	...
	// enabled or removed.
	Status enums.CustomInterestStatusEnum_CustomInterestStatus `protobuf:"varint,3,opt,name=status,proto3,enum=google.ads.googleads.v8.enums.CustomInterestStatusEnum_CustomInterestStatus" json:"status,omitempty"`
	...
	Type enums.CustomInterestTypeEnum_CustomInterestType `protobuf:"varint,5,opt,name=type,proto3,enum=google.ads.googleads.v8.enums.CustomInterestTypeEnum_CustomInterestType" json:"type,omitempty"`
...
func (x *CustomInterest) Reset() {
	*x = CustomInterest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_resources_custom_interest_proto_msgTypes[0]
...
func (*CustomInterest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_resources_custom_interest_proto_rawDescGZIP(), []int{0}
}
...
type CustomInterestMember struct {
	...
	MemberType enums.CustomInterestMemberTypeEnum_CustomInterestMemberType `protobuf:"varint,1,opt,name=member_type,json=memberType,proto3,enum=google.ads.googleads.v8.enums.CustomInterestMemberTypeEnum_CustomInterestMemberType" json:"member_type,omitempty"`
...
func (x *CustomInterestMember) Reset() {
	*x = CustomInterestMember{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_resources_custom_interest_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CustomInterestMember) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_resources_custom_interest_proto_rawDescGZIP(), []int{1}
}
...
var File_google_ads_googleads_v8_resources_custom_interest_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v8_resources_custom_interest_proto_rawDesc = []byte{
	...
	0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x43, 0x75,
	...
	0x73, 0x2e, 0x76, 0x38, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x13,
...
var (
	file_google_ads_googleads_v8_resources_custom_interest_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_resources_custom_interest_proto_rawDescData = file_google_ads_googleads_v8_resources_custom_interest_proto_rawDesc
)

func file_google_ads_googleads_v8_resources_custom_interest_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_resources_custom_interest_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_resources_custom_interest_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_resources_custom_interest_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_resources_custom_interest_proto_rawDescData
}

var file_google_ads_googleads_v8_resources_custom_interest_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v8_resources_custom_interest_proto_goTypes = []interface{}{
	(*CustomInterest)(nil),                                           // 0: google.ads.googleads.v8.resources.CustomInterest
	(*CustomInterestMember)(nil),                                     // 1: google.ads.googleads.v8.resources.CustomInterestMember
	(enums.CustomInterestStatusEnum_CustomInterestStatus)(0),         // 2: google.ads.googleads.v8.enums.CustomInterestStatusEnum.CustomInterestStatus
	(enums.CustomInterestTypeEnum_CustomInterestType)(0),             // 3: google.ads.googleads.v8.enums.CustomInterestTypeEnum.CustomInterestType
	(enums.CustomInterestMemberTypeEnum_CustomInterestMemberType)(0), // 4: google.ads.googleads.v8.enums.CustomInterestMemberTypeEnum.CustomInterestMemberType
}
var file_google_ads_googleads_v8_resources_custom_interest_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v8.resources.CustomInterest.status:type_name -> google.ads.googleads.v8.enums.CustomInterestStatusEnum.CustomInterestStatus
	3, // 1: google.ads.googleads.v8.resources.CustomInterest.type:type_name -> google.ads.googleads.v8.enums.CustomInterestTypeEnum.CustomInterestType
	1, // 2: google.ads.googleads.v8.resources.CustomInterest.members:type_name -> google.ads.googleads.v8.resources.CustomInterestMember
	4, // 3: google.ads.googleads.v8.resources.CustomInterestMember.member_type:type_name -> google.ads.googleads.v8.enums.CustomInterestMemberTypeEnum.CustomInterestMemberType
...
func init() { file_google_ads_googleads_v8_resources_custom_interest_proto_init() }
func file_google_ads_googleads_v8_resources_custom_interest_proto_init() {
	if File_google_ads_googleads_v8_resources_custom_interest_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_resources_custom_interest_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_resources_custom_interest_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_resources_custom_interest_proto_msgTypes[0].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v8_resources_custom_interest_proto_msgTypes[1].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v8_resources_custom_interest_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v8_resources_custom_interest_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_resources_custom_interest_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_resources_custom_interest_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_resources_custom_interest_proto = out.File
	file_google_ads_googleads_v8_resources_custom_interest_proto_rawDesc = nil
	file_google_ads_googleads_v8_resources_custom_interest_proto_goTypes = nil
	file_google_ads_googleads_v8_resources_custom_interest_proto_depIdxs = nil
}
