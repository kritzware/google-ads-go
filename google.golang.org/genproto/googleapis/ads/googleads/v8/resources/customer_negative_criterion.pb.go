...
type CustomerNegativeCriterion struct {
	...
	Type enums.CriterionTypeEnum_CriterionType `protobuf:"varint,3,opt,name=type,proto3,enum=google.ads.googleads.v8.enums.CriterionTypeEnum_CriterionType" json:"type,omitempty"`
...
func (x *CustomerNegativeCriterion) Reset() {
	*x = CustomerNegativeCriterion{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_resources_customer_negative_criterion_proto_msgTypes[0]
...
func (*CustomerNegativeCriterion) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_resources_customer_negative_criterion_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v8_resources_customer_negative_criterion_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v8_resources_customer_negative_criterion_proto_rawDesc = []byte{
	...
	0x38, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x63, 0x72, 0x69, 0x74, 0x65, 0x72, 0x69,
	...
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x43, 0x72, 0x69,
	...
	0x73, 0x2e, 0x76, 0x38, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x1e,
...
var (
	file_google_ads_googleads_v8_resources_customer_negative_criterion_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_resources_customer_negative_criterion_proto_rawDescData = file_google_ads_googleads_v8_resources_customer_negative_criterion_proto_rawDesc
)

func file_google_ads_googleads_v8_resources_customer_negative_criterion_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_resources_customer_negative_criterion_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_resources_customer_negative_criterion_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_resources_customer_negative_criterion_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_resources_customer_negative_criterion_proto_rawDescData
}

var file_google_ads_googleads_v8_resources_customer_negative_criterion_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v8_resources_customer_negative_criterion_proto_goTypes = []interface{}{
	(*CustomerNegativeCriterion)(nil),          // 0: google.ads.googleads.v8.resources.CustomerNegativeCriterion
	(enums.CriterionTypeEnum_CriterionType)(0), // 1: google.ads.googleads.v8.enums.CriterionTypeEnum.CriterionType
	(*common.ContentLabelInfo)(nil),            // 2: google.ads.googleads.v8.common.ContentLabelInfo
	(*common.MobileApplicationInfo)(nil),       // 3: google.ads.googleads.v8.common.MobileApplicationInfo
	(*common.MobileAppCategoryInfo)(nil),       // 4: google.ads.googleads.v8.common.MobileAppCategoryInfo
	(*common.PlacementInfo)(nil),               // 5: google.ads.googleads.v8.common.PlacementInfo
	(*common.YouTubeVideoInfo)(nil),            // 6: google.ads.googleads.v8.common.YouTubeVideoInfo
	(*common.YouTubeChannelInfo)(nil),          // 7: google.ads.googleads.v8.common.YouTubeChannelInfo
}
var file_google_ads_googleads_v8_resources_customer_negative_criterion_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v8.resources.CustomerNegativeCriterion.type:type_name -> google.ads.googleads.v8.enums.CriterionTypeEnum.CriterionType
	2, // 1: google.ads.googleads.v8.resources.CustomerNegativeCriterion.content_label:type_name -> google.ads.googleads.v8.common.ContentLabelInfo
	3, // 2: google.ads.googleads.v8.resources.CustomerNegativeCriterion.mobile_application:type_name -> google.ads.googleads.v8.common.MobileApplicationInfo
	4, // 3: google.ads.googleads.v8.resources.CustomerNegativeCriterion.mobile_app_category:type_name -> google.ads.googleads.v8.common.MobileAppCategoryInfo
	5, // 4: google.ads.googleads.v8.resources.CustomerNegativeCriterion.placement:type_name -> google.ads.googleads.v8.common.PlacementInfo
	6, // 5: google.ads.googleads.v8.resources.CustomerNegativeCriterion.youtube_video:type_name -> google.ads.googleads.v8.common.YouTubeVideoInfo
	7, // 6: google.ads.googleads.v8.resources.CustomerNegativeCriterion.youtube_channel:type_name -> google.ads.googleads.v8.common.YouTubeChannelInfo
...
func init() { file_google_ads_googleads_v8_resources_customer_negative_criterion_proto_init() }
func file_google_ads_googleads_v8_resources_customer_negative_criterion_proto_init() {
	if File_google_ads_googleads_v8_resources_customer_negative_criterion_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_resources_customer_negative_criterion_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_resources_customer_negative_criterion_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_resources_customer_negative_criterion_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v8_resources_customer_negative_criterion_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_resources_customer_negative_criterion_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_resources_customer_negative_criterion_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_resources_customer_negative_criterion_proto = out.File
	file_google_ads_googleads_v8_resources_customer_negative_criterion_proto_rawDesc = nil
	file_google_ads_googleads_v8_resources_customer_negative_criterion_proto_goTypes = nil
	file_google_ads_googleads_v8_resources_customer_negative_criterion_proto_depIdxs = nil
}
