...
type CustomerFeed struct {
	...
	// customer. Required.
	PlaceholderTypes []enums.PlaceholderTypeEnum_PlaceholderType `protobuf:"varint,3,rep,packed,name=placeholder_types,json=placeholderTypes,proto3,enum=google.ads.googleads.v8.enums.PlaceholderTypeEnum_PlaceholderType" json:"placeholder_types,omitempty"`
	...
	Status enums.FeedLinkStatusEnum_FeedLinkStatus `protobuf:"varint,5,opt,name=status,proto3,enum=google.ads.googleads.v8.enums.FeedLinkStatusEnum_FeedLinkStatus" json:"status,omitempty"`
}

func (x *CustomerFeed) Reset() {
	*x = CustomerFeed{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_resources_customer_feed_proto_msgTypes[0]
...
func (*CustomerFeed) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_resources_customer_feed_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v8_resources_customer_feed_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v8_resources_customer_feed_proto_rawDesc = []byte{
	...
	0x2f, 0x76, 0x38, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x6d, 0x61, 0x74, 0x63, 0x68,
	...
	0x38, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x70, 0x6c, 0x61, 0x63, 0x65, 0x68, 0x6f, 0x6c,
	...
	0x76, 0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x50, 0x6c, 0x61, 0x63, 0x65, 0x68, 0x6f,
	...
	0x2e, 0x76, 0x38, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x4d, 0x61, 0x74, 0x63, 0x68,
	...
	0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e,
	0x76, 0x38, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x11, 0x43, 0x75,
	...
	0x2e, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x41, 0x64, 0x73, 0x2e, 0x56, 0x38, 0x2e, 0x52, 0x65,
	...
	0x38, 0x5c, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0xea, 0x02, 0x25, 0x47, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x3a, 0x3a, 0x41, 0x64, 0x73, 0x3a, 0x3a, 0x47, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x41, 0x64, 0x73, 0x3a, 0x3a, 0x56, 0x38, 0x3a, 0x3a, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_google_ads_googleads_v8_resources_customer_feed_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_resources_customer_feed_proto_rawDescData = file_google_ads_googleads_v8_resources_customer_feed_proto_rawDesc
)

func file_google_ads_googleads_v8_resources_customer_feed_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_resources_customer_feed_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_resources_customer_feed_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_resources_customer_feed_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_resources_customer_feed_proto_rawDescData
}

var file_google_ads_googleads_v8_resources_customer_feed_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v8_resources_customer_feed_proto_goTypes = []interface{}{
	(*CustomerFeed)(nil),                           // 0: google.ads.googleads.v8.resources.CustomerFeed
	(enums.PlaceholderTypeEnum_PlaceholderType)(0), // 1: google.ads.googleads.v8.enums.PlaceholderTypeEnum.PlaceholderType
	(*common.MatchingFunction)(nil),                // 2: google.ads.googleads.v8.common.MatchingFunction
	(enums.FeedLinkStatusEnum_FeedLinkStatus)(0),   // 3: google.ads.googleads.v8.enums.FeedLinkStatusEnum.FeedLinkStatus
}
var file_google_ads_googleads_v8_resources_customer_feed_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v8.resources.CustomerFeed.placeholder_types:type_name -> google.ads.googleads.v8.enums.PlaceholderTypeEnum.PlaceholderType
	2, // 1: google.ads.googleads.v8.resources.CustomerFeed.matching_function:type_name -> google.ads.googleads.v8.common.MatchingFunction
	3, // 2: google.ads.googleads.v8.resources.CustomerFeed.status:type_name -> google.ads.googleads.v8.enums.FeedLinkStatusEnum.FeedLinkStatus
...
func init() { file_google_ads_googleads_v8_resources_customer_feed_proto_init() }
func file_google_ads_googleads_v8_resources_customer_feed_proto_init() {
	if File_google_ads_googleads_v8_resources_customer_feed_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_resources_customer_feed_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_resources_customer_feed_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v8_resources_customer_feed_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v8_resources_customer_feed_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_resources_customer_feed_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_resources_customer_feed_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_resources_customer_feed_proto = out.File
	file_google_ads_googleads_v8_resources_customer_feed_proto_rawDesc = nil
	file_google_ads_googleads_v8_resources_customer_feed_proto_goTypes = nil
	file_google_ads_googleads_v8_resources_customer_feed_proto_depIdxs = nil
}
