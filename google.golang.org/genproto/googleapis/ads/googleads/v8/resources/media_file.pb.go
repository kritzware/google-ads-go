...
type MediaFile struct {
	...
	Type enums.MediaTypeEnum_MediaType `protobuf:"varint,5,opt,name=type,proto3,enum=google.ads.googleads.v8.enums.MediaTypeEnum_MediaType" json:"type,omitempty"`
	// Output only. The mime type of the media file.
	MimeType enums.MimeTypeEnum_MimeType `protobuf:"varint,6,opt,name=mime_type,json=mimeType,proto3,enum=google.ads.googleads.v8.enums.MimeTypeEnum_MimeType" json:"mime_type,omitempty"`
...
func (x *MediaFile) Reset() {
	*x = MediaFile{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_resources_media_file_proto_msgTypes[0]
...
func (*MediaFile) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_resources_media_file_proto_rawDescGZIP(), []int{0}
}
...
func (x *MediaImage) Reset() {
	*x = MediaImage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_resources_media_file_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MediaImage) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_resources_media_file_proto_rawDescGZIP(), []int{1}
}
...
func (x *MediaBundle) Reset() {
	*x = MediaBundle{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_resources_media_file_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MediaBundle) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_resources_media_file_proto_rawDescGZIP(), []int{2}
}
...
func (x *MediaAudio) Reset() {
	*x = MediaAudio{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_resources_media_file_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MediaAudio) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_resources_media_file_proto_rawDescGZIP(), []int{3}
}
...
func (x *MediaVideo) Reset() {
	*x = MediaVideo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_resources_media_file_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MediaVideo) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_resources_media_file_proto_rawDescGZIP(), []int{4}
}
...
var File_google_ads_googleads_v8_resources_media_file_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v8_resources_media_file_proto_rawDesc = []byte{
	...
	0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x4d, 0x65, 0x64, 0x69, 0x61, 0x54, 0x79, 0x70,
	...
	0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x4d, 0x69,
...
var (
	file_google_ads_googleads_v8_resources_media_file_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_resources_media_file_proto_rawDescData = file_google_ads_googleads_v8_resources_media_file_proto_rawDesc
)

func file_google_ads_googleads_v8_resources_media_file_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_resources_media_file_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_resources_media_file_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_resources_media_file_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_resources_media_file_proto_rawDescData
}

var file_google_ads_googleads_v8_resources_media_file_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_resources_media_file_proto_goTypes = []interface{}{
	(*MediaFile)(nil),                  // 0: google.ads.googleads.v8.resources.MediaFile
	(*MediaImage)(nil),                 // 1: google.ads.googleads.v8.resources.MediaImage
	(*MediaBundle)(nil),                // 2: google.ads.googleads.v8.resources.MediaBundle
	(*MediaAudio)(nil),                 // 3: google.ads.googleads.v8.resources.MediaAudio
	(*MediaVideo)(nil),                 // 4: google.ads.googleads.v8.resources.MediaVideo
	(enums.MediaTypeEnum_MediaType)(0), // 5: google.ads.googleads.v8.enums.MediaTypeEnum.MediaType
	(enums.MimeTypeEnum_MimeType)(0),   // 6: google.ads.googleads.v8.enums.MimeTypeEnum.MimeType
}
var file_google_ads_googleads_v8_resources_media_file_proto_depIdxs = []int32{
	5, // 0: google.ads.googleads.v8.resources.MediaFile.type:type_name -> google.ads.googleads.v8.enums.MediaTypeEnum.MediaType
	6, // 1: google.ads.googleads.v8.resources.MediaFile.mime_type:type_name -> google.ads.googleads.v8.enums.MimeTypeEnum.MimeType
	1, // 2: google.ads.googleads.v8.resources.MediaFile.image:type_name -> google.ads.googleads.v8.resources.MediaImage
	2, // 3: google.ads.googleads.v8.resources.MediaFile.media_bundle:type_name -> google.ads.googleads.v8.resources.MediaBundle
	3, // 4: google.ads.googleads.v8.resources.MediaFile.audio:type_name -> google.ads.googleads.v8.resources.MediaAudio
	4, // 5: google.ads.googleads.v8.resources.MediaFile.video:type_name -> google.ads.googleads.v8.resources.MediaVideo
...
func init() { file_google_ads_googleads_v8_resources_media_file_proto_init() }
func file_google_ads_googleads_v8_resources_media_file_proto_init() {
	if File_google_ads_googleads_v8_resources_media_file_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_resources_media_file_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_resources_media_file_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_resources_media_file_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_resources_media_file_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_resources_media_file_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_resources_media_file_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*MediaFile_Image)(nil),
		(*MediaFile_MediaBundle)(nil),
		(*MediaFile_Audio)(nil),
		(*MediaFile_Video)(nil),
	}
	file_google_ads_googleads_v8_resources_media_file_proto_msgTypes[1].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v8_resources_media_file_proto_msgTypes[2].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v8_resources_media_file_proto_msgTypes[3].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v8_resources_media_file_proto_msgTypes[4].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v8_resources_media_file_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v8_resources_media_file_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_resources_media_file_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_resources_media_file_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_resources_media_file_proto = out.File
	file_google_ads_googleads_v8_resources_media_file_proto_rawDesc = nil
	file_google_ads_googleads_v8_resources_media_file_proto_goTypes = nil
	file_google_ads_googleads_v8_resources_media_file_proto_depIdxs = nil
}
