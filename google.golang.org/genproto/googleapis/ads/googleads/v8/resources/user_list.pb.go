...
type UserList struct {
	...
	// targeted to.
	MembershipStatus enums.UserListMembershipStatusEnum_UserListMembershipStatus `protobuf:"varint,6,opt,name=membership_status,json=membershipStatus,proto3,enum=google.ads.googleads.v8.enums.UserListMembershipStatusEnum_UserListMembershipStatus" json:"membership_status,omitempty"`
	...
	//
	// This field is read-only.
	SizeRangeForDisplay enums.UserListSizeRangeEnum_UserListSizeRange `protobuf:"varint,10,opt,name=size_range_for_display,json=sizeRangeForDisplay,proto3,enum=google.ads.googleads.v8.enums.UserListSizeRangeEnum_UserListSizeRange" json:"size_range_for_display,omitempty"`
	...
	//
	// This field is read-only.
	SizeRangeForSearch enums.UserListSizeRangeEnum_UserListSizeRange `protobuf:"varint,12,opt,name=size_range_for_search,json=sizeRangeForSearch,proto3,enum=google.ads.googleads.v8.enums.UserListSizeRangeEnum_UserListSizeRange" json:"size_range_for_search,omitempty"`
	// Output only. Type of this list.
	//
	// This field is read-only.
	Type enums.UserListTypeEnum_UserListType `protobuf:"varint,13,opt,name=type,proto3,enum=google.ads.googleads.v8.enums.UserListTypeEnum_UserListType" json:"type,omitempty"`
	...
	ClosingReason enums.UserListClosingReasonEnum_UserListClosingReason `protobuf:"varint,14,opt,name=closing_reason,json=closingReason,proto3,enum=google.ads.googleads.v8.enums.UserListClosingReasonEnum_UserListClosingReason" json:"closing_reason,omitempty"`
	...
	//
	// This field is read-only.
	AccessReason enums.AccessReasonEnum_AccessReason `protobuf:"varint,15,opt,name=access_reason,json=accessReason,proto3,enum=google.ads.googleads.v8.enums.AccessReasonEnum_AccessReason" json:"access_reason,omitempty"`
	...
	AccountUserListStatus enums.UserListAccessStatusEnum_UserListAccessStatus `protobuf:"varint,16,opt,name=account_user_list_status,json=accountUserListStatus,proto3,enum=google.ads.googleads.v8.enums.UserListAccessStatusEnum_UserListAccessStatus" json:"account_user_list_status,omitempty"`
...
func (x *UserList) Reset() {
	*x = UserList{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_resources_user_list_proto_msgTypes[0]
...
func (*UserList) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_resources_user_list_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v8_resources_user_list_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v8_resources_user_list_proto_rawDesc = []byte{
	...
	0x2f, 0x76, 0x38, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x6c,
	...
	0x76, 0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73,
	...
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x55, 0x73, 0x65,
	...
	0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x55,
	...
	0x73, 0x2e, 0x76, 0x38, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x43, 0x72, 0x6d, 0x42,
	...
	0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64,
	0x73, 0x2e, 0x76, 0x38, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x52, 0x75, 0x6c, 0x65,
...
var (
	file_google_ads_googleads_v8_resources_user_list_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_resources_user_list_proto_rawDescData = file_google_ads_googleads_v8_resources_user_list_proto_rawDesc
)

func file_google_ads_googleads_v8_resources_user_list_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_resources_user_list_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_resources_user_list_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_resources_user_list_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_resources_user_list_proto_rawDescData
}

var file_google_ads_googleads_v8_resources_user_list_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v8_resources_user_list_proto_goTypes = []interface{}{
	(*UserList)(nil), // 0: google.ads.googleads.v8.resources.UserList
	(enums.UserListMembershipStatusEnum_UserListMembershipStatus)(0), // 1: google.ads.googleads.v8.enums.UserListMembershipStatusEnum.UserListMembershipStatus
	(enums.UserListSizeRangeEnum_UserListSizeRange)(0),               // 2: google.ads.googleads.v8.enums.UserListSizeRangeEnum.UserListSizeRange
	(enums.UserListTypeEnum_UserListType)(0),                         // 3: google.ads.googleads.v8.enums.UserListTypeEnum.UserListType
	(enums.UserListClosingReasonEnum_UserListClosingReason)(0),       // 4: google.ads.googleads.v8.enums.UserListClosingReasonEnum.UserListClosingReason
	(enums.AccessReasonEnum_AccessReason)(0),                         // 5: google.ads.googleads.v8.enums.AccessReasonEnum.AccessReason
	(enums.UserListAccessStatusEnum_UserListAccessStatus)(0),         // 6: google.ads.googleads.v8.enums.UserListAccessStatusEnum.UserListAccessStatus
	(*common.CrmBasedUserListInfo)(nil),                              // 7: google.ads.googleads.v8.common.CrmBasedUserListInfo
	(*common.SimilarUserListInfo)(nil),                               // 8: google.ads.googleads.v8.common.SimilarUserListInfo
	(*common.RuleBasedUserListInfo)(nil),                             // 9: google.ads.googleads.v8.common.RuleBasedUserListInfo
	(*common.LogicalUserListInfo)(nil),                               // 10: google.ads.googleads.v8.common.LogicalUserListInfo
	(*common.BasicUserListInfo)(nil),                                 // 11: google.ads.googleads.v8.common.BasicUserListInfo
}
var file_google_ads_googleads_v8_resources_user_list_proto_depIdxs = []int32{
	1,  // 0: google.ads.googleads.v8.resources.UserList.membership_status:type_name -> google.ads.googleads.v8.enums.UserListMembershipStatusEnum.UserListMembershipStatus
	2,  // 1: google.ads.googleads.v8.resources.UserList.size_range_for_display:type_name -> google.ads.googleads.v8.enums.UserListSizeRangeEnum.UserListSizeRange
	2,  // 2: google.ads.googleads.v8.resources.UserList.size_range_for_search:type_name -> google.ads.googleads.v8.enums.UserListSizeRangeEnum.UserListSizeRange
	3,  // 3: google.ads.googleads.v8.resources.UserList.type:type_name -> google.ads.googleads.v8.enums.UserListTypeEnum.UserListType
	4,  // 4: google.ads.googleads.v8.resources.UserList.closing_reason:type_name -> google.ads.googleads.v8.enums.UserListClosingReasonEnum.UserListClosingReason
	5,  // 5: google.ads.googleads.v8.resources.UserList.access_reason:type_name -> google.ads.googleads.v8.enums.AccessReasonEnum.AccessReason
	6,  // 6: google.ads.googleads.v8.resources.UserList.account_user_list_status:type_name -> google.ads.googleads.v8.enums.UserListAccessStatusEnum.UserListAccessStatus
	7,  // 7: google.ads.googleads.v8.resources.UserList.crm_based_user_list:type_name -> google.ads.googleads.v8.common.CrmBasedUserListInfo
	8,  // 8: google.ads.googleads.v8.resources.UserList.similar_user_list:type_name -> google.ads.googleads.v8.common.SimilarUserListInfo
	9,  // 9: google.ads.googleads.v8.resources.UserList.rule_based_user_list:type_name -> google.ads.googleads.v8.common.RuleBasedUserListInfo
	10, // 10: google.ads.googleads.v8.resources.UserList.logical_user_list:type_name -> google.ads.googleads.v8.common.LogicalUserListInfo
	11, // 11: google.ads.googleads.v8.resources.UserList.basic_user_list:type_name -> google.ads.googleads.v8.common.BasicUserListInfo
...
func init() { file_google_ads_googleads_v8_resources_user_list_proto_init() }
func file_google_ads_googleads_v8_resources_user_list_proto_init() {
	if File_google_ads_googleads_v8_resources_user_list_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_resources_user_list_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_resources_user_list_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_resources_user_list_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v8_resources_user_list_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_resources_user_list_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_resources_user_list_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_resources_user_list_proto = out.File
	file_google_ads_googleads_v8_resources_user_list_proto_rawDesc = nil
	file_google_ads_googleads_v8_resources_user_list_proto_goTypes = nil
	file_google_ads_googleads_v8_resources_user_list_proto_depIdxs = nil
}
