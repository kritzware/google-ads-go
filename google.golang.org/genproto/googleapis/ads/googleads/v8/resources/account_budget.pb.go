...
type AccountBudget struct {
	...
	Status enums.AccountBudgetStatusEnum_AccountBudgetStatus `protobuf:"varint,4,opt,name=status,proto3,enum=google.ads.googleads.v8.enums.AccountBudgetStatusEnum_AccountBudgetStatus" json:"status,omitempty"`
...
func (x *AccountBudget) Reset() {
	*x = AccountBudget{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_resources_account_budget_proto_msgTypes[0]
...
func (*AccountBudget) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_resources_account_budget_proto_rawDescGZIP(), []int{0}
}
...
type AccountBudget_ApprovedEndTimeType struct {
	...
	ApprovedEndTimeType enums.TimeTypeEnum_TimeType `protobuf:"varint,11,opt,name=approved_end_time_type,json=approvedEndTimeType,proto3,enum=google.ads.googleads.v8.enums.TimeTypeEnum_TimeType,oneof"`
}
...
type AccountBudget_ProposedSpendingLimitType struct {
	...
	ProposedSpendingLimitType enums.SpendingLimitTypeEnum_SpendingLimitType `protobuf:"varint,13,opt,name=proposed_spending_limit_type,json=proposedSpendingLimitType,proto3,enum=google.ads.googleads.v8.enums.SpendingLimitTypeEnum_SpendingLimitType,oneof"`
}
...
type AccountBudget_ApprovedSpendingLimitType struct {
	...
	ApprovedSpendingLimitType enums.SpendingLimitTypeEnum_SpendingLimitType `protobuf:"varint,15,opt,name=approved_spending_limit_type,json=approvedSpendingLimitType,proto3,enum=google.ads.googleads.v8.enums.SpendingLimitTypeEnum_SpendingLimitType,oneof"`
}
...
type AccountBudget_AdjustedSpendingLimitType struct {
	...
	// INFINITE.
	AdjustedSpendingLimitType enums.SpendingLimitTypeEnum_SpendingLimitType `protobuf:"varint,17,opt,name=adjusted_spending_limit_type,json=adjustedSpendingLimitType,proto3,enum=google.ads.googleads.v8.enums.SpendingLimitTypeEnum_SpendingLimitType,oneof"`
}
...
type AccountBudget_PendingAccountBudgetProposal struct {
	...
	// with this proposal.
	ProposalType enums.AccountBudgetProposalTypeEnum_AccountBudgetProposalType `protobuf:"varint,2,opt,name=proposal_type,json=proposalType,proto3,enum=google.ads.googleads.v8.enums.AccountBudgetProposalTypeEnum_AccountBudgetProposalType" json:"proposal_type,omitempty"`
...
func (x *AccountBudget_PendingAccountBudgetProposal) Reset() {
	*x = AccountBudget_PendingAccountBudgetProposal{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_resources_account_budget_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AccountBudget_PendingAccountBudgetProposal) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_resources_account_budget_proto_rawDescGZIP(), []int{0, 0}
}
...
type AccountBudget_PendingAccountBudgetProposal_EndTimeType struct {
	...
	EndTimeType enums.TimeTypeEnum_TimeType `protobuf:"varint,6,opt,name=end_time_type,json=endTimeType,proto3,enum=google.ads.googleads.v8.enums.TimeTypeEnum_TimeType,oneof"`
}
...
type AccountBudget_PendingAccountBudgetProposal_SpendingLimitType struct {
	...
	SpendingLimitType enums.SpendingLimitTypeEnum_SpendingLimitType `protobuf:"varint,8,opt,name=spending_limit_type,json=spendingLimitType,proto3,enum=google.ads.googleads.v8.enums.SpendingLimitTypeEnum_SpendingLimitType,oneof"`
}
...
var File_google_ads_googleads_v8_resources_account_budget_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v8_resources_account_budget_proto_rawDesc = []byte{
	...
	0x38, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x1a, 0x40, 0x67, 0x6f, 0x6f,
	0x67, 0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64,
	0x73, 0x2f, 0x76, 0x38, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x61, 0x63, 0x63, 0x6f, 0x75,
	...
	0x61, 0x64, 0x73, 0x2f, 0x76, 0x38, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x61, 0x63, 0x63,
	...
	0x38, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x73, 0x70, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67,
	...
	0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x53, 0x70,
	...
	0x76, 0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x54, 0x79, 0x70,
	...
	0x73, 0x2e, 0x76, 0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x53, 0x70, 0x65, 0x6e, 0x64,
	...
	0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e,
	0x76, 0x38, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x12, 0x41, 0x63,
...
var (
	file_google_ads_googleads_v8_resources_account_budget_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_resources_account_budget_proto_rawDescData = file_google_ads_googleads_v8_resources_account_budget_proto_rawDesc
)

func file_google_ads_googleads_v8_resources_account_budget_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_resources_account_budget_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_resources_account_budget_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_resources_account_budget_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_resources_account_budget_proto_rawDescData
}

var file_google_ads_googleads_v8_resources_account_budget_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v8_resources_account_budget_proto_goTypes = []interface{}{
	(*AccountBudget)(nil),                                              // 0: google.ads.googleads.v8.resources.AccountBudget
	(*AccountBudget_PendingAccountBudgetProposal)(nil),                 // 1: google.ads.googleads.v8.resources.AccountBudget.PendingAccountBudgetProposal
	(enums.AccountBudgetStatusEnum_AccountBudgetStatus)(0),             // 2: google.ads.googleads.v8.enums.AccountBudgetStatusEnum.AccountBudgetStatus
	...
	(enums.AccountBudgetProposalTypeEnum_AccountBudgetProposalType)(0), // 5: google.ads.googleads.v8.enums.AccountBudgetProposalTypeEnum.AccountBudgetProposalType
}
var file_google_ads_googleads_v8_resources_account_budget_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v8.resources.AccountBudget.status:type_name -> google.ads.googleads.v8.enums.AccountBudgetStatusEnum.AccountBudgetStatus
	1,  // 1: google.ads.googleads.v8.resources.AccountBudget.pending_proposal:type_name -> google.ads.googleads.v8.resources.AccountBudget.PendingAccountBudgetProposal
	3,  // 2: google.ads.googleads.v8.resources.AccountBudget.proposed_end_time_type:type_name -> google.ads.googleads.v8.enums.TimeTypeEnum.TimeType
	3,  // 3: google.ads.googleads.v8.resources.AccountBudget.approved_end_time_type:type_name -> google.ads.googleads.v8.enums.TimeTypeEnum.TimeType
	4,  // 4: google.ads.googleads.v8.resources.AccountBudget.proposed_spending_limit_type:type_name -> google.ads.googleads.v8.enums.SpendingLimitTypeEnum.SpendingLimitType
	4,  // 5: google.ads.googleads.v8.resources.AccountBudget.approved_spending_limit_type:type_name -> google.ads.googleads.v8.enums.SpendingLimitTypeEnum.SpendingLimitType
	4,  // 6: google.ads.googleads.v8.resources.AccountBudget.adjusted_spending_limit_type:type_name -> google.ads.googleads.v8.enums.SpendingLimitTypeEnum.SpendingLimitType
	5,  // 7: google.ads.googleads.v8.resources.AccountBudget.PendingAccountBudgetProposal.proposal_type:type_name -> google.ads.googleads.v8.enums.AccountBudgetProposalTypeEnum.AccountBudgetProposalType
	3,  // 8: google.ads.googleads.v8.resources.AccountBudget.PendingAccountBudgetProposal.end_time_type:type_name -> google.ads.googleads.v8.enums.TimeTypeEnum.TimeType
	4,  // 9: google.ads.googleads.v8.resources.AccountBudget.PendingAccountBudgetProposal.spending_limit_type:type_name -> google.ads.googleads.v8.enums.SpendingLimitTypeEnum.SpendingLimitType
...
func init() { file_google_ads_googleads_v8_resources_account_budget_proto_init() }
func file_google_ads_googleads_v8_resources_account_budget_proto_init() {
	if File_google_ads_googleads_v8_resources_account_budget_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_resources_account_budget_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_resources_account_budget_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_resources_account_budget_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	file_google_ads_googleads_v8_resources_account_budget_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_resources_account_budget_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v8_resources_account_budget_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_resources_account_budget_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_resources_account_budget_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_resources_account_budget_proto = out.File
	file_google_ads_googleads_v8_resources_account_budget_proto_rawDesc = nil
	file_google_ads_googleads_v8_resources_account_budget_proto_goTypes = nil
	file_google_ads_googleads_v8_resources_account_budget_proto_depIdxs = nil
}
