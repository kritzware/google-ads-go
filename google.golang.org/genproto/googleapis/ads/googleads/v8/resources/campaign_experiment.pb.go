...
type CampaignExperiment struct {
	...
	Status enums.CampaignExperimentStatusEnum_CampaignExperimentStatus `protobuf:"varint,9,opt,name=status,proto3,enum=google.ads.googleads.v8.enums.CampaignExperimentStatusEnum_CampaignExperimentStatus" json:"status,omitempty"`
...
func (x *CampaignExperiment) Reset() {
	*x = CampaignExperiment{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_resources_campaign_experiment_proto_msgTypes[0]
...
func (*CampaignExperiment) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_resources_campaign_experiment_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v8_resources_campaign_experiment_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v8_resources_campaign_experiment_proto_rawDesc = []byte{
	...
	0x76, 0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67,
	...
	0x73, 0x2e, 0x76, 0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x43, 0x61, 0x6d, 0x70, 0x61,
...
var (
	file_google_ads_googleads_v8_resources_campaign_experiment_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_resources_campaign_experiment_proto_rawDescData = file_google_ads_googleads_v8_resources_campaign_experiment_proto_rawDesc
)

func file_google_ads_googleads_v8_resources_campaign_experiment_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_resources_campaign_experiment_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_resources_campaign_experiment_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_resources_campaign_experiment_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_resources_campaign_experiment_proto_rawDescData
}

var file_google_ads_googleads_v8_resources_campaign_experiment_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v8_resources_campaign_experiment_proto_goTypes = []interface{}{
	(*CampaignExperiment)(nil), // 0: google.ads.googleads.v8.resources.CampaignExperiment
	(enums.CampaignExperimentTrafficSplitTypeEnum_CampaignExperimentTrafficSplitType)(0), // 1: google.ads.googleads.v8.enums.CampaignExperimentTrafficSplitTypeEnum.CampaignExperimentTrafficSplitType
	(enums.CampaignExperimentStatusEnum_CampaignExperimentStatus)(0),                     // 2: google.ads.googleads.v8.enums.CampaignExperimentStatusEnum.CampaignExperimentStatus
}
var file_google_ads_googleads_v8_resources_campaign_experiment_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v8.resources.CampaignExperiment.traffic_split_type:type_name -> google.ads.googleads.v8.enums.CampaignExperimentTrafficSplitTypeEnum.CampaignExperimentTrafficSplitType
	2, // 1: google.ads.googleads.v8.resources.CampaignExperiment.status:type_name -> google.ads.googleads.v8.enums.CampaignExperimentStatusEnum.CampaignExperimentStatus
...
func init() { file_google_ads_googleads_v8_resources_campaign_experiment_proto_init() }
func file_google_ads_googleads_v8_resources_campaign_experiment_proto_init() {
	if File_google_ads_googleads_v8_resources_campaign_experiment_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_resources_campaign_experiment_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_resources_campaign_experiment_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v8_resources_campaign_experiment_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v8_resources_campaign_experiment_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_resources_campaign_experiment_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_resources_campaign_experiment_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_resources_campaign_experiment_proto = out.File
	file_google_ads_googleads_v8_resources_campaign_experiment_proto_rawDesc = nil
	file_google_ads_googleads_v8_resources_campaign_experiment_proto_goTypes = nil
	file_google_ads_googleads_v8_resources_campaign_experiment_proto_depIdxs = nil
}
