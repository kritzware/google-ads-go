...
type FeedItemTarget struct {
	...
	FeedItemTargetType enums.FeedItemTargetTypeEnum_FeedItemTargetType `protobuf:"varint,3,opt,name=feed_item_target_type,json=feedItemTargetType,proto3,enum=google.ads.googleads.v8.enums.FeedItemTargetTypeEnum_FeedItemTargetType" json:"feed_item_target_type,omitempty"`
	...
	Status enums.FeedItemTargetStatusEnum_FeedItemTargetStatus `protobuf:"varint,11,opt,name=status,proto3,enum=google.ads.googleads.v8.enums.FeedItemTargetStatusEnum_FeedItemTargetStatus" json:"status,omitempty"`
...
func (x *FeedItemTarget) Reset() {
	*x = FeedItemTarget{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_resources_feed_item_target_proto_msgTypes[0]
...
func (*FeedItemTarget) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_resources_feed_item_target_proto_rawDescGZIP(), []int{0}
}
...
type FeedItemTarget_Device struct {
	...
	Device enums.FeedItemTargetDeviceEnum_FeedItemTargetDevice `protobuf:"varint,9,opt,name=device,proto3,enum=google.ads.googleads.v8.enums.FeedItemTargetDeviceEnum_FeedItemTargetDevice,oneof"`
}
...
var File_google_ads_googleads_v8_resources_feed_item_target_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v8_resources_feed_item_target_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x38, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x1a, 0x2d, 0x67,
	...
	0x76, 0x38, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x66, 0x65, 0x65, 0x64, 0x5f, 0x69, 0x74,
	...
	0x38, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x13, 0x46, 0x65, 0x65,
...
var (
	file_google_ads_googleads_v8_resources_feed_item_target_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_resources_feed_item_target_proto_rawDescData = file_google_ads_googleads_v8_resources_feed_item_target_proto_rawDesc
)

func file_google_ads_googleads_v8_resources_feed_item_target_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_resources_feed_item_target_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_resources_feed_item_target_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_resources_feed_item_target_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_resources_feed_item_target_proto_rawDescData
}

var file_google_ads_googleads_v8_resources_feed_item_target_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v8_resources_feed_item_target_proto_goTypes = []interface{}{
	(*FeedItemTarget)(nil),                                   // 0: google.ads.googleads.v8.resources.FeedItemTarget
	(enums.FeedItemTargetTypeEnum_FeedItemTargetType)(0),     // 1: google.ads.googleads.v8.enums.FeedItemTargetTypeEnum.FeedItemTargetType
	(enums.FeedItemTargetStatusEnum_FeedItemTargetStatus)(0), // 2: google.ads.googleads.v8.enums.FeedItemTargetStatusEnum.FeedItemTargetStatus
	(*common.KeywordInfo)(nil),                               // 3: google.ads.googleads.v8.common.KeywordInfo
	(enums.FeedItemTargetDeviceEnum_FeedItemTargetDevice)(0), // 4: google.ads.googleads.v8.enums.FeedItemTargetDeviceEnum.FeedItemTargetDevice
	(*common.AdScheduleInfo)(nil),                            // 5: google.ads.googleads.v8.common.AdScheduleInfo
}
var file_google_ads_googleads_v8_resources_feed_item_target_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v8.resources.FeedItemTarget.feed_item_target_type:type_name -> google.ads.googleads.v8.enums.FeedItemTargetTypeEnum.FeedItemTargetType
	2, // 1: google.ads.googleads.v8.resources.FeedItemTarget.status:type_name -> google.ads.googleads.v8.enums.FeedItemTargetStatusEnum.FeedItemTargetStatus
	3, // 2: google.ads.googleads.v8.resources.FeedItemTarget.keyword:type_name -> google.ads.googleads.v8.common.KeywordInfo
	4, // 3: google.ads.googleads.v8.resources.FeedItemTarget.device:type_name -> google.ads.googleads.v8.enums.FeedItemTargetDeviceEnum.FeedItemTargetDevice
	5, // 4: google.ads.googleads.v8.resources.FeedItemTarget.ad_schedule:type_name -> google.ads.googleads.v8.common.AdScheduleInfo
...
func init() { file_google_ads_googleads_v8_resources_feed_item_target_proto_init() }
func file_google_ads_googleads_v8_resources_feed_item_target_proto_init() {
	if File_google_ads_googleads_v8_resources_feed_item_target_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_resources_feed_item_target_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_resources_feed_item_target_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_resources_feed_item_target_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v8_resources_feed_item_target_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_resources_feed_item_target_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_resources_feed_item_target_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_resources_feed_item_target_proto = out.File
	file_google_ads_googleads_v8_resources_feed_item_target_proto_rawDesc = nil
	file_google_ads_googleads_v8_resources_feed_item_target_proto_goTypes = nil
	file_google_ads_googleads_v8_resources_feed_item_target_proto_depIdxs = nil
}
