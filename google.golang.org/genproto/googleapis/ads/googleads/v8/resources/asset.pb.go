...
type Asset struct {
	...
	Type enums.AssetTypeEnum_AssetType `protobuf:"varint,4,opt,name=type,proto3,enum=google.ads.googleads.v8.enums.AssetTypeEnum_AssetType" json:"type,omitempty"`
...
func (x *Asset) Reset() {
	*x = Asset{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_resources_asset_proto_msgTypes[0]
...
func (*Asset) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_resources_asset_proto_rawDescGZIP(), []int{0}
}
...
type AssetPolicySummary struct {
	...
	ReviewStatus enums.PolicyReviewStatusEnum_PolicyReviewStatus `protobuf:"varint,2,opt,name=review_status,json=reviewStatus,proto3,enum=google.ads.googleads.v8.enums.PolicyReviewStatusEnum_PolicyReviewStatus" json:"review_status,omitempty"`
	...
	ApprovalStatus enums.PolicyApprovalStatusEnum_PolicyApprovalStatus `protobuf:"varint,3,opt,name=approval_status,json=approvalStatus,proto3,enum=google.ads.googleads.v8.enums.PolicyApprovalStatusEnum_PolicyApprovalStatus" json:"approval_status,omitempty"`
}

func (x *AssetPolicySummary) Reset() {
	*x = AssetPolicySummary{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_resources_asset_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AssetPolicySummary) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_resources_asset_proto_rawDescGZIP(), []int{1}
}
...
var File_google_ads_googleads_v8_resources_asset_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v8_resources_asset_proto_rawDesc = []byte{
	...
	0x73, 0x2f, 0x76, 0x38, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x70, 0x6f, 0x6c, 0x69,
	0x63, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2f, 0x76,
	0x38, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x61, 0x73, 0x73, 0x65, 0x74, 0x5f, 0x74, 0x79,
	0x70, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x3a, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2f, 0x76,
	0x38, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x5f, 0x61,
	...
	0x64, 0x73, 0x2e, 0x76, 0x38, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x59, 0x6f, 0x75,
	...
	0x38, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x54, 0x65, 0x78, 0x74, 0x41, 0x73, 0x73,
	...
	0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61,
	0x64, 0x73, 0x2e, 0x76, 0x38, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x42, 0x6f, 0x6f,
	...
	0x2e, 0x76, 0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79,
...
var (
	file_google_ads_googleads_v8_resources_asset_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_resources_asset_proto_rawDescData = file_google_ads_googleads_v8_resources_asset_proto_rawDesc
)

func file_google_ads_googleads_v8_resources_asset_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_resources_asset_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_resources_asset_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_resources_asset_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_resources_asset_proto_rawDescData
}

var file_google_ads_googleads_v8_resources_asset_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v8_resources_asset_proto_goTypes = []interface{}{
	(*Asset)(nil),                                            // 0: google.ads.googleads.v8.resources.Asset
	(*AssetPolicySummary)(nil),                               // 1: google.ads.googleads.v8.resources.AssetPolicySummary
	(enums.AssetTypeEnum_AssetType)(0),                       // 2: google.ads.googleads.v8.enums.AssetTypeEnum.AssetType
	(*common.CustomParameter)(nil),                           // 3: google.ads.googleads.v8.common.CustomParameter
	(*common.YoutubeVideoAsset)(nil),                         // 4: google.ads.googleads.v8.common.YoutubeVideoAsset
	(*common.MediaBundleAsset)(nil),                          // 5: google.ads.googleads.v8.common.MediaBundleAsset
	(*common.ImageAsset)(nil),                                // 6: google.ads.googleads.v8.common.ImageAsset
	(*common.TextAsset)(nil),                                 // 7: google.ads.googleads.v8.common.TextAsset
	(*common.LeadFormAsset)(nil),                             // 8: google.ads.googleads.v8.common.LeadFormAsset
	(*common.BookOnGoogleAsset)(nil),                         // 9: google.ads.googleads.v8.common.BookOnGoogleAsset
	(*common.PromotionAsset)(nil),                            // 10: google.ads.googleads.v8.common.PromotionAsset
	(*common.CalloutAsset)(nil),                              // 11: google.ads.googleads.v8.common.CalloutAsset
	(*common.StructuredSnippetAsset)(nil),                    // 12: google.ads.googleads.v8.common.StructuredSnippetAsset
	(*common.SitelinkAsset)(nil),                             // 13: google.ads.googleads.v8.common.SitelinkAsset
	(*common.PolicyTopicEntry)(nil),                          // 14: google.ads.googleads.v8.common.PolicyTopicEntry
	(enums.PolicyReviewStatusEnum_PolicyReviewStatus)(0),     // 15: google.ads.googleads.v8.enums.PolicyReviewStatusEnum.PolicyReviewStatus
	(enums.PolicyApprovalStatusEnum_PolicyApprovalStatus)(0), // 16: google.ads.googleads.v8.enums.PolicyApprovalStatusEnum.PolicyApprovalStatus
}
var file_google_ads_googleads_v8_resources_asset_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v8.resources.Asset.type:type_name -> google.ads.googleads.v8.enums.AssetTypeEnum.AssetType
	3,  // 1: google.ads.googleads.v8.resources.Asset.url_custom_parameters:type_name -> google.ads.googleads.v8.common.CustomParameter
	1,  // 2: google.ads.googleads.v8.resources.Asset.policy_summary:type_name -> google.ads.googleads.v8.resources.AssetPolicySummary
	4,  // 3: google.ads.googleads.v8.resources.Asset.youtube_video_asset:type_name -> google.ads.googleads.v8.common.YoutubeVideoAsset
	5,  // 4: google.ads.googleads.v8.resources.Asset.media_bundle_asset:type_name -> google.ads.googleads.v8.common.MediaBundleAsset
	6,  // 5: google.ads.googleads.v8.resources.Asset.image_asset:type_name -> google.ads.googleads.v8.common.ImageAsset
	7,  // 6: google.ads.googleads.v8.resources.Asset.text_asset:type_name -> google.ads.googleads.v8.common.TextAsset
	8,  // 7: google.ads.googleads.v8.resources.Asset.lead_form_asset:type_name -> google.ads.googleads.v8.common.LeadFormAsset
	9,  // 8: google.ads.googleads.v8.resources.Asset.book_on_google_asset:type_name -> google.ads.googleads.v8.common.BookOnGoogleAsset
	10, // 9: google.ads.googleads.v8.resources.Asset.promotion_asset:type_name -> google.ads.googleads.v8.common.PromotionAsset
	11, // 10: google.ads.googleads.v8.resources.Asset.callout_asset:type_name -> google.ads.googleads.v8.common.CalloutAsset
	12, // 11: google.ads.googleads.v8.resources.Asset.structured_snippet_asset:type_name -> google.ads.googleads.v8.common.StructuredSnippetAsset
	13, // 12: google.ads.googleads.v8.resources.Asset.sitelink_asset:type_name -> google.ads.googleads.v8.common.SitelinkAsset
	14, // 13: google.ads.googleads.v8.resources.AssetPolicySummary.policy_topic_entries:type_name -> google.ads.googleads.v8.common.PolicyTopicEntry
	15, // 14: google.ads.googleads.v8.resources.AssetPolicySummary.review_status:type_name -> google.ads.googleads.v8.enums.PolicyReviewStatusEnum.PolicyReviewStatus
	16, // 15: google.ads.googleads.v8.resources.AssetPolicySummary.approval_status:type_name -> google.ads.googleads.v8.enums.PolicyApprovalStatusEnum.PolicyApprovalStatus
...
func init() { file_google_ads_googleads_v8_resources_asset_proto_init() }
func file_google_ads_googleads_v8_resources_asset_proto_init() {
	if File_google_ads_googleads_v8_resources_asset_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_resources_asset_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Asset); i {
			case 0:
				return &v.state
			case 1:
		...
		file_google_ads_googleads_v8_resources_asset_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_resources_asset_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_resources_asset_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v8_resources_asset_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_resources_asset_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_resources_asset_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_resources_asset_proto = out.File
	file_google_ads_googleads_v8_resources_asset_proto_rawDesc = nil
	file_google_ads_googleads_v8_resources_asset_proto_goTypes = nil
	file_google_ads_googleads_v8_resources_asset_proto_depIdxs = nil
}
