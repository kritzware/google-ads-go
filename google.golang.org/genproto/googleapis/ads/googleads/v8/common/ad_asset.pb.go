...
type AdTextAsset struct {
	...
	PinnedField enums.ServedAssetFieldTypeEnum_ServedAssetFieldType `protobuf:"varint,2,opt,name=pinned_field,json=pinnedField,proto3,enum=google.ads.googleads.v8.enums.ServedAssetFieldTypeEnum_ServedAssetFieldType" json:"pinned_field,omitempty"`
	// The performance label of this text asset.
	AssetPerformanceLabel enums.AssetPerformanceLabelEnum_AssetPerformanceLabel `protobuf:"varint,5,opt,name=asset_performance_label,json=assetPerformanceLabel,proto3,enum=google.ads.googleads.v8.enums.AssetPerformanceLabelEnum_AssetPerformanceLabel" json:"asset_performance_label,omitempty"`
...
func (x *AdTextAsset) Reset() {
	*x = AdTextAsset{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_common_ad_asset_proto_msgTypes[0]
...
func (*AdTextAsset) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_common_ad_asset_proto_rawDescGZIP(), []int{0}
}
...
func (x *AdImageAsset) Reset() {
	*x = AdImageAsset{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_common_ad_asset_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdImageAsset) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_common_ad_asset_proto_rawDescGZIP(), []int{1}
}
...
func (x *AdVideoAsset) Reset() {
	*x = AdVideoAsset{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_common_ad_asset_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdVideoAsset) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_common_ad_asset_proto_rawDescGZIP(), []int{2}
}
...
func (x *AdMediaBundleAsset) Reset() {
	*x = AdMediaBundleAsset{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_common_ad_asset_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdMediaBundleAsset) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_common_ad_asset_proto_rawDescGZIP(), []int{3}
}
...
var file_google_ads_googleads_v8_common_ad_asset_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x61, 0x64, 0x73, 0x2f, 0x76, 0x38, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x73,
	...
	0x2e, 0x76, 0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x64,
	...
	0x73, 0x2e, 0x76, 0x38, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x41, 0x64, 0x41, 0x73,
	...
	0x38, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x42, 0x0c, 0x41, 0x64, 0x41, 0x73, 0x73, 0x65,
...
var (
	file_google_ads_googleads_v8_common_ad_asset_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_common_ad_asset_proto_rawDescData = file_google_ads_googleads_v8_common_ad_asset_proto_rawDesc
)

func file_google_ads_googleads_v8_common_ad_asset_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_common_ad_asset_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_common_ad_asset_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_common_ad_asset_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_common_ad_asset_proto_rawDescData
}

var file_google_ads_googleads_v8_common_ad_asset_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v8_common_ad_asset_proto_goTypes = []interface{}{
	(*AdTextAsset)(nil),        // 0: google.ads.googleads.v8.common.AdTextAsset
	(*AdImageAsset)(nil),       // 1: google.ads.googleads.v8.common.AdImageAsset
	(*AdVideoAsset)(nil),       // 2: google.ads.googleads.v8.common.AdVideoAsset
	(*AdMediaBundleAsset)(nil), // 3: google.ads.googleads.v8.common.AdMediaBundleAsset
	(enums.ServedAssetFieldTypeEnum_ServedAssetFieldType)(0),   // 4: google.ads.googleads.v8.enums.ServedAssetFieldTypeEnum.ServedAssetFieldType
	(enums.AssetPerformanceLabelEnum_AssetPerformanceLabel)(0), // 5: google.ads.googleads.v8.enums.AssetPerformanceLabelEnum.AssetPerformanceLabel
	(*AdAssetPolicySummary)(nil),                               // 6: google.ads.googleads.v8.common.AdAssetPolicySummary
}
var file_google_ads_googleads_v8_common_ad_asset_proto_depIdxs = []int32{
	4, // 0: google.ads.googleads.v8.common.AdTextAsset.pinned_field:type_name -> google.ads.googleads.v8.enums.ServedAssetFieldTypeEnum.ServedAssetFieldType
	5, // 1: google.ads.googleads.v8.common.AdTextAsset.asset_performance_label:type_name -> google.ads.googleads.v8.enums.AssetPerformanceLabelEnum.AssetPerformanceLabel
	6, // 2: google.ads.googleads.v8.common.AdTextAsset.policy_summary_info:type_name -> google.ads.googleads.v8.common.AdAssetPolicySummary
...
func init() { file_google_ads_googleads_v8_common_ad_asset_proto_init() }
func file_google_ads_googleads_v8_common_ad_asset_proto_init() {
	if File_google_ads_googleads_v8_common_ad_asset_proto != nil {
		return
	}
	file_google_ads_googleads_v8_common_asset_policy_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_common_ad_asset_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_common_ad_asset_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_common_ad_asset_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_common_ad_asset_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_common_ad_asset_proto_msgTypes[0].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v8_common_ad_asset_proto_msgTypes[1].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v8_common_ad_asset_proto_msgTypes[2].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v8_common_ad_asset_proto_msgTypes[3].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v8_common_ad_asset_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v8_common_ad_asset_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_common_ad_asset_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_common_ad_asset_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_common_ad_asset_proto = out.File
	file_google_ads_googleads_v8_common_ad_asset_proto_rawDesc = nil
	file_google_ads_googleads_v8_common_ad_asset_proto_goTypes = nil
	file_google_ads_googleads_v8_common_ad_asset_proto_depIdxs = nil
}
