...
type TagSnippet struct {
	...
	Type enums.TrackingCodeTypeEnum_TrackingCodeType `protobuf:"varint,1,opt,name=type,proto3,enum=google.ads.googleads.v8.enums.TrackingCodeTypeEnum_TrackingCodeType" json:"type,omitempty"`
	// The format of the web page where the tracking tag and snippet will be
	// installed, e.g. HTML.
	PageFormat enums.TrackingCodePageFormatEnum_TrackingCodePageFormat `protobuf:"varint,2,opt,name=page_format,json=pageFormat,proto3,enum=google.ads.googleads.v8.enums.TrackingCodePageFormatEnum_TrackingCodePageFormat" json:"page_format,omitempty"`
...
func (x *TagSnippet) Reset() {
	*x = TagSnippet{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_common_tag_snippet_proto_msgTypes[0]
...
func (*TagSnippet) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_common_tag_snippet_proto_rawDescGZIP(), []int{0}
}
...
var file_google_ads_googleads_v8_common_tag_snippet_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v8_common_tag_snippet_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_common_tag_snippet_proto_rawDescData = file_google_ads_googleads_v8_common_tag_snippet_proto_rawDesc
)

func file_google_ads_googleads_v8_common_tag_snippet_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_common_tag_snippet_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_common_tag_snippet_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_common_tag_snippet_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_common_tag_snippet_proto_rawDescData
}

var file_google_ads_googleads_v8_common_tag_snippet_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v8_common_tag_snippet_proto_goTypes = []interface{}{
	(*TagSnippet)(nil), // 0: google.ads.googleads.v8.common.TagSnippet
	(enums.TrackingCodeTypeEnum_TrackingCodeType)(0),             // 1: google.ads.googleads.v8.enums.TrackingCodeTypeEnum.TrackingCodeType
	(enums.TrackingCodePageFormatEnum_TrackingCodePageFormat)(0), // 2: google.ads.googleads.v8.enums.TrackingCodePageFormatEnum.TrackingCodePageFormat
}
var file_google_ads_googleads_v8_common_tag_snippet_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v8.common.TagSnippet.type:type_name -> google.ads.googleads.v8.enums.TrackingCodeTypeEnum.TrackingCodeType
	2, // 1: google.ads.googleads.v8.common.TagSnippet.page_format:type_name -> google.ads.googleads.v8.enums.TrackingCodePageFormatEnum.TrackingCodePageFormat
...
func init() { file_google_ads_googleads_v8_common_tag_snippet_proto_init() }
func file_google_ads_googleads_v8_common_tag_snippet_proto_init() {
	if File_google_ads_googleads_v8_common_tag_snippet_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_common_tag_snippet_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_common_tag_snippet_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v8_common_tag_snippet_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v8_common_tag_snippet_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_common_tag_snippet_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_common_tag_snippet_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_common_tag_snippet_proto = out.File
	file_google_ads_googleads_v8_common_tag_snippet_proto_rawDesc = nil
	file_google_ads_googleads_v8_common_tag_snippet_proto_goTypes = nil
	file_google_ads_googleads_v8_common_tag_snippet_proto_depIdxs = nil
}
