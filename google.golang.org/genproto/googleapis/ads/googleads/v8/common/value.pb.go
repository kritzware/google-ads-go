...
func (x *Value) Reset() {
	*x = Value{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_common_value_proto_msgTypes[0]
...
func (*Value) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_common_value_proto_rawDescGZIP(), []int{0}
}
...
var file_google_ads_googleads_v8_common_value_proto_rawDesc = []byte{
	...
	0x64, 0x73, 0x2e, 0x76, 0x38, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x1a, 0x1c, 0x67, 0x6f,
	...
	0x73, 0x2e, 0x76, 0x38, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x42, 0x0a, 0x56, 0x61, 0x6c,
	...
	0x38, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x3b, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0xa2,
	...
	0x3a, 0x3a, 0x56, 0x38, 0x3a, 0x3a, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_google_ads_googleads_v8_common_value_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_common_value_proto_rawDescData = file_google_ads_googleads_v8_common_value_proto_rawDesc
)

func file_google_ads_googleads_v8_common_value_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_common_value_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_common_value_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_common_value_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_common_value_proto_rawDescData
}

var file_google_ads_googleads_v8_common_value_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v8_common_value_proto_goTypes = []interface{}{
	(*Value)(nil), // 0: google.ads.googleads.v8.common.Value
}
var file_google_ads_googleads_v8_common_value_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v8_common_value_proto_init() }
func file_google_ads_googleads_v8_common_value_proto_init() {
	if File_google_ads_googleads_v8_common_value_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_common_value_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Value); i {
			case 0:
				return &v.state
			case 1:
	...
	file_google_ads_googleads_v8_common_value_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_common_value_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v8_common_value_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_common_value_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_common_value_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_common_value_proto = out.File
	file_google_ads_googleads_v8_common_value_proto_rawDesc = nil
	file_google_ads_googleads_v8_common_value_proto_goTypes = nil
	file_google_ads_googleads_v8_common_value_proto_depIdxs = nil
}
