...
func (x *GetCustomerLabelRequest) Reset() {
	*x = GetCustomerLabelRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_customer_label_service_proto_msgTypes[0]
...
func (*GetCustomerLabelRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_customer_label_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateCustomerLabelsRequest) Reset() {
	*x = MutateCustomerLabelsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_customer_label_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerLabelsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_customer_label_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *CustomerLabelOperation) Reset() {
	*x = CustomerLabelOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_customer_label_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CustomerLabelOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_customer_label_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomerLabelsResponse) Reset() {
	*x = MutateCustomerLabelsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_customer_label_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerLabelsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_customer_label_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateCustomerLabelResult) Reset() {
	*x = MutateCustomerLabelResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_customer_label_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerLabelResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_customer_label_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_customer_label_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v8_services_customer_label_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_customer_label_service_proto_rawDescData = file_google_ads_googleads_v8_services_customer_label_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_customer_label_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_customer_label_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_customer_label_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_customer_label_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_customer_label_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_customer_label_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_customer_label_service_proto_goTypes = []interface{}{
	(*GetCustomerLabelRequest)(nil),      // 0: google.ads.googleads.v8.services.GetCustomerLabelRequest
	(*MutateCustomerLabelsRequest)(nil),  // 1: google.ads.googleads.v8.services.MutateCustomerLabelsRequest
	(*CustomerLabelOperation)(nil),       // 2: google.ads.googleads.v8.services.CustomerLabelOperation
	(*MutateCustomerLabelsResponse)(nil), // 3: google.ads.googleads.v8.services.MutateCustomerLabelsResponse
	(*MutateCustomerLabelResult)(nil),    // 4: google.ads.googleads.v8.services.MutateCustomerLabelResult
	(*resources.CustomerLabel)(nil),      // 5: google.ads.googleads.v8.resources.CustomerLabel
	(*status.Status)(nil),                // 6: google.rpc.Status
}
var file_google_ads_googleads_v8_services_customer_label_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v8.services.MutateCustomerLabelsRequest.operations:type_name -> google.ads.googleads.v8.services.CustomerLabelOperation
	5, // 1: google.ads.googleads.v8.services.CustomerLabelOperation.create:type_name -> google.ads.googleads.v8.resources.CustomerLabel
	6, // 2: google.ads.googleads.v8.services.MutateCustomerLabelsResponse.partial_failure_error:type_name -> google.rpc.Status
	4, // 3: google.ads.googleads.v8.services.MutateCustomerLabelsResponse.results:type_name -> google.ads.googleads.v8.services.MutateCustomerLabelResult
	0, // 4: google.ads.googleads.v8.services.CustomerLabelService.GetCustomerLabel:input_type -> google.ads.googleads.v8.services.GetCustomerLabelRequest
	1, // 5: google.ads.googleads.v8.services.CustomerLabelService.MutateCustomerLabels:input_type -> google.ads.googleads.v8.services.MutateCustomerLabelsRequest
	5, // 6: google.ads.googleads.v8.services.CustomerLabelService.GetCustomerLabel:output_type -> google.ads.googleads.v8.resources.CustomerLabel
	3, // 7: google.ads.googleads.v8.services.CustomerLabelService.MutateCustomerLabels:output_type -> google.ads.googleads.v8.services.MutateCustomerLabelsResponse
...
func init() { file_google_ads_googleads_v8_services_customer_label_service_proto_init() }
func file_google_ads_googleads_v8_services_customer_label_service_proto_init() {
	if File_google_ads_googleads_v8_services_customer_label_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_customer_label_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_customer_label_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_customer_label_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_customer_label_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_customer_label_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_customer_label_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_customer_label_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_customer_label_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_customer_label_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_customer_label_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_customer_label_service_proto = out.File
	file_google_ads_googleads_v8_services_customer_label_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_customer_label_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_customer_label_service_proto_depIdxs = nil
}
