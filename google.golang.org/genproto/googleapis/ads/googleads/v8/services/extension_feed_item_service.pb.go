...
func (x *GetExtensionFeedItemRequest) Reset() {
	*x = GetExtensionFeedItemRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_extension_feed_item_service_proto_msgTypes[0]
...
func (*GetExtensionFeedItemRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_extension_feed_item_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateExtensionFeedItemsRequest) Reset() {
	*x = MutateExtensionFeedItemsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_extension_feed_item_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateExtensionFeedItemsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_extension_feed_item_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *ExtensionFeedItemOperation) Reset() {
	*x = ExtensionFeedItemOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_extension_feed_item_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ExtensionFeedItemOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_extension_feed_item_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateExtensionFeedItemsResponse) Reset() {
	*x = MutateExtensionFeedItemsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_extension_feed_item_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateExtensionFeedItemsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_extension_feed_item_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateExtensionFeedItemResult) Reset() {
	*x = MutateExtensionFeedItemResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_extension_feed_item_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateExtensionFeedItemResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_extension_feed_item_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_extension_feed_item_service_proto_rawDesc = []byte{
	...
	0x65, 0x6d, 0x22, 0x4c, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x36, 0x12, 0x34, 0x2f, 0x76, 0x38, 0x2f,
...
var (
	file_google_ads_googleads_v8_services_extension_feed_item_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_extension_feed_item_service_proto_rawDescData = file_google_ads_googleads_v8_services_extension_feed_item_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_extension_feed_item_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_extension_feed_item_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_extension_feed_item_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_extension_feed_item_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_extension_feed_item_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_extension_feed_item_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_extension_feed_item_service_proto_goTypes = []interface{}{
	(*GetExtensionFeedItemRequest)(nil),                    // 0: google.ads.googleads.v8.services.GetExtensionFeedItemRequest
	(*MutateExtensionFeedItemsRequest)(nil),                // 1: google.ads.googleads.v8.services.MutateExtensionFeedItemsRequest
	(*ExtensionFeedItemOperation)(nil),                     // 2: google.ads.googleads.v8.services.ExtensionFeedItemOperation
	(*MutateExtensionFeedItemsResponse)(nil),               // 3: google.ads.googleads.v8.services.MutateExtensionFeedItemsResponse
	(*MutateExtensionFeedItemResult)(nil),                  // 4: google.ads.googleads.v8.services.MutateExtensionFeedItemResult
	...
	(*resources.ExtensionFeedItem)(nil),                    // 7: google.ads.googleads.v8.resources.ExtensionFeedItem
	(*status.Status)(nil),                                  // 8: google.rpc.Status
}
var file_google_ads_googleads_v8_services_extension_feed_item_service_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v8.services.MutateExtensionFeedItemsRequest.operations:type_name -> google.ads.googleads.v8.services.ExtensionFeedItemOperation
	5,  // 1: google.ads.googleads.v8.services.MutateExtensionFeedItemsRequest.response_content_type:type_name -> google.ads.googleads.v8.enums.ResponseContentTypeEnum.ResponseContentType
	6,  // 2: google.ads.googleads.v8.services.ExtensionFeedItemOperation.update_mask:type_name -> google.protobuf.FieldMask
	7,  // 3: google.ads.googleads.v8.services.ExtensionFeedItemOperation.create:type_name -> google.ads.googleads.v8.resources.ExtensionFeedItem
	7,  // 4: google.ads.googleads.v8.services.ExtensionFeedItemOperation.update:type_name -> google.ads.googleads.v8.resources.ExtensionFeedItem
	8,  // 5: google.ads.googleads.v8.services.MutateExtensionFeedItemsResponse.partial_failure_error:type_name -> google.rpc.Status
	4,  // 6: google.ads.googleads.v8.services.MutateExtensionFeedItemsResponse.results:type_name -> google.ads.googleads.v8.services.MutateExtensionFeedItemResult
	7,  // 7: google.ads.googleads.v8.services.MutateExtensionFeedItemResult.extension_feed_item:type_name -> google.ads.googleads.v8.resources.ExtensionFeedItem
	0,  // 8: google.ads.googleads.v8.services.ExtensionFeedItemService.GetExtensionFeedItem:input_type -> google.ads.googleads.v8.services.GetExtensionFeedItemRequest
	1,  // 9: google.ads.googleads.v8.services.ExtensionFeedItemService.MutateExtensionFeedItems:input_type -> google.ads.googleads.v8.services.MutateExtensionFeedItemsRequest
	7,  // 10: google.ads.googleads.v8.services.ExtensionFeedItemService.GetExtensionFeedItem:output_type -> google.ads.googleads.v8.resources.ExtensionFeedItem
	3,  // 11: google.ads.googleads.v8.services.ExtensionFeedItemService.MutateExtensionFeedItems:output_type -> google.ads.googleads.v8.services.MutateExtensionFeedItemsResponse
...
func init() { file_google_ads_googleads_v8_services_extension_feed_item_service_proto_init() }
func file_google_ads_googleads_v8_services_extension_feed_item_service_proto_init() {
	if File_google_ads_googleads_v8_services_extension_feed_item_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_extension_feed_item_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_extension_feed_item_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_extension_feed_item_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_extension_feed_item_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_extension_feed_item_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_extension_feed_item_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_extension_feed_item_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_extension_feed_item_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_extension_feed_item_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_extension_feed_item_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_extension_feed_item_service_proto = out.File
	file_google_ads_googleads_v8_services_extension_feed_item_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_extension_feed_item_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_extension_feed_item_service_proto_depIdxs = nil
}
