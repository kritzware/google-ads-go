...
func (x *GetAdRequest) Reset() {
	*x = GetAdRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_service_proto_msgTypes[0]
...
func (*GetAdRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateAdsRequest) Reset() {
	*x = MutateAdsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *AdOperation) Reset() {
	*x = AdOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdsResponse) Reset() {
	*x = MutateAdsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateAdResult) Reset() {
	*x = MutateAdResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_ad_service_proto_rawDesc = []byte{
	...
	0x93, 0x02, 0x27, 0x12, 0x25, 0x2f, 0x76, 0x38, 0x2f, 0x7b, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72,
	...
	0x65, 0x22, 0x4c, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x2d, 0x22, 0x28, 0x2f, 0x76, 0x38, 0x2f, 0x63,
...
var (
	file_google_ads_googleads_v8_services_ad_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_ad_service_proto_rawDescData = file_google_ads_googleads_v8_services_ad_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_ad_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_ad_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_ad_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_ad_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_ad_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_ad_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_ad_service_proto_goTypes = []interface{}{
	(*GetAdRequest)(nil),                                   // 0: google.ads.googleads.v8.services.GetAdRequest
	(*MutateAdsRequest)(nil),                               // 1: google.ads.googleads.v8.services.MutateAdsRequest
	(*AdOperation)(nil),                                    // 2: google.ads.googleads.v8.services.AdOperation
	(*MutateAdsResponse)(nil),                              // 3: google.ads.googleads.v8.services.MutateAdsResponse
	(*MutateAdResult)(nil),                                 // 4: google.ads.googleads.v8.services.MutateAdResult
	...
	(*resources.Ad)(nil),                                   // 8: google.ads.googleads.v8.resources.Ad
	(*status.Status)(nil),                                  // 9: google.rpc.Status
}
var file_google_ads_googleads_v8_services_ad_service_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v8.services.MutateAdsRequest.operations:type_name -> google.ads.googleads.v8.services.AdOperation
	5,  // 1: google.ads.googleads.v8.services.MutateAdsRequest.response_content_type:type_name -> google.ads.googleads.v8.enums.ResponseContentTypeEnum.ResponseContentType
	6,  // 2: google.ads.googleads.v8.services.AdOperation.update_mask:type_name -> google.protobuf.FieldMask
	7,  // 3: google.ads.googleads.v8.services.AdOperation.policy_validation_parameter:type_name -> google.ads.googleads.v8.common.PolicyValidationParameter
	8,  // 4: google.ads.googleads.v8.services.AdOperation.update:type_name -> google.ads.googleads.v8.resources.Ad
	9,  // 5: google.ads.googleads.v8.services.MutateAdsResponse.partial_failure_error:type_name -> google.rpc.Status
	4,  // 6: google.ads.googleads.v8.services.MutateAdsResponse.results:type_name -> google.ads.googleads.v8.services.MutateAdResult
	8,  // 7: google.ads.googleads.v8.services.MutateAdResult.ad:type_name -> google.ads.googleads.v8.resources.Ad
	0,  // 8: google.ads.googleads.v8.services.AdService.GetAd:input_type -> google.ads.googleads.v8.services.GetAdRequest
	1,  // 9: google.ads.googleads.v8.services.AdService.MutateAds:input_type -> google.ads.googleads.v8.services.MutateAdsRequest
	8,  // 10: google.ads.googleads.v8.services.AdService.GetAd:output_type -> google.ads.googleads.v8.resources.Ad
	3,  // 11: google.ads.googleads.v8.services.AdService.MutateAds:output_type -> google.ads.googleads.v8.services.MutateAdsResponse
...
func init() { file_google_ads_googleads_v8_services_ad_service_proto_init() }
func file_google_ads_googleads_v8_services_ad_service_proto_init() {
	if File_google_ads_googleads_v8_services_ad_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_ad_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_ad_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_ad_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_ad_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_ad_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_ad_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_ad_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_ad_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_ad_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_ad_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_ad_service_proto = out.File
	file_google_ads_googleads_v8_services_ad_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_ad_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_ad_service_proto_depIdxs = nil
}
...
func (c *adServiceClient) GetAd(ctx context.Context, in *GetAdRequest, opts ...grpc.CallOption) (*resources.Ad, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v8.services.AdService/GetAd", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adServiceClient) MutateAds(ctx context.Context, in *MutateAdsRequest, opts ...grpc.CallOption) (*MutateAdsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v8.services.AdService/MutateAds", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedAdServiceServer) GetAd(context.Context, *GetAdRequest) (*resources.Ad, error) {
	return nil, status1.Errorf(codes.Unimplemented, "method GetAd not implemented")
}
func (*UnimplementedAdServiceServer) MutateAds(context.Context, *MutateAdsRequest) (*MutateAdsResponse, error) {
	return nil, status1.Errorf(codes.Unimplemented, "method MutateAds not implemented")
}
...
func _AdService_GetAd_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v8.services.AdService/GetAd",
	}
...
func _AdService_MutateAds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v8.services.AdService/MutateAds",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
