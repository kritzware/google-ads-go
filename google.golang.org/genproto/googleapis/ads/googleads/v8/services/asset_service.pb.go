...
func (x *GetAssetRequest) Reset() {
	*x = GetAssetRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_asset_service_proto_msgTypes[0]
...
func (*GetAssetRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_asset_service_proto_rawDescGZIP(), []int{0}
}
...
type MutateAssetsRequest struct {
	...
	ResponseContentType enums.ResponseContentTypeEnum_ResponseContentType `protobuf:"varint,3,opt,name=response_content_type,json=responseContentType,proto3,enum=google.ads.googleads.v8.enums.ResponseContentTypeEnum_ResponseContentType" json:"response_content_type,omitempty"`
...
func (x *MutateAssetsRequest) Reset() {
	*x = MutateAssetsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_asset_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAssetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_asset_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *AssetOperation) Reset() {
	*x = AssetOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_asset_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AssetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_asset_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAssetsResponse) Reset() {
	*x = MutateAssetsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_asset_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAssetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_asset_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateAssetResult) Reset() {
	*x = MutateAssetResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_asset_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAssetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_asset_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_asset_service_proto_rawDesc = []byte{
	...
	0x38, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x41, 0x73, 0x73, 0x65,
	...
	0xd3, 0xe4, 0x93, 0x02, 0x2a, 0x12, 0x28, 0x2f, 0x76, 0x38, 0x2f, 0x7b, 0x72, 0x65, 0x73, 0x6f,
	...
	0x4f, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x30, 0x22, 0x2b, 0x2f, 0x76, 0x38, 0x2f, 0x63, 0x75, 0x73,
...
var (
	file_google_ads_googleads_v8_services_asset_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_asset_service_proto_rawDescData = file_google_ads_googleads_v8_services_asset_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_asset_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_asset_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_asset_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_asset_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_asset_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_asset_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_asset_service_proto_goTypes = []interface{}{
	(*GetAssetRequest)(nil),                                // 0: google.ads.googleads.v8.services.GetAssetRequest
	(*MutateAssetsRequest)(nil),                            // 1: google.ads.googleads.v8.services.MutateAssetsRequest
	(*AssetOperation)(nil),                                 // 2: google.ads.googleads.v8.services.AssetOperation
	(*MutateAssetsResponse)(nil),                           // 3: google.ads.googleads.v8.services.MutateAssetsResponse
	(*MutateAssetResult)(nil),                              // 4: google.ads.googleads.v8.services.MutateAssetResult
	...
	(*resources.Asset)(nil),                                // 7: google.ads.googleads.v8.resources.Asset
	(*status.Status)(nil),                                  // 8: google.rpc.Status
}
var file_google_ads_googleads_v8_services_asset_service_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v8.services.MutateAssetsRequest.operations:type_name -> google.ads.googleads.v8.services.AssetOperation
	5,  // 1: google.ads.googleads.v8.services.MutateAssetsRequest.response_content_type:type_name -> google.ads.googleads.v8.enums.ResponseContentTypeEnum.ResponseContentType
	6,  // 2: google.ads.googleads.v8.services.AssetOperation.update_mask:type_name -> google.protobuf.FieldMask
	7,  // 3: google.ads.googleads.v8.services.AssetOperation.create:type_name -> google.ads.googleads.v8.resources.Asset
	7,  // 4: google.ads.googleads.v8.services.AssetOperation.update:type_name -> google.ads.googleads.v8.resources.Asset
	8,  // 5: google.ads.googleads.v8.services.MutateAssetsResponse.partial_failure_error:type_name -> google.rpc.Status
	4,  // 6: google.ads.googleads.v8.services.MutateAssetsResponse.results:type_name -> google.ads.googleads.v8.services.MutateAssetResult
	7,  // 7: google.ads.googleads.v8.services.MutateAssetResult.asset:type_name -> google.ads.googleads.v8.resources.Asset
	0,  // 8: google.ads.googleads.v8.services.AssetService.GetAsset:input_type -> google.ads.googleads.v8.services.GetAssetRequest
	1,  // 9: google.ads.googleads.v8.services.AssetService.MutateAssets:input_type -> google.ads.googleads.v8.services.MutateAssetsRequest
	7,  // 10: google.ads.googleads.v8.services.AssetService.GetAsset:output_type -> google.ads.googleads.v8.resources.Asset
	3,  // 11: google.ads.googleads.v8.services.AssetService.MutateAssets:output_type -> google.ads.googleads.v8.services.MutateAssetsResponse
...
func init() { file_google_ads_googleads_v8_services_asset_service_proto_init() }
func file_google_ads_googleads_v8_services_asset_service_proto_init() {
	if File_google_ads_googleads_v8_services_asset_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_asset_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_asset_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_asset_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_asset_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_asset_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_asset_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_asset_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_asset_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_asset_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_asset_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_asset_service_proto = out.File
	file_google_ads_googleads_v8_services_asset_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_asset_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_asset_service_proto_depIdxs = nil
}
...
func (*UnimplementedAssetServiceServer) MutateAssets(context.Context, *MutateAssetsRequest) (*MutateAssetsResponse, error) {
	return nil, status1.Errorf(codes.Unimplemented, "method MutateAssets not implemented")
}
