...
func (x *GetCampaignBudgetRequest) Reset() {
	*x = GetCampaignBudgetRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_budget_service_proto_msgTypes[0]
...
func (*GetCampaignBudgetRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_budget_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateCampaignBudgetsRequest) Reset() {
	*x = MutateCampaignBudgetsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_budget_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignBudgetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_budget_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *CampaignBudgetOperation) Reset() {
	*x = CampaignBudgetOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_budget_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CampaignBudgetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_budget_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCampaignBudgetsResponse) Reset() {
	*x = MutateCampaignBudgetsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_budget_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignBudgetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_budget_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateCampaignBudgetResult) Reset() {
	*x = MutateCampaignBudgetResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_budget_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignBudgetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_budget_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_campaign_budget_service_proto_rawDesc = []byte{
	...
	0x38, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x47, 0x65, 0x74, 0x43, 0x61,
...
var (
	file_google_ads_googleads_v8_services_campaign_budget_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_campaign_budget_service_proto_rawDescData = file_google_ads_googleads_v8_services_campaign_budget_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_campaign_budget_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_campaign_budget_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_campaign_budget_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_campaign_budget_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_campaign_budget_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_campaign_budget_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_campaign_budget_service_proto_goTypes = []interface{}{
	(*GetCampaignBudgetRequest)(nil),                       // 0: google.ads.googleads.v8.services.GetCampaignBudgetRequest
	(*MutateCampaignBudgetsRequest)(nil),                   // 1: google.ads.googleads.v8.services.MutateCampaignBudgetsRequest
	(*CampaignBudgetOperation)(nil),                        // 2: google.ads.googleads.v8.services.CampaignBudgetOperation
	(*MutateCampaignBudgetsResponse)(nil),                  // 3: google.ads.googleads.v8.services.MutateCampaignBudgetsResponse
	(*MutateCampaignBudgetResult)(nil),                     // 4: google.ads.googleads.v8.services.MutateCampaignBudgetResult
	...
	(*resources.CampaignBudget)(nil),                       // 7: google.ads.googleads.v8.resources.CampaignBudget
	(*status.Status)(nil),                                  // 8: google.rpc.Status
}
var file_google_ads_googleads_v8_services_campaign_budget_service_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v8.services.MutateCampaignBudgetsRequest.operations:type_name -> google.ads.googleads.v8.services.CampaignBudgetOperation
	5,  // 1: google.ads.googleads.v8.services.MutateCampaignBudgetsRequest.response_content_type:type_name -> google.ads.googleads.v8.enums.ResponseContentTypeEnum.ResponseContentType
	6,  // 2: google.ads.googleads.v8.services.CampaignBudgetOperation.update_mask:type_name -> google.protobuf.FieldMask
	7,  // 3: google.ads.googleads.v8.services.CampaignBudgetOperation.create:type_name -> google.ads.googleads.v8.resources.CampaignBudget
	7,  // 4: google.ads.googleads.v8.services.CampaignBudgetOperation.update:type_name -> google.ads.googleads.v8.resources.CampaignBudget
	8,  // 5: google.ads.googleads.v8.services.MutateCampaignBudgetsResponse.partial_failure_error:type_name -> google.rpc.Status
	4,  // 6: google.ads.googleads.v8.services.MutateCampaignBudgetsResponse.results:type_name -> google.ads.googleads.v8.services.MutateCampaignBudgetResult
	7,  // 7: google.ads.googleads.v8.services.MutateCampaignBudgetResult.campaign_budget:type_name -> google.ads.googleads.v8.resources.CampaignBudget
	0,  // 8: google.ads.googleads.v8.services.CampaignBudgetService.GetCampaignBudget:input_type -> google.ads.googleads.v8.services.GetCampaignBudgetRequest
	1,  // 9: google.ads.googleads.v8.services.CampaignBudgetService.MutateCampaignBudgets:input_type -> google.ads.googleads.v8.services.MutateCampaignBudgetsRequest
	7,  // 10: google.ads.googleads.v8.services.CampaignBudgetService.GetCampaignBudget:output_type -> google.ads.googleads.v8.resources.CampaignBudget
	3,  // 11: google.ads.googleads.v8.services.CampaignBudgetService.MutateCampaignBudgets:output_type -> google.ads.googleads.v8.services.MutateCampaignBudgetsResponse
...
func init() { file_google_ads_googleads_v8_services_campaign_budget_service_proto_init() }
func file_google_ads_googleads_v8_services_campaign_budget_service_proto_init() {
	if File_google_ads_googleads_v8_services_campaign_budget_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_campaign_budget_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_campaign_budget_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_campaign_budget_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_campaign_budget_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_campaign_budget_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_campaign_budget_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_campaign_budget_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_campaign_budget_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_campaign_budget_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_campaign_budget_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_campaign_budget_service_proto = out.File
	file_google_ads_googleads_v8_services_campaign_budget_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_campaign_budget_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_campaign_budget_service_proto_depIdxs = nil
}
