...
func (x *GetLabelRequest) Reset() {
	*x = GetLabelRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_label_service_proto_msgTypes[0]
...
func (*GetLabelRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_label_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateLabelsRequest) Reset() {
	*x = MutateLabelsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_label_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateLabelsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_label_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *LabelOperation) Reset() {
	*x = LabelOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_label_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LabelOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_label_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateLabelsResponse) Reset() {
	*x = MutateLabelsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_label_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateLabelsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_label_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateLabelResult) Reset() {
	*x = MutateLabelResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_label_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateLabelResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_label_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_label_service_proto_rawDesc = []byte{
	...
	0x38, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x4c, 0x61, 0x62, 0x65,
	...
	0x30, 0x22, 0x2b, 0x2f, 0x76, 0x38, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73,
	...
	0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76,
	0x38, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x11, 0x4c, 0x61, 0x62, 0x65,
...
var (
	file_google_ads_googleads_v8_services_label_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_label_service_proto_rawDescData = file_google_ads_googleads_v8_services_label_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_label_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_label_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_label_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_label_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_label_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_label_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_label_service_proto_goTypes = []interface{}{
	(*GetLabelRequest)(nil),                                // 0: google.ads.googleads.v8.services.GetLabelRequest
	(*MutateLabelsRequest)(nil),                            // 1: google.ads.googleads.v8.services.MutateLabelsRequest
	(*LabelOperation)(nil),                                 // 2: google.ads.googleads.v8.services.LabelOperation
	(*MutateLabelsResponse)(nil),                           // 3: google.ads.googleads.v8.services.MutateLabelsResponse
	(*MutateLabelResult)(nil),                              // 4: google.ads.googleads.v8.services.MutateLabelResult
	...
	(*resources.Label)(nil),                                // 7: google.ads.googleads.v8.resources.Label
	(*status.Status)(nil),                                  // 8: google.rpc.Status
}
var file_google_ads_googleads_v8_services_label_service_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v8.services.MutateLabelsRequest.operations:type_name -> google.ads.googleads.v8.services.LabelOperation
	5,  // 1: google.ads.googleads.v8.services.MutateLabelsRequest.response_content_type:type_name -> google.ads.googleads.v8.enums.ResponseContentTypeEnum.ResponseContentType
	6,  // 2: google.ads.googleads.v8.services.LabelOperation.update_mask:type_name -> google.protobuf.FieldMask
	7,  // 3: google.ads.googleads.v8.services.LabelOperation.create:type_name -> google.ads.googleads.v8.resources.Label
	7,  // 4: google.ads.googleads.v8.services.LabelOperation.update:type_name -> google.ads.googleads.v8.resources.Label
	8,  // 5: google.ads.googleads.v8.services.MutateLabelsResponse.partial_failure_error:type_name -> google.rpc.Status
	4,  // 6: google.ads.googleads.v8.services.MutateLabelsResponse.results:type_name -> google.ads.googleads.v8.services.MutateLabelResult
	7,  // 7: google.ads.googleads.v8.services.MutateLabelResult.label:type_name -> google.ads.googleads.v8.resources.Label
	0,  // 8: google.ads.googleads.v8.services.LabelService.GetLabel:input_type -> google.ads.googleads.v8.services.GetLabelRequest
	1,  // 9: google.ads.googleads.v8.services.LabelService.MutateLabels:input_type -> google.ads.googleads.v8.services.MutateLabelsRequest
	7,  // 10: google.ads.googleads.v8.services.LabelService.GetLabel:output_type -> google.ads.googleads.v8.resources.Label
	3,  // 11: google.ads.googleads.v8.services.LabelService.MutateLabels:output_type -> google.ads.googleads.v8.services.MutateLabelsResponse
...
func init() { file_google_ads_googleads_v8_services_label_service_proto_init() }
func file_google_ads_googleads_v8_services_label_service_proto_init() {
	if File_google_ads_googleads_v8_services_label_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_label_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_label_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_label_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_label_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_label_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_label_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_label_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_label_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_label_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_label_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_label_service_proto = out.File
	file_google_ads_googleads_v8_services_label_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_label_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_label_service_proto_depIdxs = nil
}
