...
func (x *GetSmartCampaignSettingRequest) Reset() {
	*x = GetSmartCampaignSettingRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_msgTypes[0]
...
func (*GetSmartCampaignSettingRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateSmartCampaignSettingsRequest) Reset() {
	*x = MutateSmartCampaignSettingsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateSmartCampaignSettingsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *SmartCampaignSettingOperation) Reset() {
	*x = SmartCampaignSettingOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SmartCampaignSettingOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateSmartCampaignSettingsResponse) Reset() {
	*x = MutateSmartCampaignSettingsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateSmartCampaignSettingsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateSmartCampaignSettingResult) Reset() {
	*x = MutateSmartCampaignSettingResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateSmartCampaignSettingResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x38, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x6d,
	0x61, 0x72, 0x74, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x53, 0x65, 0x74, 0x74, 0x69,
	...
	0x4f, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x39, 0x12, 0x37, 0x2f, 0x76, 0x38, 0x2f, 0x7b, 0x72, 0x65,
	...
	0xd3, 0xe4, 0x93, 0x02, 0x3f, 0x22, 0x3a, 0x2f, 0x76, 0x38, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f,
	...
	0x73, 0x2e, 0x76, 0x38, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x20, 0x53,
...
var (
	file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_rawDescData = file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_goTypes = []interface{}{
	(*GetSmartCampaignSettingRequest)(nil),                 // 0: google.ads.googleads.v8.services.GetSmartCampaignSettingRequest
	(*MutateSmartCampaignSettingsRequest)(nil),             // 1: google.ads.googleads.v8.services.MutateSmartCampaignSettingsRequest
	(*SmartCampaignSettingOperation)(nil),                  // 2: google.ads.googleads.v8.services.SmartCampaignSettingOperation
	(*MutateSmartCampaignSettingsResponse)(nil),            // 3: google.ads.googleads.v8.services.MutateSmartCampaignSettingsResponse
	(*MutateSmartCampaignSettingResult)(nil),               // 4: google.ads.googleads.v8.services.MutateSmartCampaignSettingResult
	...
	(*resources.SmartCampaignSetting)(nil),                 // 6: google.ads.googleads.v8.resources.SmartCampaignSetting
	(*fieldmaskpb.FieldMask)(nil),                          // 7: google.protobuf.FieldMask
	(*status.Status)(nil),                                  // 8: google.rpc.Status
}
var file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v8.services.MutateSmartCampaignSettingsRequest.operations:type_name -> google.ads.googleads.v8.services.SmartCampaignSettingOperation
	5, // 1: google.ads.googleads.v8.services.MutateSmartCampaignSettingsRequest.response_content_type:type_name -> google.ads.googleads.v8.enums.ResponseContentTypeEnum.ResponseContentType
	6, // 2: google.ads.googleads.v8.services.SmartCampaignSettingOperation.update:type_name -> google.ads.googleads.v8.resources.SmartCampaignSetting
	7, // 3: google.ads.googleads.v8.services.SmartCampaignSettingOperation.update_mask:type_name -> google.protobuf.FieldMask
	8, // 4: google.ads.googleads.v8.services.MutateSmartCampaignSettingsResponse.partial_failure_error:type_name -> google.rpc.Status
	4, // 5: google.ads.googleads.v8.services.MutateSmartCampaignSettingsResponse.results:type_name -> google.ads.googleads.v8.services.MutateSmartCampaignSettingResult
	6, // 6: google.ads.googleads.v8.services.MutateSmartCampaignSettingResult.smart_campaign_setting:type_name -> google.ads.googleads.v8.resources.SmartCampaignSetting
	0, // 7: google.ads.googleads.v8.services.SmartCampaignSettingService.GetSmartCampaignSetting:input_type -> google.ads.googleads.v8.services.GetSmartCampaignSettingRequest
	1, // 8: google.ads.googleads.v8.services.SmartCampaignSettingService.MutateSmartCampaignSettings:input_type -> google.ads.googleads.v8.services.MutateSmartCampaignSettingsRequest
	6, // 9: google.ads.googleads.v8.services.SmartCampaignSettingService.GetSmartCampaignSetting:output_type -> google.ads.googleads.v8.resources.SmartCampaignSetting
	3, // 10: google.ads.googleads.v8.services.SmartCampaignSettingService.MutateSmartCampaignSettings:output_type -> google.ads.googleads.v8.services.MutateSmartCampaignSettingsResponse
...
func init() { file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_init() }
func file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_init() {
	if File_google_ads_googleads_v8_services_smart_campaign_setting_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_smart_campaign_setting_service_proto = out.File
	file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_smart_campaign_setting_service_proto_depIdxs = nil
}
...
// UnimplementedSmartCampaignSettingServiceServer can be embedded to have forward compatible implementations.
...
func (*UnimplementedSmartCampaignSettingServiceServer) GetSmartCampaignSetting(context.Context, *GetSmartCampaignSettingRequest) (*resources.SmartCampaignSetting, error) {
	return nil, status1.Errorf(codes.Unimplemented, "method GetSmartCampaignSetting not implemented")
}
func (*UnimplementedSmartCampaignSettingServiceServer) MutateSmartCampaignSettings(context.Context, *MutateSmartCampaignSettingsRequest) (*MutateSmartCampaignSettingsResponse, error) {
	return nil, status1.Errorf(codes.Unimplemented, "method MutateSmartCampaignSettings not implemented")
}

func RegisterSmartCampaignSettingServiceServer(s *grpc.Server, srv SmartCampaignSettingServiceServer) {
	s.RegisterService(&_SmartCampaignSettingService_serviceDesc, srv)
}
...
var _SmartCampaignSettingService_serviceDesc = grpc.ServiceDesc{
