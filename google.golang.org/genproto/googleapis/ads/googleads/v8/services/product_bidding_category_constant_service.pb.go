...
func (x *GetProductBiddingCategoryConstantRequest) Reset() {
	*x = GetProductBiddingCategoryConstantRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_product_bidding_category_constant_service_proto_msgTypes[0]
...
func (*GetProductBiddingCategoryConstantRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_product_bidding_category_constant_service_proto_rawDescGZIP(), []int{0}
}
...
var file_google_ads_googleads_v8_services_product_bidding_category_constant_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v8_services_product_bidding_category_constant_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_product_bidding_category_constant_service_proto_rawDescData = file_google_ads_googleads_v8_services_product_bidding_category_constant_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_product_bidding_category_constant_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_product_bidding_category_constant_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_product_bidding_category_constant_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_product_bidding_category_constant_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_product_bidding_category_constant_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_product_bidding_category_constant_service_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v8_services_product_bidding_category_constant_service_proto_goTypes = []interface{}{
	(*GetProductBiddingCategoryConstantRequest)(nil), // 0: google.ads.googleads.v8.services.GetProductBiddingCategoryConstantRequest
	(*resources.ProductBiddingCategoryConstant)(nil), // 1: google.ads.googleads.v8.resources.ProductBiddingCategoryConstant
}
var file_google_ads_googleads_v8_services_product_bidding_category_constant_service_proto_depIdxs = []int32{
	0, // 0: google.ads.googleads.v8.services.ProductBiddingCategoryConstantService.GetProductBiddingCategoryConstant:input_type -> google.ads.googleads.v8.services.GetProductBiddingCategoryConstantRequest
	1, // 1: google.ads.googleads.v8.services.ProductBiddingCategoryConstantService.GetProductBiddingCategoryConstant:output_type -> google.ads.googleads.v8.resources.ProductBiddingCategoryConstant
...
func init() {
	file_google_ads_googleads_v8_services_product_bidding_category_constant_service_proto_init()
}
func file_google_ads_googleads_v8_services_product_bidding_category_constant_service_proto_init() {
	if File_google_ads_googleads_v8_services_product_bidding_category_constant_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_product_bidding_category_constant_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_product_bidding_category_constant_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_product_bidding_category_constant_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_product_bidding_category_constant_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_product_bidding_category_constant_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_product_bidding_category_constant_service_proto = out.File
	file_google_ads_googleads_v8_services_product_bidding_category_constant_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_product_bidding_category_constant_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_product_bidding_category_constant_service_proto_depIdxs = nil
}
...
func (c *productBiddingCategoryConstantServiceClient) GetProductBiddingCategoryConstant(ctx context.Context, in *GetProductBiddingCategoryConstantRequest, opts ...grpc.CallOption) (*resources.ProductBiddingCategoryConstant, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v8.services.ProductBiddingCategoryConstantService/GetProductBiddingCategoryConstant", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ProductBiddingCategoryConstantService_GetProductBiddingCategoryConstant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v8.services.ProductBiddingCategoryConstantService/GetProductBiddingCategoryConstant",
	}
