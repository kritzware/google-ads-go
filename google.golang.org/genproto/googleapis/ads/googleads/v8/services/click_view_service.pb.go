...
func (x *GetClickViewRequest) Reset() {
	*x = GetClickViewRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_click_view_service_proto_msgTypes[0]
...
func (*GetClickViewRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_click_view_service_proto_rawDescGZIP(), []int{0}
}
...
var file_google_ads_googleads_v8_services_click_view_service_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x38, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x43, 0x6c,
	...
	0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64,
	0x73, 0x2e, 0x76, 0x38, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x15, 0x43,
...
var (
	file_google_ads_googleads_v8_services_click_view_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_click_view_service_proto_rawDescData = file_google_ads_googleads_v8_services_click_view_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_click_view_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_click_view_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_click_view_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_click_view_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_click_view_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_click_view_service_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v8_services_click_view_service_proto_goTypes = []interface{}{
	(*GetClickViewRequest)(nil), // 0: google.ads.googleads.v8.services.GetClickViewRequest
	(*resources.ClickView)(nil), // 1: google.ads.googleads.v8.resources.ClickView
}
var file_google_ads_googleads_v8_services_click_view_service_proto_depIdxs = []int32{
	0, // 0: google.ads.googleads.v8.services.ClickViewService.GetClickView:input_type -> google.ads.googleads.v8.services.GetClickViewRequest
	1, // 1: google.ads.googleads.v8.services.ClickViewService.GetClickView:output_type -> google.ads.googleads.v8.resources.ClickView
...
func init() { file_google_ads_googleads_v8_services_click_view_service_proto_init() }
func file_google_ads_googleads_v8_services_click_view_service_proto_init() {
	if File_google_ads_googleads_v8_services_click_view_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_click_view_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_click_view_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_click_view_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_click_view_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_click_view_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_click_view_service_proto = out.File
	file_google_ads_googleads_v8_services_click_view_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_click_view_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_click_view_service_proto_depIdxs = nil
}
...
func (c *clickViewServiceClient) GetClickView(ctx context.Context, in *GetClickViewRequest, opts ...grpc.CallOption) (*resources.ClickView, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v8.services.ClickViewService/GetClickView", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ClickViewService_GetClickView_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v8.services.ClickViewService/GetClickView",
	}
