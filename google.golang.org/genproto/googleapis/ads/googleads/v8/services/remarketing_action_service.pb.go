...
func (x *GetRemarketingActionRequest) Reset() {
	*x = GetRemarketingActionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_remarketing_action_service_proto_msgTypes[0]
...
func (*GetRemarketingActionRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_remarketing_action_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateRemarketingActionsRequest) Reset() {
	*x = MutateRemarketingActionsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_remarketing_action_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateRemarketingActionsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_remarketing_action_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *RemarketingActionOperation) Reset() {
	*x = RemarketingActionOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_remarketing_action_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RemarketingActionOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_remarketing_action_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateRemarketingActionsResponse) Reset() {
	*x = MutateRemarketingActionsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_remarketing_action_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateRemarketingActionsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_remarketing_action_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateRemarketingActionResult) Reset() {
	*x = MutateRemarketingActionResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_remarketing_action_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateRemarketingActionResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_remarketing_action_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_remarketing_action_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v8_services_remarketing_action_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_remarketing_action_service_proto_rawDescData = file_google_ads_googleads_v8_services_remarketing_action_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_remarketing_action_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_remarketing_action_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_remarketing_action_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_remarketing_action_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_remarketing_action_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_remarketing_action_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_remarketing_action_service_proto_goTypes = []interface{}{
	(*GetRemarketingActionRequest)(nil),      // 0: google.ads.googleads.v8.services.GetRemarketingActionRequest
	(*MutateRemarketingActionsRequest)(nil),  // 1: google.ads.googleads.v8.services.MutateRemarketingActionsRequest
	(*RemarketingActionOperation)(nil),       // 2: google.ads.googleads.v8.services.RemarketingActionOperation
	(*MutateRemarketingActionsResponse)(nil), // 3: google.ads.googleads.v8.services.MutateRemarketingActionsResponse
	(*MutateRemarketingActionResult)(nil),    // 4: google.ads.googleads.v8.services.MutateRemarketingActionResult
	(*fieldmaskpb.FieldMask)(nil),            // 5: google.protobuf.FieldMask
	(*resources.RemarketingAction)(nil),      // 6: google.ads.googleads.v8.resources.RemarketingAction
	(*status.Status)(nil),                    // 7: google.rpc.Status
}
var file_google_ads_googleads_v8_services_remarketing_action_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v8.services.MutateRemarketingActionsRequest.operations:type_name -> google.ads.googleads.v8.services.RemarketingActionOperation
	5, // 1: google.ads.googleads.v8.services.RemarketingActionOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 2: google.ads.googleads.v8.services.RemarketingActionOperation.create:type_name -> google.ads.googleads.v8.resources.RemarketingAction
	6, // 3: google.ads.googleads.v8.services.RemarketingActionOperation.update:type_name -> google.ads.googleads.v8.resources.RemarketingAction
	7, // 4: google.ads.googleads.v8.services.MutateRemarketingActionsResponse.partial_failure_error:type_name -> google.rpc.Status
	4, // 5: google.ads.googleads.v8.services.MutateRemarketingActionsResponse.results:type_name -> google.ads.googleads.v8.services.MutateRemarketingActionResult
	0, // 6: google.ads.googleads.v8.services.RemarketingActionService.GetRemarketingAction:input_type -> google.ads.googleads.v8.services.GetRemarketingActionRequest
	1, // 7: google.ads.googleads.v8.services.RemarketingActionService.MutateRemarketingActions:input_type -> google.ads.googleads.v8.services.MutateRemarketingActionsRequest
	6, // 8: google.ads.googleads.v8.services.RemarketingActionService.GetRemarketingAction:output_type -> google.ads.googleads.v8.resources.RemarketingAction
	3, // 9: google.ads.googleads.v8.services.RemarketingActionService.MutateRemarketingActions:output_type -> google.ads.googleads.v8.services.MutateRemarketingActionsResponse
...
func init() { file_google_ads_googleads_v8_services_remarketing_action_service_proto_init() }
func file_google_ads_googleads_v8_services_remarketing_action_service_proto_init() {
	if File_google_ads_googleads_v8_services_remarketing_action_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_remarketing_action_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_remarketing_action_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_remarketing_action_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_remarketing_action_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_remarketing_action_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_remarketing_action_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_remarketing_action_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_remarketing_action_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_remarketing_action_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_remarketing_action_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_remarketing_action_service_proto = out.File
	file_google_ads_googleads_v8_services_remarketing_action_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_remarketing_action_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_remarketing_action_service_proto_depIdxs = nil
}
