...
func (x *GetCampaignCriterionRequest) Reset() {
	*x = GetCampaignCriterionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_criterion_service_proto_msgTypes[0]
...
func (*GetCampaignCriterionRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_criterion_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateCampaignCriteriaRequest) Reset() {
	*x = MutateCampaignCriteriaRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_criterion_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignCriteriaRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_criterion_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *CampaignCriterionOperation) Reset() {
	*x = CampaignCriterionOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_criterion_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CampaignCriterionOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_criterion_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCampaignCriteriaResponse) Reset() {
	*x = MutateCampaignCriteriaResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_criterion_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignCriteriaResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_criterion_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateCampaignCriterionResult) Reset() {
	*x = MutateCampaignCriterionResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_criterion_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignCriterionResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_criterion_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_campaign_criterion_service_proto_rawDesc = []byte{
	...
	0x93, 0x02, 0x34, 0x12, 0x32, 0x2f, 0x76, 0x38, 0x2f, 0x7b, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72,
...
var (
	file_google_ads_googleads_v8_services_campaign_criterion_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_campaign_criterion_service_proto_rawDescData = file_google_ads_googleads_v8_services_campaign_criterion_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_campaign_criterion_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_campaign_criterion_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_campaign_criterion_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_campaign_criterion_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_campaign_criterion_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_campaign_criterion_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_campaign_criterion_service_proto_goTypes = []interface{}{
	(*GetCampaignCriterionRequest)(nil),                    // 0: google.ads.googleads.v8.services.GetCampaignCriterionRequest
	(*MutateCampaignCriteriaRequest)(nil),                  // 1: google.ads.googleads.v8.services.MutateCampaignCriteriaRequest
	(*CampaignCriterionOperation)(nil),                     // 2: google.ads.googleads.v8.services.CampaignCriterionOperation
	(*MutateCampaignCriteriaResponse)(nil),                 // 3: google.ads.googleads.v8.services.MutateCampaignCriteriaResponse
	(*MutateCampaignCriterionResult)(nil),                  // 4: google.ads.googleads.v8.services.MutateCampaignCriterionResult
	...
	(*resources.CampaignCriterion)(nil),                    // 7: google.ads.googleads.v8.resources.CampaignCriterion
	(*status.Status)(nil),                                  // 8: google.rpc.Status
}
var file_google_ads_googleads_v8_services_campaign_criterion_service_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v8.services.MutateCampaignCriteriaRequest.operations:type_name -> google.ads.googleads.v8.services.CampaignCriterionOperation
	5,  // 1: google.ads.googleads.v8.services.MutateCampaignCriteriaRequest.response_content_type:type_name -> google.ads.googleads.v8.enums.ResponseContentTypeEnum.ResponseContentType
	6,  // 2: google.ads.googleads.v8.services.CampaignCriterionOperation.update_mask:type_name -> google.protobuf.FieldMask
	7,  // 3: google.ads.googleads.v8.services.CampaignCriterionOperation.create:type_name -> google.ads.googleads.v8.resources.CampaignCriterion
	7,  // 4: google.ads.googleads.v8.services.CampaignCriterionOperation.update:type_name -> google.ads.googleads.v8.resources.CampaignCriterion
	8,  // 5: google.ads.googleads.v8.services.MutateCampaignCriteriaResponse.partial_failure_error:type_name -> google.rpc.Status
	4,  // 6: google.ads.googleads.v8.services.MutateCampaignCriteriaResponse.results:type_name -> google.ads.googleads.v8.services.MutateCampaignCriterionResult
	7,  // 7: google.ads.googleads.v8.services.MutateCampaignCriterionResult.campaign_criterion:type_name -> google.ads.googleads.v8.resources.CampaignCriterion
	0,  // 8: google.ads.googleads.v8.services.CampaignCriterionService.GetCampaignCriterion:input_type -> google.ads.googleads.v8.services.GetCampaignCriterionRequest
	1,  // 9: google.ads.googleads.v8.services.CampaignCriterionService.MutateCampaignCriteria:input_type -> google.ads.googleads.v8.services.MutateCampaignCriteriaRequest
	7,  // 10: google.ads.googleads.v8.services.CampaignCriterionService.GetCampaignCriterion:output_type -> google.ads.googleads.v8.resources.CampaignCriterion
	3,  // 11: google.ads.googleads.v8.services.CampaignCriterionService.MutateCampaignCriteria:output_type -> google.ads.googleads.v8.services.MutateCampaignCriteriaResponse
...
func init() { file_google_ads_googleads_v8_services_campaign_criterion_service_proto_init() }
func file_google_ads_googleads_v8_services_campaign_criterion_service_proto_init() {
	if File_google_ads_googleads_v8_services_campaign_criterion_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_campaign_criterion_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_campaign_criterion_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_campaign_criterion_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_campaign_criterion_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_campaign_criterion_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_campaign_criterion_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_campaign_criterion_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_campaign_criterion_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_campaign_criterion_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_campaign_criterion_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_campaign_criterion_service_proto = out.File
	file_google_ads_googleads_v8_services_campaign_criterion_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_campaign_criterion_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_campaign_criterion_service_proto_depIdxs = nil
}
