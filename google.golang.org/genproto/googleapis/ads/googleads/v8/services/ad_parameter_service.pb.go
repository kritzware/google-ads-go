...
func (x *GetAdParameterRequest) Reset() {
	*x = GetAdParameterRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_parameter_service_proto_msgTypes[0]
...
func (*GetAdParameterRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_parameter_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateAdParametersRequest) Reset() {
	*x = MutateAdParametersRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_parameter_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdParametersRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_parameter_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *AdParameterOperation) Reset() {
	*x = AdParameterOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_parameter_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdParameterOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_parameter_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdParametersResponse) Reset() {
	*x = MutateAdParametersResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_parameter_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdParametersResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_parameter_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateAdParameterResult) Reset() {
	*x = MutateAdParameterResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_parameter_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdParameterResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_parameter_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_ad_parameter_service_proto_rawDesc = []byte{
	...
	0x76, 0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	...
	0x2e, 0x76, 0x38, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x41, 0x64,
...
var (
	file_google_ads_googleads_v8_services_ad_parameter_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_ad_parameter_service_proto_rawDescData = file_google_ads_googleads_v8_services_ad_parameter_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_ad_parameter_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_ad_parameter_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_ad_parameter_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_ad_parameter_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_ad_parameter_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_ad_parameter_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_ad_parameter_service_proto_goTypes = []interface{}{
	(*GetAdParameterRequest)(nil),                          // 0: google.ads.googleads.v8.services.GetAdParameterRequest
	(*MutateAdParametersRequest)(nil),                      // 1: google.ads.googleads.v8.services.MutateAdParametersRequest
	(*AdParameterOperation)(nil),                           // 2: google.ads.googleads.v8.services.AdParameterOperation
	(*MutateAdParametersResponse)(nil),                     // 3: google.ads.googleads.v8.services.MutateAdParametersResponse
	(*MutateAdParameterResult)(nil),                        // 4: google.ads.googleads.v8.services.MutateAdParameterResult
	...
	(*resources.AdParameter)(nil),                          // 7: google.ads.googleads.v8.resources.AdParameter
	(*status.Status)(nil),                                  // 8: google.rpc.Status
}
var file_google_ads_googleads_v8_services_ad_parameter_service_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v8.services.MutateAdParametersRequest.operations:type_name -> google.ads.googleads.v8.services.AdParameterOperation
	5,  // 1: google.ads.googleads.v8.services.MutateAdParametersRequest.response_content_type:type_name -> google.ads.googleads.v8.enums.ResponseContentTypeEnum.ResponseContentType
	6,  // 2: google.ads.googleads.v8.services.AdParameterOperation.update_mask:type_name -> google.protobuf.FieldMask
	7,  // 3: google.ads.googleads.v8.services.AdParameterOperation.create:type_name -> google.ads.googleads.v8.resources.AdParameter
	7,  // 4: google.ads.googleads.v8.services.AdParameterOperation.update:type_name -> google.ads.googleads.v8.resources.AdParameter
	8,  // 5: google.ads.googleads.v8.services.MutateAdParametersResponse.partial_failure_error:type_name -> google.rpc.Status
	4,  // 6: google.ads.googleads.v8.services.MutateAdParametersResponse.results:type_name -> google.ads.googleads.v8.services.MutateAdParameterResult
	7,  // 7: google.ads.googleads.v8.services.MutateAdParameterResult.ad_parameter:type_name -> google.ads.googleads.v8.resources.AdParameter
	0,  // 8: google.ads.googleads.v8.services.AdParameterService.GetAdParameter:input_type -> google.ads.googleads.v8.services.GetAdParameterRequest
	1,  // 9: google.ads.googleads.v8.services.AdParameterService.MutateAdParameters:input_type -> google.ads.googleads.v8.services.MutateAdParametersRequest
	7,  // 10: google.ads.googleads.v8.services.AdParameterService.GetAdParameter:output_type -> google.ads.googleads.v8.resources.AdParameter
	3,  // 11: google.ads.googleads.v8.services.AdParameterService.MutateAdParameters:output_type -> google.ads.googleads.v8.services.MutateAdParametersResponse
...
func init() { file_google_ads_googleads_v8_services_ad_parameter_service_proto_init() }
func file_google_ads_googleads_v8_services_ad_parameter_service_proto_init() {
	if File_google_ads_googleads_v8_services_ad_parameter_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_ad_parameter_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_ad_parameter_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_ad_parameter_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_ad_parameter_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_ad_parameter_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_ad_parameter_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_ad_parameter_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_ad_parameter_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_ad_parameter_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_ad_parameter_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_ad_parameter_service_proto = out.File
	file_google_ads_googleads_v8_services_ad_parameter_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_ad_parameter_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_ad_parameter_service_proto_depIdxs = nil
}
