...
func (x *GetAdGroupRequest) Reset() {
	*x = GetAdGroupRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_group_service_proto_msgTypes[0]
...
func (*GetAdGroupRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_group_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateAdGroupsRequest) Reset() {
	*x = MutateAdGroupsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_group_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_group_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *AdGroupOperation) Reset() {
	*x = AdGroupOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_group_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdGroupOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_group_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdGroupsResponse) Reset() {
	*x = MutateAdGroupsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_group_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_group_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateAdGroupResult) Reset() {
	*x = MutateAdGroupResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_group_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_group_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_ad_group_service_proto_rawDesc = []byte{
	...
	0x76, 0x38, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x39, 0x67, 0x6f, 0x6f,
	...
	0x70, 0x22, 0x42, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x2c, 0x12, 0x2a, 0x2f, 0x76, 0x38, 0x2f, 0x7b,
	...
	0x93, 0x02, 0x32, 0x22, 0x2d, 0x2f, 0x76, 0x38, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65,
	...
	0x64, 0x73, 0x2e, 0x76, 0x38, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x13,
...
var (
	file_google_ads_googleads_v8_services_ad_group_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_ad_group_service_proto_rawDescData = file_google_ads_googleads_v8_services_ad_group_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_ad_group_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_ad_group_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_ad_group_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_ad_group_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_ad_group_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_ad_group_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_ad_group_service_proto_goTypes = []interface{}{
	(*GetAdGroupRequest)(nil),                              // 0: google.ads.googleads.v8.services.GetAdGroupRequest
	(*MutateAdGroupsRequest)(nil),                          // 1: google.ads.googleads.v8.services.MutateAdGroupsRequest
	(*AdGroupOperation)(nil),                               // 2: google.ads.googleads.v8.services.AdGroupOperation
	(*MutateAdGroupsResponse)(nil),                         // 3: google.ads.googleads.v8.services.MutateAdGroupsResponse
	(*MutateAdGroupResult)(nil),                            // 4: google.ads.googleads.v8.services.MutateAdGroupResult
	...
	(*resources.AdGroup)(nil),                              // 7: google.ads.googleads.v8.resources.AdGroup
	(*status.Status)(nil),                                  // 8: google.rpc.Status
}
var file_google_ads_googleads_v8_services_ad_group_service_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v8.services.MutateAdGroupsRequest.operations:type_name -> google.ads.googleads.v8.services.AdGroupOperation
	5,  // 1: google.ads.googleads.v8.services.MutateAdGroupsRequest.response_content_type:type_name -> google.ads.googleads.v8.enums.ResponseContentTypeEnum.ResponseContentType
	6,  // 2: google.ads.googleads.v8.services.AdGroupOperation.update_mask:type_name -> google.protobuf.FieldMask
	7,  // 3: google.ads.googleads.v8.services.AdGroupOperation.create:type_name -> google.ads.googleads.v8.resources.AdGroup
	7,  // 4: google.ads.googleads.v8.services.AdGroupOperation.update:type_name -> google.ads.googleads.v8.resources.AdGroup
	8,  // 5: google.ads.googleads.v8.services.MutateAdGroupsResponse.partial_failure_error:type_name -> google.rpc.Status
	4,  // 6: google.ads.googleads.v8.services.MutateAdGroupsResponse.results:type_name -> google.ads.googleads.v8.services.MutateAdGroupResult
	7,  // 7: google.ads.googleads.v8.services.MutateAdGroupResult.ad_group:type_name -> google.ads.googleads.v8.resources.AdGroup
	0,  // 8: google.ads.googleads.v8.services.AdGroupService.GetAdGroup:input_type -> google.ads.googleads.v8.services.GetAdGroupRequest
	1,  // 9: google.ads.googleads.v8.services.AdGroupService.MutateAdGroups:input_type -> google.ads.googleads.v8.services.MutateAdGroupsRequest
	7,  // 10: google.ads.googleads.v8.services.AdGroupService.GetAdGroup:output_type -> google.ads.googleads.v8.resources.AdGroup
	3,  // 11: google.ads.googleads.v8.services.AdGroupService.MutateAdGroups:output_type -> google.ads.googleads.v8.services.MutateAdGroupsResponse
...
func init() { file_google_ads_googleads_v8_services_ad_group_service_proto_init() }
func file_google_ads_googleads_v8_services_ad_group_service_proto_init() {
	if File_google_ads_googleads_v8_services_ad_group_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_ad_group_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_ad_group_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_ad_group_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_ad_group_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_ad_group_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_ad_group_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_ad_group_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_ad_group_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_ad_group_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_ad_group_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_ad_group_service_proto = out.File
	file_google_ads_googleads_v8_services_ad_group_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_ad_group_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_ad_group_service_proto_depIdxs = nil
}
...
func (c *adGroupServiceClient) GetAdGroup(ctx context.Context, in *GetAdGroupRequest, opts ...grpc.CallOption) (*resources.AdGroup, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v8.services.AdGroupService/GetAdGroup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adGroupServiceClient) MutateAdGroups(ctx context.Context, in *MutateAdGroupsRequest, opts ...grpc.CallOption) (*MutateAdGroupsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v8.services.AdGroupService/MutateAdGroups", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AdGroupService_GetAdGroup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v8.services.AdGroupService/GetAdGroup",
	}
...
func _AdGroupService_MutateAdGroups_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v8.services.AdGroupService/MutateAdGroups",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
