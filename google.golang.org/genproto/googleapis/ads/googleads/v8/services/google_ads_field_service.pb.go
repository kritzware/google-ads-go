...
func (x *GetGoogleAdsFieldRequest) Reset() {
	*x = GetGoogleAdsFieldRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_google_ads_field_service_proto_msgTypes[0]
...
func (*GetGoogleAdsFieldRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_google_ads_field_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *SearchGoogleAdsFieldsRequest) Reset() {
	*x = SearchGoogleAdsFieldsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_google_ads_field_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SearchGoogleAdsFieldsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_google_ads_field_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *SearchGoogleAdsFieldsResponse) Reset() {
	*x = SearchGoogleAdsFieldsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_google_ads_field_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SearchGoogleAdsFieldsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_google_ads_field_service_proto_rawDescGZIP(), []int{2}
}
...
var file_google_ads_googleads_v8_services_google_ads_field_service_proto_rawDesc = []byte{
	...
	0x3d, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x27, 0x12, 0x25, 0x2f, 0x76, 0x38, 0x2f, 0x7b, 0x72, 0x65,
	...
	0x76, 0x38, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x65, 0x61, 0x72,
	...
	0x1f, 0x22, 0x1a, 0x2f, 0x76, 0x38, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x41, 0x64, 0x73,
...
var (
	file_google_ads_googleads_v8_services_google_ads_field_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_google_ads_field_service_proto_rawDescData = file_google_ads_googleads_v8_services_google_ads_field_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_google_ads_field_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_google_ads_field_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_google_ads_field_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_google_ads_field_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_google_ads_field_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_google_ads_field_service_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_google_ads_googleads_v8_services_google_ads_field_service_proto_goTypes = []interface{}{
	(*GetGoogleAdsFieldRequest)(nil),      // 0: google.ads.googleads.v8.services.GetGoogleAdsFieldRequest
	(*SearchGoogleAdsFieldsRequest)(nil),  // 1: google.ads.googleads.v8.services.SearchGoogleAdsFieldsRequest
	(*SearchGoogleAdsFieldsResponse)(nil), // 2: google.ads.googleads.v8.services.SearchGoogleAdsFieldsResponse
	(*resources.GoogleAdsField)(nil),      // 3: google.ads.googleads.v8.resources.GoogleAdsField
}
var file_google_ads_googleads_v8_services_google_ads_field_service_proto_depIdxs = []int32{
	3, // 0: google.ads.googleads.v8.services.SearchGoogleAdsFieldsResponse.results:type_name -> google.ads.googleads.v8.resources.GoogleAdsField
	0, // 1: google.ads.googleads.v8.services.GoogleAdsFieldService.GetGoogleAdsField:input_type -> google.ads.googleads.v8.services.GetGoogleAdsFieldRequest
	1, // 2: google.ads.googleads.v8.services.GoogleAdsFieldService.SearchGoogleAdsFields:input_type -> google.ads.googleads.v8.services.SearchGoogleAdsFieldsRequest
	3, // 3: google.ads.googleads.v8.services.GoogleAdsFieldService.GetGoogleAdsField:output_type -> google.ads.googleads.v8.resources.GoogleAdsField
	2, // 4: google.ads.googleads.v8.services.GoogleAdsFieldService.SearchGoogleAdsFields:output_type -> google.ads.googleads.v8.services.SearchGoogleAdsFieldsResponse
...
func init() { file_google_ads_googleads_v8_services_google_ads_field_service_proto_init() }
func file_google_ads_googleads_v8_services_google_ads_field_service_proto_init() {
	if File_google_ads_googleads_v8_services_google_ads_field_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_google_ads_field_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_google_ads_field_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_google_ads_field_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_google_ads_field_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_google_ads_field_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_google_ads_field_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_google_ads_field_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_google_ads_field_service_proto = out.File
	file_google_ads_googleads_v8_services_google_ads_field_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_google_ads_field_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_google_ads_field_service_proto_depIdxs = nil
}
...
func (c *googleAdsFieldServiceClient) GetGoogleAdsField(ctx context.Context, in *GetGoogleAdsFieldRequest, opts ...grpc.CallOption) (*resources.GoogleAdsField, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v8.services.GoogleAdsFieldService/GetGoogleAdsField", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *googleAdsFieldServiceClient) SearchGoogleAdsFields(ctx context.Context, in *SearchGoogleAdsFieldsRequest, opts ...grpc.CallOption) (*SearchGoogleAdsFieldsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v8.services.GoogleAdsFieldService/SearchGoogleAdsFields", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _GoogleAdsFieldService_GetGoogleAdsField_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v8.services.GoogleAdsFieldService/GetGoogleAdsField",
	}
...
func _GoogleAdsFieldService_SearchGoogleAdsFields_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v8.services.GoogleAdsFieldService/SearchGoogleAdsFields",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
