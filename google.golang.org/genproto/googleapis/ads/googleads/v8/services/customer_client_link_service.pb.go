...
func (x *GetCustomerClientLinkRequest) Reset() {
	*x = GetCustomerClientLinkRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_customer_client_link_service_proto_msgTypes[0]
...
func (*GetCustomerClientLinkRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_customer_client_link_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateCustomerClientLinkRequest) Reset() {
	*x = MutateCustomerClientLinkRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_customer_client_link_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerClientLinkRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_customer_client_link_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *CustomerClientLinkOperation) Reset() {
	*x = CustomerClientLinkOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_customer_client_link_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CustomerClientLinkOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_customer_client_link_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomerClientLinkResponse) Reset() {
	*x = MutateCustomerClientLinkResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_customer_client_link_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerClientLinkResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_customer_client_link_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateCustomerClientLinkResult) Reset() {
	*x = MutateCustomerClientLinkResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_customer_client_link_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerClientLinkResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_customer_client_link_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_customer_client_link_service_proto_rawDesc = []byte{
	...
	0x22, 0x38, 0x2f, 0x76, 0x38, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73, 0x2f,
...
var (
	file_google_ads_googleads_v8_services_customer_client_link_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_customer_client_link_service_proto_rawDescData = file_google_ads_googleads_v8_services_customer_client_link_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_customer_client_link_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_customer_client_link_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_customer_client_link_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_customer_client_link_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_customer_client_link_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_customer_client_link_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_customer_client_link_service_proto_goTypes = []interface{}{
	(*GetCustomerClientLinkRequest)(nil),     // 0: google.ads.googleads.v8.services.GetCustomerClientLinkRequest
	(*MutateCustomerClientLinkRequest)(nil),  // 1: google.ads.googleads.v8.services.MutateCustomerClientLinkRequest
	(*CustomerClientLinkOperation)(nil),      // 2: google.ads.googleads.v8.services.CustomerClientLinkOperation
	(*MutateCustomerClientLinkResponse)(nil), // 3: google.ads.googleads.v8.services.MutateCustomerClientLinkResponse
	(*MutateCustomerClientLinkResult)(nil),   // 4: google.ads.googleads.v8.services.MutateCustomerClientLinkResult
	(*fieldmaskpb.FieldMask)(nil),            // 5: google.protobuf.FieldMask
	(*resources.CustomerClientLink)(nil),     // 6: google.ads.googleads.v8.resources.CustomerClientLink
}
var file_google_ads_googleads_v8_services_customer_client_link_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v8.services.MutateCustomerClientLinkRequest.operation:type_name -> google.ads.googleads.v8.services.CustomerClientLinkOperation
	5, // 1: google.ads.googleads.v8.services.CustomerClientLinkOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 2: google.ads.googleads.v8.services.CustomerClientLinkOperation.create:type_name -> google.ads.googleads.v8.resources.CustomerClientLink
	6, // 3: google.ads.googleads.v8.services.CustomerClientLinkOperation.update:type_name -> google.ads.googleads.v8.resources.CustomerClientLink
	4, // 4: google.ads.googleads.v8.services.MutateCustomerClientLinkResponse.result:type_name -> google.ads.googleads.v8.services.MutateCustomerClientLinkResult
	0, // 5: google.ads.googleads.v8.services.CustomerClientLinkService.GetCustomerClientLink:input_type -> google.ads.googleads.v8.services.GetCustomerClientLinkRequest
	1, // 6: google.ads.googleads.v8.services.CustomerClientLinkService.MutateCustomerClientLink:input_type -> google.ads.googleads.v8.services.MutateCustomerClientLinkRequest
	6, // 7: google.ads.googleads.v8.services.CustomerClientLinkService.GetCustomerClientLink:output_type -> google.ads.googleads.v8.resources.CustomerClientLink
	3, // 8: google.ads.googleads.v8.services.CustomerClientLinkService.MutateCustomerClientLink:output_type -> google.ads.googleads.v8.services.MutateCustomerClientLinkResponse
...
func init() { file_google_ads_googleads_v8_services_customer_client_link_service_proto_init() }
func file_google_ads_googleads_v8_services_customer_client_link_service_proto_init() {
	if File_google_ads_googleads_v8_services_customer_client_link_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_customer_client_link_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_customer_client_link_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_customer_client_link_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_customer_client_link_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_customer_client_link_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_customer_client_link_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_customer_client_link_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_customer_client_link_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_customer_client_link_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_customer_client_link_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_customer_client_link_service_proto = out.File
	file_google_ads_googleads_v8_services_customer_client_link_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_customer_client_link_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_customer_client_link_service_proto_depIdxs = nil
}
