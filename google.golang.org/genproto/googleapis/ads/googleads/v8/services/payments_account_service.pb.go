...
func (x *ListPaymentsAccountsRequest) Reset() {
	*x = ListPaymentsAccountsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_payments_account_service_proto_msgTypes[0]
...
func (*ListPaymentsAccountsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_payments_account_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *ListPaymentsAccountsResponse) Reset() {
	*x = ListPaymentsAccountsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_payments_account_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListPaymentsAccountsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_payments_account_service_proto_rawDescGZIP(), []int{1}
}
...
var file_google_ads_googleads_v8_services_payments_account_service_proto_rawDesc = []byte{
	...
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x30, 0x12, 0x2e, 0x2f, 0x76, 0x38, 0x2f, 0x63, 0x75, 0x73, 0x74,
...
var (
	file_google_ads_googleads_v8_services_payments_account_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_payments_account_service_proto_rawDescData = file_google_ads_googleads_v8_services_payments_account_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_payments_account_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_payments_account_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_payments_account_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_payments_account_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_payments_account_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_payments_account_service_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v8_services_payments_account_service_proto_goTypes = []interface{}{
	(*ListPaymentsAccountsRequest)(nil),  // 0: google.ads.googleads.v8.services.ListPaymentsAccountsRequest
	(*ListPaymentsAccountsResponse)(nil), // 1: google.ads.googleads.v8.services.ListPaymentsAccountsResponse
	(*resources.PaymentsAccount)(nil),    // 2: google.ads.googleads.v8.resources.PaymentsAccount
}
var file_google_ads_googleads_v8_services_payments_account_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v8.services.ListPaymentsAccountsResponse.payments_accounts:type_name -> google.ads.googleads.v8.resources.PaymentsAccount
	0, // 1: google.ads.googleads.v8.services.PaymentsAccountService.ListPaymentsAccounts:input_type -> google.ads.googleads.v8.services.ListPaymentsAccountsRequest
	1, // 2: google.ads.googleads.v8.services.PaymentsAccountService.ListPaymentsAccounts:output_type -> google.ads.googleads.v8.services.ListPaymentsAccountsResponse
...
func init() { file_google_ads_googleads_v8_services_payments_account_service_proto_init() }
func file_google_ads_googleads_v8_services_payments_account_service_proto_init() {
	if File_google_ads_googleads_v8_services_payments_account_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_payments_account_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_payments_account_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_payments_account_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_payments_account_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_payments_account_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_payments_account_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_payments_account_service_proto = out.File
	file_google_ads_googleads_v8_services_payments_account_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_payments_account_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_payments_account_service_proto_depIdxs = nil
}
...
func (c *paymentsAccountServiceClient) ListPaymentsAccounts(ctx context.Context, in *ListPaymentsAccountsRequest, opts ...grpc.CallOption) (*ListPaymentsAccountsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v8.services.PaymentsAccountService/ListPaymentsAccounts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PaymentsAccountService_ListPaymentsAccounts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v8.services.PaymentsAccountService/ListPaymentsAccounts",
	}
