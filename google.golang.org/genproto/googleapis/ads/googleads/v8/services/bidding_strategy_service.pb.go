...
func (x *GetBiddingStrategyRequest) Reset() {
	*x = GetBiddingStrategyRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_bidding_strategy_service_proto_msgTypes[0]
...
func (*GetBiddingStrategyRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_bidding_strategy_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateBiddingStrategiesRequest) Reset() {
	*x = MutateBiddingStrategiesRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_bidding_strategy_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateBiddingStrategiesRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_bidding_strategy_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *BiddingStrategyOperation) Reset() {
	*x = BiddingStrategyOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_bidding_strategy_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BiddingStrategyOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_bidding_strategy_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateBiddingStrategiesResponse) Reset() {
	*x = MutateBiddingStrategiesResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_bidding_strategy_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateBiddingStrategiesResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_bidding_strategy_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateBiddingStrategyResult) Reset() {
	*x = MutateBiddingStrategyResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_bidding_strategy_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateBiddingStrategyResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_bidding_strategy_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_bidding_strategy_service_proto_rawDesc = []byte{
	...
	0x38, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x42, 0x69, 0x64, 0x64, 0x69,
	...
	0x73, 0x2e, 0x76, 0x38, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x42,
	...
	0x93, 0x02, 0x35, 0x12, 0x33, 0x2f, 0x76, 0x38, 0x2f, 0x7b, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72,
	...
	0x3b, 0x22, 0x36, 0x2f, 0x76, 0x38, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73,
...
var (
	file_google_ads_googleads_v8_services_bidding_strategy_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_bidding_strategy_service_proto_rawDescData = file_google_ads_googleads_v8_services_bidding_strategy_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_bidding_strategy_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_bidding_strategy_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_bidding_strategy_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_bidding_strategy_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_bidding_strategy_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_bidding_strategy_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_bidding_strategy_service_proto_goTypes = []interface{}{
	(*GetBiddingStrategyRequest)(nil),                      // 0: google.ads.googleads.v8.services.GetBiddingStrategyRequest
	(*MutateBiddingStrategiesRequest)(nil),                 // 1: google.ads.googleads.v8.services.MutateBiddingStrategiesRequest
	(*BiddingStrategyOperation)(nil),                       // 2: google.ads.googleads.v8.services.BiddingStrategyOperation
	(*MutateBiddingStrategiesResponse)(nil),                // 3: google.ads.googleads.v8.services.MutateBiddingStrategiesResponse
	(*MutateBiddingStrategyResult)(nil),                    // 4: google.ads.googleads.v8.services.MutateBiddingStrategyResult
	...
	(*resources.BiddingStrategy)(nil),                      // 7: google.ads.googleads.v8.resources.BiddingStrategy
	(*status.Status)(nil),                                  // 8: google.rpc.Status
}
var file_google_ads_googleads_v8_services_bidding_strategy_service_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v8.services.MutateBiddingStrategiesRequest.operations:type_name -> google.ads.googleads.v8.services.BiddingStrategyOperation
	5,  // 1: google.ads.googleads.v8.services.MutateBiddingStrategiesRequest.response_content_type:type_name -> google.ads.googleads.v8.enums.ResponseContentTypeEnum.ResponseContentType
	6,  // 2: google.ads.googleads.v8.services.BiddingStrategyOperation.update_mask:type_name -> google.protobuf.FieldMask
	7,  // 3: google.ads.googleads.v8.services.BiddingStrategyOperation.create:type_name -> google.ads.googleads.v8.resources.BiddingStrategy
	7,  // 4: google.ads.googleads.v8.services.BiddingStrategyOperation.update:type_name -> google.ads.googleads.v8.resources.BiddingStrategy
	8,  // 5: google.ads.googleads.v8.services.MutateBiddingStrategiesResponse.partial_failure_error:type_name -> google.rpc.Status
	4,  // 6: google.ads.googleads.v8.services.MutateBiddingStrategiesResponse.results:type_name -> google.ads.googleads.v8.services.MutateBiddingStrategyResult
	7,  // 7: google.ads.googleads.v8.services.MutateBiddingStrategyResult.bidding_strategy:type_name -> google.ads.googleads.v8.resources.BiddingStrategy
	0,  // 8: google.ads.googleads.v8.services.BiddingStrategyService.GetBiddingStrategy:input_type -> google.ads.googleads.v8.services.GetBiddingStrategyRequest
	1,  // 9: google.ads.googleads.v8.services.BiddingStrategyService.MutateBiddingStrategies:input_type -> google.ads.googleads.v8.services.MutateBiddingStrategiesRequest
	7,  // 10: google.ads.googleads.v8.services.BiddingStrategyService.GetBiddingStrategy:output_type -> google.ads.googleads.v8.resources.BiddingStrategy
	3,  // 11: google.ads.googleads.v8.services.BiddingStrategyService.MutateBiddingStrategies:output_type -> google.ads.googleads.v8.services.MutateBiddingStrategiesResponse
...
func init() { file_google_ads_googleads_v8_services_bidding_strategy_service_proto_init() }
func file_google_ads_googleads_v8_services_bidding_strategy_service_proto_init() {
	if File_google_ads_googleads_v8_services_bidding_strategy_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_bidding_strategy_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_bidding_strategy_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_bidding_strategy_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_bidding_strategy_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_bidding_strategy_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_bidding_strategy_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_bidding_strategy_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_bidding_strategy_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_bidding_strategy_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_bidding_strategy_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_bidding_strategy_service_proto = out.File
	file_google_ads_googleads_v8_services_bidding_strategy_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_bidding_strategy_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_bidding_strategy_service_proto_depIdxs = nil
}
