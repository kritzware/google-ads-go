...
func (x *GetAdGroupCriterionRequest) Reset() {
	*x = GetAdGroupCriterionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_msgTypes[0]
...
func (*GetAdGroupCriterionRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateAdGroupCriteriaRequest) Reset() {
	*x = MutateAdGroupCriteriaRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupCriteriaRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *AdGroupCriterionOperation) Reset() {
	*x = AdGroupCriterionOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdGroupCriterionOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdGroupCriteriaResponse) Reset() {
	*x = MutateAdGroupCriteriaResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupCriteriaResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateAdGroupCriterionResult) Reset() {
	*x = MutateAdGroupCriterionResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupCriterionResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_rawDesc = []byte{
	...
	0xd3, 0xe4, 0x93, 0x02, 0x33, 0x12, 0x31, 0x2f, 0x76, 0x38, 0x2f, 0x7b, 0x72, 0x65, 0x73, 0x6f,
	...
	0x6e, 0x73, 0x65, 0x22, 0x58, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x39, 0x22, 0x34, 0x2f, 0x76, 0x38,
	...
	0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64,
	0x73, 0x2e, 0x76, 0x38, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x1c, 0x41,
...
var (
	file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_rawDescData = file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_goTypes = []interface{}{
	(*GetAdGroupCriterionRequest)(nil),                     // 0: google.ads.googleads.v8.services.GetAdGroupCriterionRequest
	(*MutateAdGroupCriteriaRequest)(nil),                   // 1: google.ads.googleads.v8.services.MutateAdGroupCriteriaRequest
	(*AdGroupCriterionOperation)(nil),                      // 2: google.ads.googleads.v8.services.AdGroupCriterionOperation
	(*MutateAdGroupCriteriaResponse)(nil),                  // 3: google.ads.googleads.v8.services.MutateAdGroupCriteriaResponse
	(*MutateAdGroupCriterionResult)(nil),                   // 4: google.ads.googleads.v8.services.MutateAdGroupCriterionResult
	...
	(*common.PolicyViolationKey)(nil),                      // 7: google.ads.googleads.v8.common.PolicyViolationKey
	(*resources.AdGroupCriterion)(nil),                     // 8: google.ads.googleads.v8.resources.AdGroupCriterion
	(*status.Status)(nil),                                  // 9: google.rpc.Status
}
var file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v8.services.MutateAdGroupCriteriaRequest.operations:type_name -> google.ads.googleads.v8.services.AdGroupCriterionOperation
	5,  // 1: google.ads.googleads.v8.services.MutateAdGroupCriteriaRequest.response_content_type:type_name -> google.ads.googleads.v8.enums.ResponseContentTypeEnum.ResponseContentType
	6,  // 2: google.ads.googleads.v8.services.AdGroupCriterionOperation.update_mask:type_name -> google.protobuf.FieldMask
	7,  // 3: google.ads.googleads.v8.services.AdGroupCriterionOperation.exempt_policy_violation_keys:type_name -> google.ads.googleads.v8.common.PolicyViolationKey
	8,  // 4: google.ads.googleads.v8.services.AdGroupCriterionOperation.create:type_name -> google.ads.googleads.v8.resources.AdGroupCriterion
	8,  // 5: google.ads.googleads.v8.services.AdGroupCriterionOperation.update:type_name -> google.ads.googleads.v8.resources.AdGroupCriterion
	9,  // 6: google.ads.googleads.v8.services.MutateAdGroupCriteriaResponse.partial_failure_error:type_name -> google.rpc.Status
	4,  // 7: google.ads.googleads.v8.services.MutateAdGroupCriteriaResponse.results:type_name -> google.ads.googleads.v8.services.MutateAdGroupCriterionResult
	8,  // 8: google.ads.googleads.v8.services.MutateAdGroupCriterionResult.ad_group_criterion:type_name -> google.ads.googleads.v8.resources.AdGroupCriterion
	0,  // 9: google.ads.googleads.v8.services.AdGroupCriterionService.GetAdGroupCriterion:input_type -> google.ads.googleads.v8.services.GetAdGroupCriterionRequest
	1,  // 10: google.ads.googleads.v8.services.AdGroupCriterionService.MutateAdGroupCriteria:input_type -> google.ads.googleads.v8.services.MutateAdGroupCriteriaRequest
	8,  // 11: google.ads.googleads.v8.services.AdGroupCriterionService.GetAdGroupCriterion:output_type -> google.ads.googleads.v8.resources.AdGroupCriterion
	3,  // 12: google.ads.googleads.v8.services.AdGroupCriterionService.MutateAdGroupCriteria:output_type -> google.ads.googleads.v8.services.MutateAdGroupCriteriaResponse
...
func init() { file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_init() }
func file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_init() {
	if File_google_ads_googleads_v8_services_ad_group_criterion_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_ad_group_criterion_service_proto = out.File
	file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_ad_group_criterion_service_proto_depIdxs = nil
}
