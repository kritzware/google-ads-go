...
func (x *GetCampaignAssetRequest) Reset() {
	*x = GetCampaignAssetRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_asset_service_proto_msgTypes[0]
...
func (*GetCampaignAssetRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_asset_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateCampaignAssetsRequest) Reset() {
	*x = MutateCampaignAssetsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_asset_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignAssetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_asset_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *CampaignAssetOperation) Reset() {
	*x = CampaignAssetOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_asset_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CampaignAssetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_asset_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCampaignAssetsResponse) Reset() {
	*x = MutateCampaignAssetsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_asset_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignAssetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_asset_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateCampaignAssetResult) Reset() {
	*x = MutateCampaignAssetResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_asset_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignAssetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_asset_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_campaign_asset_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v8_services_campaign_asset_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_campaign_asset_service_proto_rawDescData = file_google_ads_googleads_v8_services_campaign_asset_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_campaign_asset_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_campaign_asset_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_campaign_asset_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_campaign_asset_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_campaign_asset_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_campaign_asset_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_campaign_asset_service_proto_goTypes = []interface{}{
	(*GetCampaignAssetRequest)(nil),                        // 0: google.ads.googleads.v8.services.GetCampaignAssetRequest
	(*MutateCampaignAssetsRequest)(nil),                    // 1: google.ads.googleads.v8.services.MutateCampaignAssetsRequest
	(*CampaignAssetOperation)(nil),                         // 2: google.ads.googleads.v8.services.CampaignAssetOperation
	(*MutateCampaignAssetsResponse)(nil),                   // 3: google.ads.googleads.v8.services.MutateCampaignAssetsResponse
	(*MutateCampaignAssetResult)(nil),                      // 4: google.ads.googleads.v8.services.MutateCampaignAssetResult
	...
	(*resources.CampaignAsset)(nil),                        // 7: google.ads.googleads.v8.resources.CampaignAsset
	(*status.Status)(nil),                                  // 8: google.rpc.Status
}
var file_google_ads_googleads_v8_services_campaign_asset_service_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v8.services.MutateCampaignAssetsRequest.operations:type_name -> google.ads.googleads.v8.services.CampaignAssetOperation
	5,  // 1: google.ads.googleads.v8.services.MutateCampaignAssetsRequest.response_content_type:type_name -> google.ads.googleads.v8.enums.ResponseContentTypeEnum.ResponseContentType
	6,  // 2: google.ads.googleads.v8.services.CampaignAssetOperation.update_mask:type_name -> google.protobuf.FieldMask
	7,  // 3: google.ads.googleads.v8.services.CampaignAssetOperation.create:type_name -> google.ads.googleads.v8.resources.CampaignAsset
	7,  // 4: google.ads.googleads.v8.services.CampaignAssetOperation.update:type_name -> google.ads.googleads.v8.resources.CampaignAsset
	8,  // 5: google.ads.googleads.v8.services.MutateCampaignAssetsResponse.partial_failure_error:type_name -> google.rpc.Status
	4,  // 6: google.ads.googleads.v8.services.MutateCampaignAssetsResponse.results:type_name -> google.ads.googleads.v8.services.MutateCampaignAssetResult
	7,  // 7: google.ads.googleads.v8.services.MutateCampaignAssetResult.campaign_asset:type_name -> google.ads.googleads.v8.resources.CampaignAsset
	0,  // 8: google.ads.googleads.v8.services.CampaignAssetService.GetCampaignAsset:input_type -> google.ads.googleads.v8.services.GetCampaignAssetRequest
	1,  // 9: google.ads.googleads.v8.services.CampaignAssetService.MutateCampaignAssets:input_type -> google.ads.googleads.v8.services.MutateCampaignAssetsRequest
	7,  // 10: google.ads.googleads.v8.services.CampaignAssetService.GetCampaignAsset:output_type -> google.ads.googleads.v8.resources.CampaignAsset
	3,  // 11: google.ads.googleads.v8.services.CampaignAssetService.MutateCampaignAssets:output_type -> google.ads.googleads.v8.services.MutateCampaignAssetsResponse
...
func init() { file_google_ads_googleads_v8_services_campaign_asset_service_proto_init() }
func file_google_ads_googleads_v8_services_campaign_asset_service_proto_init() {
	if File_google_ads_googleads_v8_services_campaign_asset_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_campaign_asset_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_campaign_asset_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_campaign_asset_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_campaign_asset_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_campaign_asset_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_campaign_asset_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_campaign_asset_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_campaign_asset_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_campaign_asset_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_campaign_asset_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_campaign_asset_service_proto = out.File
	file_google_ads_googleads_v8_services_campaign_asset_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_campaign_asset_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_campaign_asset_service_proto_depIdxs = nil
}
...
func (c *campaignAssetServiceClient) GetCampaignAsset(ctx context.Context, in *GetCampaignAssetRequest, opts ...grpc.CallOption) (*resources.CampaignAsset, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v8.services.CampaignAssetService/GetCampaignAsset", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *campaignAssetServiceClient) MutateCampaignAssets(ctx context.Context, in *MutateCampaignAssetsRequest, opts ...grpc.CallOption) (*MutateCampaignAssetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v8.services.CampaignAssetService/MutateCampaignAssets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CampaignAssetService_GetCampaignAsset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v8.services.CampaignAssetService/GetCampaignAsset",
	}
...
func _CampaignAssetService_MutateCampaignAssets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v8.services.CampaignAssetService/MutateCampaignAssets",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
