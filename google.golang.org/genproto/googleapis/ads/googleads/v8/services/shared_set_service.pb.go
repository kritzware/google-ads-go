...
func (x *GetSharedSetRequest) Reset() {
	*x = GetSharedSetRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_shared_set_service_proto_msgTypes[0]
...
func (*GetSharedSetRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_shared_set_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateSharedSetsRequest) Reset() {
	*x = MutateSharedSetsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_shared_set_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateSharedSetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_shared_set_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *SharedSetOperation) Reset() {
	*x = SharedSetOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_shared_set_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SharedSetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_shared_set_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateSharedSetsResponse) Reset() {
	*x = MutateSharedSetsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_shared_set_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateSharedSetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_shared_set_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateSharedSetResult) Reset() {
	*x = MutateSharedSetResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_shared_set_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateSharedSetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_shared_set_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_shared_set_service_proto_rawDesc = []byte{
	...
	0x38, 0x2f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2f, 0x73, 0x68, 0x61, 0x72,
	...
	0x76, 0x38, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x68, 0x61, 0x72,
	...
	0x2e, 0x76, 0x38, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x68,
	...
	0x2c, 0x2f, 0x76, 0x38, 0x2f, 0x7b, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x6e,
	...
	0x34, 0x22, 0x2f, 0x2f, 0x76, 0x38, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73,
...
var (
	file_google_ads_googleads_v8_services_shared_set_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_shared_set_service_proto_rawDescData = file_google_ads_googleads_v8_services_shared_set_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_shared_set_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_shared_set_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_shared_set_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_shared_set_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_shared_set_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_shared_set_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_shared_set_service_proto_goTypes = []interface{}{
	(*GetSharedSetRequest)(nil),                            // 0: google.ads.googleads.v8.services.GetSharedSetRequest
	(*MutateSharedSetsRequest)(nil),                        // 1: google.ads.googleads.v8.services.MutateSharedSetsRequest
	(*SharedSetOperation)(nil),                             // 2: google.ads.googleads.v8.services.SharedSetOperation
	(*MutateSharedSetsResponse)(nil),                       // 3: google.ads.googleads.v8.services.MutateSharedSetsResponse
	(*MutateSharedSetResult)(nil),                          // 4: google.ads.googleads.v8.services.MutateSharedSetResult
	...
	(*resources.SharedSet)(nil),                            // 7: google.ads.googleads.v8.resources.SharedSet
	(*status.Status)(nil),                                  // 8: google.rpc.Status
}
var file_google_ads_googleads_v8_services_shared_set_service_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v8.services.MutateSharedSetsRequest.operations:type_name -> google.ads.googleads.v8.services.SharedSetOperation
	5,  // 1: google.ads.googleads.v8.services.MutateSharedSetsRequest.response_content_type:type_name -> google.ads.googleads.v8.enums.ResponseContentTypeEnum.ResponseContentType
	6,  // 2: google.ads.googleads.v8.services.SharedSetOperation.update_mask:type_name -> google.protobuf.FieldMask
	7,  // 3: google.ads.googleads.v8.services.SharedSetOperation.create:type_name -> google.ads.googleads.v8.resources.SharedSet
	7,  // 4: google.ads.googleads.v8.services.SharedSetOperation.update:type_name -> google.ads.googleads.v8.resources.SharedSet
	8,  // 5: google.ads.googleads.v8.services.MutateSharedSetsResponse.partial_failure_error:type_name -> google.rpc.Status
	4,  // 6: google.ads.googleads.v8.services.MutateSharedSetsResponse.results:type_name -> google.ads.googleads.v8.services.MutateSharedSetResult
	7,  // 7: google.ads.googleads.v8.services.MutateSharedSetResult.shared_set:type_name -> google.ads.googleads.v8.resources.SharedSet
	0,  // 8: google.ads.googleads.v8.services.SharedSetService.GetSharedSet:input_type -> google.ads.googleads.v8.services.GetSharedSetRequest
	1,  // 9: google.ads.googleads.v8.services.SharedSetService.MutateSharedSets:input_type -> google.ads.googleads.v8.services.MutateSharedSetsRequest
	7,  // 10: google.ads.googleads.v8.services.SharedSetService.GetSharedSet:output_type -> google.ads.googleads.v8.resources.SharedSet
	3,  // 11: google.ads.googleads.v8.services.SharedSetService.MutateSharedSets:output_type -> google.ads.googleads.v8.services.MutateSharedSetsResponse
...
func init() { file_google_ads_googleads_v8_services_shared_set_service_proto_init() }
func file_google_ads_googleads_v8_services_shared_set_service_proto_init() {
	if File_google_ads_googleads_v8_services_shared_set_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_shared_set_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_shared_set_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_shared_set_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_shared_set_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_shared_set_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_shared_set_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_shared_set_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_shared_set_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_shared_set_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_shared_set_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_shared_set_service_proto = out.File
	file_google_ads_googleads_v8_services_shared_set_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_shared_set_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_shared_set_service_proto_depIdxs = nil
}
