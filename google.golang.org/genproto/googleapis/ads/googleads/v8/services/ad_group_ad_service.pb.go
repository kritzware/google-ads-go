...
func (x *GetAdGroupAdRequest) Reset() {
	*x = GetAdGroupAdRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_group_ad_service_proto_msgTypes[0]
...
func (*GetAdGroupAdRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_group_ad_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateAdGroupAdsRequest) Reset() {
	*x = MutateAdGroupAdsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_group_ad_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupAdsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_group_ad_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *AdGroupAdOperation) Reset() {
	*x = AdGroupAdOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_group_ad_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdGroupAdOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_group_ad_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdGroupAdsResponse) Reset() {
	*x = MutateAdGroupAdsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_group_ad_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupAdsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_group_ad_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateAdGroupAdResult) Reset() {
	*x = MutateAdGroupAdResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_group_ad_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupAdResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_group_ad_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_ad_group_ad_service_proto_rawDesc = []byte{
	...
	0x64, 0x73, 0x2e, 0x76, 0x38, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x2b,
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x61, 0x64, 0x73, 0x2f, 0x76, 0x38, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x70,
	...
	0x73, 0x2f, 0x76, 0x38, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x72, 0x65, 0x73, 0x70, 0x6f,
	...
	0x41, 0x64, 0x22, 0x44, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x2e, 0x12, 0x2c, 0x2f, 0x76, 0x38, 0x2f,
...
var (
	file_google_ads_googleads_v8_services_ad_group_ad_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_ad_group_ad_service_proto_rawDescData = file_google_ads_googleads_v8_services_ad_group_ad_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_ad_group_ad_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_ad_group_ad_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_ad_group_ad_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_ad_group_ad_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_ad_group_ad_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_ad_group_ad_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_ad_group_ad_service_proto_goTypes = []interface{}{
	(*GetAdGroupAdRequest)(nil),                            // 0: google.ads.googleads.v8.services.GetAdGroupAdRequest
	(*MutateAdGroupAdsRequest)(nil),                        // 1: google.ads.googleads.v8.services.MutateAdGroupAdsRequest
	(*AdGroupAdOperation)(nil),                             // 2: google.ads.googleads.v8.services.AdGroupAdOperation
	(*MutateAdGroupAdsResponse)(nil),                       // 3: google.ads.googleads.v8.services.MutateAdGroupAdsResponse
	(*MutateAdGroupAdResult)(nil),                          // 4: google.ads.googleads.v8.services.MutateAdGroupAdResult
	...
	(*common.PolicyValidationParameter)(nil),               // 7: google.ads.googleads.v8.common.PolicyValidationParameter
	(*resources.AdGroupAd)(nil),                            // 8: google.ads.googleads.v8.resources.AdGroupAd
	(*status.Status)(nil),                                  // 9: google.rpc.Status
}
var file_google_ads_googleads_v8_services_ad_group_ad_service_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v8.services.MutateAdGroupAdsRequest.operations:type_name -> google.ads.googleads.v8.services.AdGroupAdOperation
	5,  // 1: google.ads.googleads.v8.services.MutateAdGroupAdsRequest.response_content_type:type_name -> google.ads.googleads.v8.enums.ResponseContentTypeEnum.ResponseContentType
	6,  // 2: google.ads.googleads.v8.services.AdGroupAdOperation.update_mask:type_name -> google.protobuf.FieldMask
	7,  // 3: google.ads.googleads.v8.services.AdGroupAdOperation.policy_validation_parameter:type_name -> google.ads.googleads.v8.common.PolicyValidationParameter
	8,  // 4: google.ads.googleads.v8.services.AdGroupAdOperation.create:type_name -> google.ads.googleads.v8.resources.AdGroupAd
	8,  // 5: google.ads.googleads.v8.services.AdGroupAdOperation.update:type_name -> google.ads.googleads.v8.resources.AdGroupAd
	9,  // 6: google.ads.googleads.v8.services.MutateAdGroupAdsResponse.partial_failure_error:type_name -> google.rpc.Status
	4,  // 7: google.ads.googleads.v8.services.MutateAdGroupAdsResponse.results:type_name -> google.ads.googleads.v8.services.MutateAdGroupAdResult
	8,  // 8: google.ads.googleads.v8.services.MutateAdGroupAdResult.ad_group_ad:type_name -> google.ads.googleads.v8.resources.AdGroupAd
	0,  // 9: google.ads.googleads.v8.services.AdGroupAdService.GetAdGroupAd:input_type -> google.ads.googleads.v8.services.GetAdGroupAdRequest
	1,  // 10: google.ads.googleads.v8.services.AdGroupAdService.MutateAdGroupAds:input_type -> google.ads.googleads.v8.services.MutateAdGroupAdsRequest
	8,  // 11: google.ads.googleads.v8.services.AdGroupAdService.GetAdGroupAd:output_type -> google.ads.googleads.v8.resources.AdGroupAd
	3,  // 12: google.ads.googleads.v8.services.AdGroupAdService.MutateAdGroupAds:output_type -> google.ads.googleads.v8.services.MutateAdGroupAdsResponse
...
func init() { file_google_ads_googleads_v8_services_ad_group_ad_service_proto_init() }
func file_google_ads_googleads_v8_services_ad_group_ad_service_proto_init() {
	if File_google_ads_googleads_v8_services_ad_group_ad_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_ad_group_ad_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_ad_group_ad_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_ad_group_ad_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_ad_group_ad_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_ad_group_ad_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_ad_group_ad_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_ad_group_ad_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_ad_group_ad_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_ad_group_ad_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_ad_group_ad_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_ad_group_ad_service_proto = out.File
	file_google_ads_googleads_v8_services_ad_group_ad_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_ad_group_ad_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_ad_group_ad_service_proto_depIdxs = nil
}
