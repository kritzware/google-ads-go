...
func (x *GetChangeStatusRequest) Reset() {
	*x = GetChangeStatusRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_change_status_service_proto_msgTypes[0]
...
func (*GetChangeStatusRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_change_status_service_proto_rawDescGZIP(), []int{0}
}
...
var file_google_ads_googleads_v8_services_change_status_service_proto_rawDesc = []byte{
	...
	0x46, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x30, 0x12, 0x2e, 0x2f, 0x76, 0x38, 0x2f, 0x7b, 0x72, 0x65,
...
var (
	file_google_ads_googleads_v8_services_change_status_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_change_status_service_proto_rawDescData = file_google_ads_googleads_v8_services_change_status_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_change_status_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_change_status_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_change_status_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_change_status_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_change_status_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_change_status_service_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v8_services_change_status_service_proto_goTypes = []interface{}{
	(*GetChangeStatusRequest)(nil), // 0: google.ads.googleads.v8.services.GetChangeStatusRequest
	(*resources.ChangeStatus)(nil), // 1: google.ads.googleads.v8.resources.ChangeStatus
}
var file_google_ads_googleads_v8_services_change_status_service_proto_depIdxs = []int32{
	0, // 0: google.ads.googleads.v8.services.ChangeStatusService.GetChangeStatus:input_type -> google.ads.googleads.v8.services.GetChangeStatusRequest
	1, // 1: google.ads.googleads.v8.services.ChangeStatusService.GetChangeStatus:output_type -> google.ads.googleads.v8.resources.ChangeStatus
...
func init() { file_google_ads_googleads_v8_services_change_status_service_proto_init() }
func file_google_ads_googleads_v8_services_change_status_service_proto_init() {
	if File_google_ads_googleads_v8_services_change_status_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_change_status_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_change_status_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_change_status_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_change_status_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_change_status_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_change_status_service_proto = out.File
	file_google_ads_googleads_v8_services_change_status_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_change_status_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_change_status_service_proto_depIdxs = nil
}
...
func (c *changeStatusServiceClient) GetChangeStatus(ctx context.Context, in *GetChangeStatusRequest, opts ...grpc.CallOption) (*resources.ChangeStatus, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v8.services.ChangeStatusService/GetChangeStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ChangeStatusService_GetChangeStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v8.services.ChangeStatusService/GetChangeStatus",
	}
