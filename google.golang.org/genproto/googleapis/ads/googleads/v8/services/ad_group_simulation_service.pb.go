...
func (x *GetAdGroupSimulationRequest) Reset() {
	*x = GetAdGroupSimulationRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_group_simulation_service_proto_msgTypes[0]
...
func (*GetAdGroupSimulationRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_group_simulation_service_proto_rawDescGZIP(), []int{0}
}
...
var file_google_ads_googleads_v8_services_ad_group_simulation_service_proto_rawDesc = []byte{
	...
	0x36, 0x12, 0x34, 0x2f, 0x76, 0x38, 0x2f, 0x7b, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
...
var (
	file_google_ads_googleads_v8_services_ad_group_simulation_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_ad_group_simulation_service_proto_rawDescData = file_google_ads_googleads_v8_services_ad_group_simulation_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_ad_group_simulation_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_ad_group_simulation_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_ad_group_simulation_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_ad_group_simulation_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_ad_group_simulation_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_ad_group_simulation_service_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v8_services_ad_group_simulation_service_proto_goTypes = []interface{}{
	(*GetAdGroupSimulationRequest)(nil), // 0: google.ads.googleads.v8.services.GetAdGroupSimulationRequest
	(*resources.AdGroupSimulation)(nil), // 1: google.ads.googleads.v8.resources.AdGroupSimulation
}
var file_google_ads_googleads_v8_services_ad_group_simulation_service_proto_depIdxs = []int32{
	0, // 0: google.ads.googleads.v8.services.AdGroupSimulationService.GetAdGroupSimulation:input_type -> google.ads.googleads.v8.services.GetAdGroupSimulationRequest
	1, // 1: google.ads.googleads.v8.services.AdGroupSimulationService.GetAdGroupSimulation:output_type -> google.ads.googleads.v8.resources.AdGroupSimulation
...
func init() { file_google_ads_googleads_v8_services_ad_group_simulation_service_proto_init() }
func file_google_ads_googleads_v8_services_ad_group_simulation_service_proto_init() {
	if File_google_ads_googleads_v8_services_ad_group_simulation_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_ad_group_simulation_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_ad_group_simulation_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_ad_group_simulation_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_ad_group_simulation_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_ad_group_simulation_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_ad_group_simulation_service_proto = out.File
	file_google_ads_googleads_v8_services_ad_group_simulation_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_ad_group_simulation_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_ad_group_simulation_service_proto_depIdxs = nil
}
...
func (c *adGroupSimulationServiceClient) GetAdGroupSimulation(ctx context.Context, in *GetAdGroupSimulationRequest, opts ...grpc.CallOption) (*resources.AdGroupSimulation, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v8.services.AdGroupSimulationService/GetAdGroupSimulation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AdGroupSimulationService_GetAdGroupSimulation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v8.services.AdGroupSimulationService/GetAdGroupSimulation",
	}
