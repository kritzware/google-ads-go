...
func (x *UploadConversionAdjustmentsRequest) Reset() {
	*x = UploadConversionAdjustmentsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_msgTypes[0]
...
func (*UploadConversionAdjustmentsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *UploadConversionAdjustmentsResponse) Reset() {
	*x = UploadConversionAdjustmentsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UploadConversionAdjustmentsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_rawDescGZIP(), []int{1}
}
...
type ConversionAdjustment struct {
	...
	// The adjustment type.
	AdjustmentType enums.ConversionAdjustmentTypeEnum_ConversionAdjustmentType `protobuf:"varint,5,opt,name=adjustment_type,json=adjustmentType,proto3,enum=google.ads.googleads.v8.enums.ConversionAdjustmentTypeEnum_ConversionAdjustmentType" json:"adjustment_type,omitempty"`
...
func (x *ConversionAdjustment) Reset() {
	*x = ConversionAdjustment{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ConversionAdjustment) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *RestatementValue) Reset() {
	*x = RestatementValue{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RestatementValue) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *GclidDateTimePair) Reset() {
	*x = GclidDateTimePair{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GclidDateTimePair) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_rawDescGZIP(), []int{4}
}
...
func (x *ConversionAdjustmentResult) Reset() {
	*x = ConversionAdjustmentResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ConversionAdjustmentResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_rawDescGZIP(), []int{5}
}
...
var file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_rawDesc = []byte{
	...
	0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x69,
	...
	0x76, 0x38, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x52, 0x65, 0x73, 0x74,
	...
	0x64, 0x73, 0x2e, 0x76, 0x38, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x47,
	...
	0x5f, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x32, 0x92, 0x03, 0x0a, 0x21, 0x43,
	0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x41, 0x64, 0x6a, 0x75, 0x73, 0x74, 0x6d,
	...
	0x5f, 0x66, 0x61, 0x69, 0x6c, 0x75, 0x72, 0x65, 0x1a, 0x45, 0xca, 0x41, 0x18, 0x67, 0x6f, 0x6f,
	...
	0x8d, 0x02, 0x0a, 0x24, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61,
	0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x38, 0x2e,
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x26, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72,
	0x73, 0x69, 0x6f, 0x6e, 0x41, 0x64, 0x6a, 0x75, 0x73, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x55, 0x70,
	0x6c, 0x6f, 0x61, 0x64, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f,
...
var (
	file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_rawDescData = file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_goTypes = []interface{}{
	(*UploadConversionAdjustmentsRequest)(nil),                       // 0: google.ads.googleads.v8.services.UploadConversionAdjustmentsRequest
	(*UploadConversionAdjustmentsResponse)(nil),                      // 1: google.ads.googleads.v8.services.UploadConversionAdjustmentsResponse
	(*ConversionAdjustment)(nil),                                     // 2: google.ads.googleads.v8.services.ConversionAdjustment
	(*RestatementValue)(nil),                                         // 3: google.ads.googleads.v8.services.RestatementValue
	(*GclidDateTimePair)(nil),                                        // 4: google.ads.googleads.v8.services.GclidDateTimePair
	(*ConversionAdjustmentResult)(nil),                               // 5: google.ads.googleads.v8.services.ConversionAdjustmentResult
	(*status.Status)(nil),                                            // 6: google.rpc.Status
	(enums.ConversionAdjustmentTypeEnum_ConversionAdjustmentType)(0), // 7: google.ads.googleads.v8.enums.ConversionAdjustmentTypeEnum.ConversionAdjustmentType
}
var file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v8.services.UploadConversionAdjustmentsRequest.conversion_adjustments:type_name -> google.ads.googleads.v8.services.ConversionAdjustment
	6, // 1: google.ads.googleads.v8.services.UploadConversionAdjustmentsResponse.partial_failure_error:type_name -> google.rpc.Status
	5, // 2: google.ads.googleads.v8.services.UploadConversionAdjustmentsResponse.results:type_name -> google.ads.googleads.v8.services.ConversionAdjustmentResult
	7, // 3: google.ads.googleads.v8.services.ConversionAdjustment.adjustment_type:type_name -> google.ads.googleads.v8.enums.ConversionAdjustmentTypeEnum.ConversionAdjustmentType
	3, // 4: google.ads.googleads.v8.services.ConversionAdjustment.restatement_value:type_name -> google.ads.googleads.v8.services.RestatementValue
	4, // 5: google.ads.googleads.v8.services.ConversionAdjustment.gclid_date_time_pair:type_name -> google.ads.googleads.v8.services.GclidDateTimePair
	7, // 6: google.ads.googleads.v8.services.ConversionAdjustmentResult.adjustment_type:type_name -> google.ads.googleads.v8.enums.ConversionAdjustmentTypeEnum.ConversionAdjustmentType
	4, // 7: google.ads.googleads.v8.services.ConversionAdjustmentResult.gclid_date_time_pair:type_name -> google.ads.googleads.v8.services.GclidDateTimePair
	0, // 8: google.ads.googleads.v8.services.ConversionAdjustmentUploadService.UploadConversionAdjustments:input_type -> google.ads.googleads.v8.services.UploadConversionAdjustmentsRequest
	1, // 9: google.ads.googleads.v8.services.ConversionAdjustmentUploadService.UploadConversionAdjustments:output_type -> google.ads.googleads.v8.services.UploadConversionAdjustmentsResponse
...
func init() { file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_init() }
func file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_init() {
	if File_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_msgTypes[2].OneofWrappers = []interface{}{
		(*ConversionAdjustment_GclidDateTimePair)(nil),
		(*ConversionAdjustment_OrderId)(nil),
	}
	file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_msgTypes[3].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_msgTypes[4].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_msgTypes[5].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto = out.File
	file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_conversion_adjustment_upload_service_proto_depIdxs = nil
}
...
func (c *conversionAdjustmentUploadServiceClient) UploadConversionAdjustments(ctx context.Context, in *UploadConversionAdjustmentsRequest, opts ...grpc.CallOption) (*UploadConversionAdjustmentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v8.services.ConversionAdjustmentUploadService/UploadConversionAdjustments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ConversionAdjustmentUploadService_UploadConversionAdjustments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v8.services.ConversionAdjustmentUploadService/UploadConversionAdjustments",
	}
