...
func (x *GetWebpageViewRequest) Reset() {
	*x = GetWebpageViewRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_webpage_view_service_proto_msgTypes[0]
...
func (*GetWebpageViewRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_webpage_view_service_proto_rawDescGZIP(), []int{0}
}
...
var file_google_ads_googleads_v8_services_webpage_view_service_proto_rawDesc = []byte{
	...
	0x38, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x57, 0x65, 0x62, 0x70,
	0x61, 0x67, 0x65, 0x56, 0x69, 0x65, 0x77, 0x22, 0x46, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x30, 0x12,
	0x2e, 0x2f, 0x76, 0x38, 0x2f, 0x7b, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x6e,
...
var (
	file_google_ads_googleads_v8_services_webpage_view_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_webpage_view_service_proto_rawDescData = file_google_ads_googleads_v8_services_webpage_view_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_webpage_view_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_webpage_view_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_webpage_view_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_webpage_view_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_webpage_view_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_webpage_view_service_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v8_services_webpage_view_service_proto_goTypes = []interface{}{
	(*GetWebpageViewRequest)(nil), // 0: google.ads.googleads.v8.services.GetWebpageViewRequest
	(*resources.WebpageView)(nil), // 1: google.ads.googleads.v8.resources.WebpageView
}
var file_google_ads_googleads_v8_services_webpage_view_service_proto_depIdxs = []int32{
	0, // 0: google.ads.googleads.v8.services.WebpageViewService.GetWebpageView:input_type -> google.ads.googleads.v8.services.GetWebpageViewRequest
	1, // 1: google.ads.googleads.v8.services.WebpageViewService.GetWebpageView:output_type -> google.ads.googleads.v8.resources.WebpageView
...
func init() { file_google_ads_googleads_v8_services_webpage_view_service_proto_init() }
func file_google_ads_googleads_v8_services_webpage_view_service_proto_init() {
	if File_google_ads_googleads_v8_services_webpage_view_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_webpage_view_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_webpage_view_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_webpage_view_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_webpage_view_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_webpage_view_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_webpage_view_service_proto = out.File
	file_google_ads_googleads_v8_services_webpage_view_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_webpage_view_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_webpage_view_service_proto_depIdxs = nil
}
...
// UnimplementedWebpageViewServiceServer can be embedded to have forward compatible implementations.
...
func RegisterWebpageViewServiceServer(s *grpc.Server, srv WebpageViewServiceServer) {
	s.RegisterService(&_WebpageViewService_serviceDesc, srv)
}
...
var _WebpageViewService_serviceDesc = grpc.ServiceDesc{
