...
func (x *GetSharedCriterionRequest) Reset() {
	*x = GetSharedCriterionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_shared_criterion_service_proto_msgTypes[0]
...
func (*GetSharedCriterionRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_shared_criterion_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateSharedCriteriaRequest) Reset() {
	*x = MutateSharedCriteriaRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_shared_criterion_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateSharedCriteriaRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_shared_criterion_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *SharedCriterionOperation) Reset() {
	*x = SharedCriterionOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_shared_criterion_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SharedCriterionOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_shared_criterion_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateSharedCriteriaResponse) Reset() {
	*x = MutateSharedCriteriaResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_shared_criterion_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateSharedCriteriaResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_shared_criterion_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateSharedCriterionResult) Reset() {
	*x = MutateSharedCriterionResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_shared_criterion_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateSharedCriterionResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_shared_criterion_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_shared_criterion_service_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x76, 0x38, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x53,
	...
	0x38, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x47, 0x65, 0x74, 0x53, 0x68,
	...
	0x12, 0x30, 0x2f, 0x76, 0x38, 0x2f, 0x7b, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f,
	...
	0x02, 0x38, 0x22, 0x33, 0x2f, 0x76, 0x38, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72,
...
var (
	file_google_ads_googleads_v8_services_shared_criterion_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_shared_criterion_service_proto_rawDescData = file_google_ads_googleads_v8_services_shared_criterion_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_shared_criterion_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_shared_criterion_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_shared_criterion_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_shared_criterion_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_shared_criterion_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_shared_criterion_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_shared_criterion_service_proto_goTypes = []interface{}{
	(*GetSharedCriterionRequest)(nil),                      // 0: google.ads.googleads.v8.services.GetSharedCriterionRequest
	(*MutateSharedCriteriaRequest)(nil),                    // 1: google.ads.googleads.v8.services.MutateSharedCriteriaRequest
	(*SharedCriterionOperation)(nil),                       // 2: google.ads.googleads.v8.services.SharedCriterionOperation
	(*MutateSharedCriteriaResponse)(nil),                   // 3: google.ads.googleads.v8.services.MutateSharedCriteriaResponse
	(*MutateSharedCriterionResult)(nil),                    // 4: google.ads.googleads.v8.services.MutateSharedCriterionResult
	...
	(*resources.SharedCriterion)(nil),                      // 6: google.ads.googleads.v8.resources.SharedCriterion
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v8_services_shared_criterion_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v8.services.MutateSharedCriteriaRequest.operations:type_name -> google.ads.googleads.v8.services.SharedCriterionOperation
	5, // 1: google.ads.googleads.v8.services.MutateSharedCriteriaRequest.response_content_type:type_name -> google.ads.googleads.v8.enums.ResponseContentTypeEnum.ResponseContentType
	6, // 2: google.ads.googleads.v8.services.SharedCriterionOperation.create:type_name -> google.ads.googleads.v8.resources.SharedCriterion
	7, // 3: google.ads.googleads.v8.services.MutateSharedCriteriaResponse.partial_failure_error:type_name -> google.rpc.Status
	4, // 4: google.ads.googleads.v8.services.MutateSharedCriteriaResponse.results:type_name -> google.ads.googleads.v8.services.MutateSharedCriterionResult
	6, // 5: google.ads.googleads.v8.services.MutateSharedCriterionResult.shared_criterion:type_name -> google.ads.googleads.v8.resources.SharedCriterion
	0, // 6: google.ads.googleads.v8.services.SharedCriterionService.GetSharedCriterion:input_type -> google.ads.googleads.v8.services.GetSharedCriterionRequest
	1, // 7: google.ads.googleads.v8.services.SharedCriterionService.MutateSharedCriteria:input_type -> google.ads.googleads.v8.services.MutateSharedCriteriaRequest
	6, // 8: google.ads.googleads.v8.services.SharedCriterionService.GetSharedCriterion:output_type -> google.ads.googleads.v8.resources.SharedCriterion
	3, // 9: google.ads.googleads.v8.services.SharedCriterionService.MutateSharedCriteria:output_type -> google.ads.googleads.v8.services.MutateSharedCriteriaResponse
...
func init() { file_google_ads_googleads_v8_services_shared_criterion_service_proto_init() }
func file_google_ads_googleads_v8_services_shared_criterion_service_proto_init() {
	if File_google_ads_googleads_v8_services_shared_criterion_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_shared_criterion_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_shared_criterion_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_shared_criterion_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_shared_criterion_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_shared_criterion_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_shared_criterion_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_shared_criterion_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_shared_criterion_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_shared_criterion_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_shared_criterion_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_shared_criterion_service_proto = out.File
	file_google_ads_googleads_v8_services_shared_criterion_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_shared_criterion_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_shared_criterion_service_proto_depIdxs = nil
}
