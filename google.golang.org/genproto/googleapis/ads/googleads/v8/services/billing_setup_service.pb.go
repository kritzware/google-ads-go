...
func (x *GetBillingSetupRequest) Reset() {
	*x = GetBillingSetupRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_billing_setup_service_proto_msgTypes[0]
...
func (*GetBillingSetupRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_billing_setup_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateBillingSetupRequest) Reset() {
	*x = MutateBillingSetupRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_billing_setup_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateBillingSetupRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_billing_setup_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *BillingSetupOperation) Reset() {
	*x = BillingSetupOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_billing_setup_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BillingSetupOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_billing_setup_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateBillingSetupResponse) Reset() {
	*x = MutateBillingSetupResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_billing_setup_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateBillingSetupResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_billing_setup_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateBillingSetupResult) Reset() {
	*x = MutateBillingSetupResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_billing_setup_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateBillingSetupResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_billing_setup_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_billing_setup_service_proto_rawDesc = []byte{
	...
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x31, 0x12, 0x2f, 0x2f, 0x76, 0x38, 0x2f, 0x7b, 0x72, 0x65, 0x73,
	...
	0x37, 0x22, 0x32, 0x2f, 0x76, 0x38, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73,
...
var (
	file_google_ads_googleads_v8_services_billing_setup_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_billing_setup_service_proto_rawDescData = file_google_ads_googleads_v8_services_billing_setup_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_billing_setup_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_billing_setup_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_billing_setup_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_billing_setup_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_billing_setup_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_billing_setup_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_billing_setup_service_proto_goTypes = []interface{}{
	(*GetBillingSetupRequest)(nil),     // 0: google.ads.googleads.v8.services.GetBillingSetupRequest
	(*MutateBillingSetupRequest)(nil),  // 1: google.ads.googleads.v8.services.MutateBillingSetupRequest
	(*BillingSetupOperation)(nil),      // 2: google.ads.googleads.v8.services.BillingSetupOperation
	(*MutateBillingSetupResponse)(nil), // 3: google.ads.googleads.v8.services.MutateBillingSetupResponse
	(*MutateBillingSetupResult)(nil),   // 4: google.ads.googleads.v8.services.MutateBillingSetupResult
	(*resources.BillingSetup)(nil),     // 5: google.ads.googleads.v8.resources.BillingSetup
}
var file_google_ads_googleads_v8_services_billing_setup_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v8.services.MutateBillingSetupRequest.operation:type_name -> google.ads.googleads.v8.services.BillingSetupOperation
	5, // 1: google.ads.googleads.v8.services.BillingSetupOperation.create:type_name -> google.ads.googleads.v8.resources.BillingSetup
	4, // 2: google.ads.googleads.v8.services.MutateBillingSetupResponse.result:type_name -> google.ads.googleads.v8.services.MutateBillingSetupResult
	0, // 3: google.ads.googleads.v8.services.BillingSetupService.GetBillingSetup:input_type -> google.ads.googleads.v8.services.GetBillingSetupRequest
	1, // 4: google.ads.googleads.v8.services.BillingSetupService.MutateBillingSetup:input_type -> google.ads.googleads.v8.services.MutateBillingSetupRequest
	5, // 5: google.ads.googleads.v8.services.BillingSetupService.GetBillingSetup:output_type -> google.ads.googleads.v8.resources.BillingSetup
	3, // 6: google.ads.googleads.v8.services.BillingSetupService.MutateBillingSetup:output_type -> google.ads.googleads.v8.services.MutateBillingSetupResponse
...
func init() { file_google_ads_googleads_v8_services_billing_setup_service_proto_init() }
func file_google_ads_googleads_v8_services_billing_setup_service_proto_init() {
	if File_google_ads_googleads_v8_services_billing_setup_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_billing_setup_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_billing_setup_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_billing_setup_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_billing_setup_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_billing_setup_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_billing_setup_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_billing_setup_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_billing_setup_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_billing_setup_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_billing_setup_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_billing_setup_service_proto = out.File
	file_google_ads_googleads_v8_services_billing_setup_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_billing_setup_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_billing_setup_service_proto_depIdxs = nil
}
...
func (c *billingSetupServiceClient) GetBillingSetup(ctx context.Context, in *GetBillingSetupRequest, opts ...grpc.CallOption) (*resources.BillingSetup, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v8.services.BillingSetupService/GetBillingSetup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *billingSetupServiceClient) MutateBillingSetup(ctx context.Context, in *MutateBillingSetupRequest, opts ...grpc.CallOption) (*MutateBillingSetupResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v8.services.BillingSetupService/MutateBillingSetup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BillingSetupService_GetBillingSetup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v8.services.BillingSetupService/GetBillingSetup",
	}
...
func _BillingSetupService_MutateBillingSetup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v8.services.BillingSetupService/MutateBillingSetup",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
