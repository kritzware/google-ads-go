...
func (x *GetFeedMappingRequest) Reset() {
	*x = GetFeedMappingRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_feed_mapping_service_proto_msgTypes[0]
...
func (*GetFeedMappingRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_feed_mapping_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateFeedMappingsRequest) Reset() {
	*x = MutateFeedMappingsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_feed_mapping_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedMappingsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_feed_mapping_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *FeedMappingOperation) Reset() {
	*x = FeedMappingOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_feed_mapping_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FeedMappingOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_feed_mapping_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateFeedMappingsResponse) Reset() {
	*x = MutateFeedMappingsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_feed_mapping_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedMappingsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_feed_mapping_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateFeedMappingResult) Reset() {
	*x = MutateFeedMappingResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_feed_mapping_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedMappingResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_feed_mapping_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_feed_mapping_service_proto_rawDesc = []byte{
	...
	0x2f, 0x76, 0x38, 0x2f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2f, 0x66, 0x65,
	...
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x36, 0x22, 0x31, 0x2f, 0x76, 0x38, 0x2f, 0x63, 0x75, 0x73, 0x74,
...
var (
	file_google_ads_googleads_v8_services_feed_mapping_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_feed_mapping_service_proto_rawDescData = file_google_ads_googleads_v8_services_feed_mapping_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_feed_mapping_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_feed_mapping_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_feed_mapping_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_feed_mapping_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_feed_mapping_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_feed_mapping_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_feed_mapping_service_proto_goTypes = []interface{}{
	(*GetFeedMappingRequest)(nil),                          // 0: google.ads.googleads.v8.services.GetFeedMappingRequest
	(*MutateFeedMappingsRequest)(nil),                      // 1: google.ads.googleads.v8.services.MutateFeedMappingsRequest
	(*FeedMappingOperation)(nil),                           // 2: google.ads.googleads.v8.services.FeedMappingOperation
	(*MutateFeedMappingsResponse)(nil),                     // 3: google.ads.googleads.v8.services.MutateFeedMappingsResponse
	(*MutateFeedMappingResult)(nil),                        // 4: google.ads.googleads.v8.services.MutateFeedMappingResult
	...
	(*resources.FeedMapping)(nil),                          // 6: google.ads.googleads.v8.resources.FeedMapping
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v8_services_feed_mapping_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v8.services.MutateFeedMappingsRequest.operations:type_name -> google.ads.googleads.v8.services.FeedMappingOperation
	5, // 1: google.ads.googleads.v8.services.MutateFeedMappingsRequest.response_content_type:type_name -> google.ads.googleads.v8.enums.ResponseContentTypeEnum.ResponseContentType
	6, // 2: google.ads.googleads.v8.services.FeedMappingOperation.create:type_name -> google.ads.googleads.v8.resources.FeedMapping
	7, // 3: google.ads.googleads.v8.services.MutateFeedMappingsResponse.partial_failure_error:type_name -> google.rpc.Status
	4, // 4: google.ads.googleads.v8.services.MutateFeedMappingsResponse.results:type_name -> google.ads.googleads.v8.services.MutateFeedMappingResult
	6, // 5: google.ads.googleads.v8.services.MutateFeedMappingResult.feed_mapping:type_name -> google.ads.googleads.v8.resources.FeedMapping
	0, // 6: google.ads.googleads.v8.services.FeedMappingService.GetFeedMapping:input_type -> google.ads.googleads.v8.services.GetFeedMappingRequest
	1, // 7: google.ads.googleads.v8.services.FeedMappingService.MutateFeedMappings:input_type -> google.ads.googleads.v8.services.MutateFeedMappingsRequest
	6, // 8: google.ads.googleads.v8.services.FeedMappingService.GetFeedMapping:output_type -> google.ads.googleads.v8.resources.FeedMapping
	3, // 9: google.ads.googleads.v8.services.FeedMappingService.MutateFeedMappings:output_type -> google.ads.googleads.v8.services.MutateFeedMappingsResponse
...
func init() { file_google_ads_googleads_v8_services_feed_mapping_service_proto_init() }
func file_google_ads_googleads_v8_services_feed_mapping_service_proto_init() {
	if File_google_ads_googleads_v8_services_feed_mapping_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_feed_mapping_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_feed_mapping_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_feed_mapping_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_feed_mapping_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_feed_mapping_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_feed_mapping_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_feed_mapping_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_feed_mapping_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_feed_mapping_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_feed_mapping_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_feed_mapping_service_proto = out.File
	file_google_ads_googleads_v8_services_feed_mapping_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_feed_mapping_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_feed_mapping_service_proto_depIdxs = nil
}
...
func (c *feedMappingServiceClient) GetFeedMapping(ctx context.Context, in *GetFeedMappingRequest, opts ...grpc.CallOption) (*resources.FeedMapping, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v8.services.FeedMappingService/GetFeedMapping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *feedMappingServiceClient) MutateFeedMappings(ctx context.Context, in *MutateFeedMappingsRequest, opts ...grpc.CallOption) (*MutateFeedMappingsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v8.services.FeedMappingService/MutateFeedMappings", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _FeedMappingService_GetFeedMapping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v8.services.FeedMappingService/GetFeedMapping",
	}
...
func _FeedMappingService_MutateFeedMappings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v8.services.FeedMappingService/MutateFeedMappings",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
