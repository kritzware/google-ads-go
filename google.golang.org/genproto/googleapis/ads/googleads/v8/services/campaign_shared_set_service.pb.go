...
func (x *GetCampaignSharedSetRequest) Reset() {
	*x = GetCampaignSharedSetRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_msgTypes[0]
...
func (*GetCampaignSharedSetRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateCampaignSharedSetsRequest) Reset() {
	*x = MutateCampaignSharedSetsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignSharedSetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *CampaignSharedSetOperation) Reset() {
	*x = CampaignSharedSetOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CampaignSharedSetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCampaignSharedSetsResponse) Reset() {
	*x = MutateCampaignSharedSetsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignSharedSetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateCampaignSharedSetResult) Reset() {
	*x = MutateCampaignSharedSetResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignSharedSetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_rawDesc = []byte{
	...
	0x53, 0x65, 0x74, 0x22, 0x4c, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x36, 0x12, 0x34, 0x2f, 0x76, 0x38,
...
var (
	file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_rawDescData = file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_goTypes = []interface{}{
	(*GetCampaignSharedSetRequest)(nil),                    // 0: google.ads.googleads.v8.services.GetCampaignSharedSetRequest
	(*MutateCampaignSharedSetsRequest)(nil),                // 1: google.ads.googleads.v8.services.MutateCampaignSharedSetsRequest
	(*CampaignSharedSetOperation)(nil),                     // 2: google.ads.googleads.v8.services.CampaignSharedSetOperation
	(*MutateCampaignSharedSetsResponse)(nil),               // 3: google.ads.googleads.v8.services.MutateCampaignSharedSetsResponse
	(*MutateCampaignSharedSetResult)(nil),                  // 4: google.ads.googleads.v8.services.MutateCampaignSharedSetResult
	...
	(*resources.CampaignSharedSet)(nil),                    // 6: google.ads.googleads.v8.resources.CampaignSharedSet
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v8.services.MutateCampaignSharedSetsRequest.operations:type_name -> google.ads.googleads.v8.services.CampaignSharedSetOperation
	5, // 1: google.ads.googleads.v8.services.MutateCampaignSharedSetsRequest.response_content_type:type_name -> google.ads.googleads.v8.enums.ResponseContentTypeEnum.ResponseContentType
	6, // 2: google.ads.googleads.v8.services.CampaignSharedSetOperation.create:type_name -> google.ads.googleads.v8.resources.CampaignSharedSet
	7, // 3: google.ads.googleads.v8.services.MutateCampaignSharedSetsResponse.partial_failure_error:type_name -> google.rpc.Status
	4, // 4: google.ads.googleads.v8.services.MutateCampaignSharedSetsResponse.results:type_name -> google.ads.googleads.v8.services.MutateCampaignSharedSetResult
	6, // 5: google.ads.googleads.v8.services.MutateCampaignSharedSetResult.campaign_shared_set:type_name -> google.ads.googleads.v8.resources.CampaignSharedSet
	0, // 6: google.ads.googleads.v8.services.CampaignSharedSetService.GetCampaignSharedSet:input_type -> google.ads.googleads.v8.services.GetCampaignSharedSetRequest
	1, // 7: google.ads.googleads.v8.services.CampaignSharedSetService.MutateCampaignSharedSets:input_type -> google.ads.googleads.v8.services.MutateCampaignSharedSetsRequest
	6, // 8: google.ads.googleads.v8.services.CampaignSharedSetService.GetCampaignSharedSet:output_type -> google.ads.googleads.v8.resources.CampaignSharedSet
	3, // 9: google.ads.googleads.v8.services.CampaignSharedSetService.MutateCampaignSharedSets:output_type -> google.ads.googleads.v8.services.MutateCampaignSharedSetsResponse
...
func init() { file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_init() }
func file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_init() {
	if File_google_ads_googleads_v8_services_campaign_shared_set_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_campaign_shared_set_service_proto = out.File
	file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_campaign_shared_set_service_proto_depIdxs = nil
}
