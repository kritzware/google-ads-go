...
func (x *GetFeedItemTargetRequest) Reset() {
	*x = GetFeedItemTargetRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_feed_item_target_service_proto_msgTypes[0]
...
func (*GetFeedItemTargetRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_feed_item_target_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateFeedItemTargetsRequest) Reset() {
	*x = MutateFeedItemTargetsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_feed_item_target_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedItemTargetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_feed_item_target_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *FeedItemTargetOperation) Reset() {
	*x = FeedItemTargetOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_feed_item_target_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FeedItemTargetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_feed_item_target_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateFeedItemTargetsResponse) Reset() {
	*x = MutateFeedItemTargetsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_feed_item_target_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedItemTargetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_feed_item_target_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateFeedItemTargetResult) Reset() {
	*x = MutateFeedItemTargetResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_feed_item_target_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedItemTargetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_feed_item_target_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_feed_item_target_service_proto_rawDesc = []byte{
	...
	0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64,
	0x73, 0x2e, 0x76, 0x38, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x1a, 0x46,
...
var (
	file_google_ads_googleads_v8_services_feed_item_target_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_feed_item_target_service_proto_rawDescData = file_google_ads_googleads_v8_services_feed_item_target_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_feed_item_target_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_feed_item_target_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_feed_item_target_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_feed_item_target_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_feed_item_target_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_feed_item_target_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_feed_item_target_service_proto_goTypes = []interface{}{
	(*GetFeedItemTargetRequest)(nil),                       // 0: google.ads.googleads.v8.services.GetFeedItemTargetRequest
	(*MutateFeedItemTargetsRequest)(nil),                   // 1: google.ads.googleads.v8.services.MutateFeedItemTargetsRequest
	(*FeedItemTargetOperation)(nil),                        // 2: google.ads.googleads.v8.services.FeedItemTargetOperation
	(*MutateFeedItemTargetsResponse)(nil),                  // 3: google.ads.googleads.v8.services.MutateFeedItemTargetsResponse
	(*MutateFeedItemTargetResult)(nil),                     // 4: google.ads.googleads.v8.services.MutateFeedItemTargetResult
	...
	(*resources.FeedItemTarget)(nil),                       // 6: google.ads.googleads.v8.resources.FeedItemTarget
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v8_services_feed_item_target_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v8.services.MutateFeedItemTargetsRequest.operations:type_name -> google.ads.googleads.v8.services.FeedItemTargetOperation
	5, // 1: google.ads.googleads.v8.services.MutateFeedItemTargetsRequest.response_content_type:type_name -> google.ads.googleads.v8.enums.ResponseContentTypeEnum.ResponseContentType
	6, // 2: google.ads.googleads.v8.services.FeedItemTargetOperation.create:type_name -> google.ads.googleads.v8.resources.FeedItemTarget
	7, // 3: google.ads.googleads.v8.services.MutateFeedItemTargetsResponse.partial_failure_error:type_name -> google.rpc.Status
	4, // 4: google.ads.googleads.v8.services.MutateFeedItemTargetsResponse.results:type_name -> google.ads.googleads.v8.services.MutateFeedItemTargetResult
	6, // 5: google.ads.googleads.v8.services.MutateFeedItemTargetResult.feed_item_target:type_name -> google.ads.googleads.v8.resources.FeedItemTarget
	0, // 6: google.ads.googleads.v8.services.FeedItemTargetService.GetFeedItemTarget:input_type -> google.ads.googleads.v8.services.GetFeedItemTargetRequest
	1, // 7: google.ads.googleads.v8.services.FeedItemTargetService.MutateFeedItemTargets:input_type -> google.ads.googleads.v8.services.MutateFeedItemTargetsRequest
	6, // 8: google.ads.googleads.v8.services.FeedItemTargetService.GetFeedItemTarget:output_type -> google.ads.googleads.v8.resources.FeedItemTarget
	3, // 9: google.ads.googleads.v8.services.FeedItemTargetService.MutateFeedItemTargets:output_type -> google.ads.googleads.v8.services.MutateFeedItemTargetsResponse
...
func init() { file_google_ads_googleads_v8_services_feed_item_target_service_proto_init() }
func file_google_ads_googleads_v8_services_feed_item_target_service_proto_init() {
	if File_google_ads_googleads_v8_services_feed_item_target_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_feed_item_target_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_feed_item_target_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_feed_item_target_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_feed_item_target_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_feed_item_target_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_feed_item_target_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_feed_item_target_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_feed_item_target_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_feed_item_target_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_feed_item_target_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_feed_item_target_service_proto = out.File
	file_google_ads_googleads_v8_services_feed_item_target_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_feed_item_target_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_feed_item_target_service_proto_depIdxs = nil
}
...
func (c *feedItemTargetServiceClient) GetFeedItemTarget(ctx context.Context, in *GetFeedItemTargetRequest, opts ...grpc.CallOption) (*resources.FeedItemTarget, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v8.services.FeedItemTargetService/GetFeedItemTarget", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *feedItemTargetServiceClient) MutateFeedItemTargets(ctx context.Context, in *MutateFeedItemTargetsRequest, opts ...grpc.CallOption) (*MutateFeedItemTargetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v8.services.FeedItemTargetService/MutateFeedItemTargets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedFeedItemTargetServiceServer) GetFeedItemTarget(context.Context, *GetFeedItemTargetRequest) (*resources.FeedItemTarget, error) {
	return nil, status1.Errorf(codes.Unimplemented, "method GetFeedItemTarget not implemented")
}
func (*UnimplementedFeedItemTargetServiceServer) MutateFeedItemTargets(context.Context, *MutateFeedItemTargetsRequest) (*MutateFeedItemTargetsResponse, error) {
	return nil, status1.Errorf(codes.Unimplemented, "method MutateFeedItemTargets not implemented")
}
...
func _FeedItemTargetService_GetFeedItemTarget_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v8.services.FeedItemTargetService/GetFeedItemTarget",
	}
...
func _FeedItemTargetService_MutateFeedItemTargets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v8.services.FeedItemTargetService/MutateFeedItemTargets",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
