...
func (x *GetFeedItemRequest) Reset() {
	*x = GetFeedItemRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_feed_item_service_proto_msgTypes[0]
...
func (*GetFeedItemRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_feed_item_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateFeedItemsRequest) Reset() {
	*x = MutateFeedItemsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_feed_item_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedItemsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_feed_item_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *FeedItemOperation) Reset() {
	*x = FeedItemOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_feed_item_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FeedItemOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_feed_item_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateFeedItemsResponse) Reset() {
	*x = MutateFeedItemsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_feed_item_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedItemsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_feed_item_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateFeedItemResult) Reset() {
	*x = MutateFeedItemResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_feed_item_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedItemResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_feed_item_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_feed_item_service_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x22, 0x52, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x33, 0x22, 0x2e, 0x2f, 0x76, 0x38, 0x2f,
...
var (
	file_google_ads_googleads_v8_services_feed_item_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_feed_item_service_proto_rawDescData = file_google_ads_googleads_v8_services_feed_item_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_feed_item_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_feed_item_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_feed_item_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_feed_item_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_feed_item_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_feed_item_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_feed_item_service_proto_goTypes = []interface{}{
	(*GetFeedItemRequest)(nil),                             // 0: google.ads.googleads.v8.services.GetFeedItemRequest
	(*MutateFeedItemsRequest)(nil),                         // 1: google.ads.googleads.v8.services.MutateFeedItemsRequest
	(*FeedItemOperation)(nil),                              // 2: google.ads.googleads.v8.services.FeedItemOperation
	(*MutateFeedItemsResponse)(nil),                        // 3: google.ads.googleads.v8.services.MutateFeedItemsResponse
	(*MutateFeedItemResult)(nil),                           // 4: google.ads.googleads.v8.services.MutateFeedItemResult
	...
	(*resources.FeedItem)(nil),                             // 7: google.ads.googleads.v8.resources.FeedItem
	(*status.Status)(nil),                                  // 8: google.rpc.Status
}
var file_google_ads_googleads_v8_services_feed_item_service_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v8.services.MutateFeedItemsRequest.operations:type_name -> google.ads.googleads.v8.services.FeedItemOperation
	5,  // 1: google.ads.googleads.v8.services.MutateFeedItemsRequest.response_content_type:type_name -> google.ads.googleads.v8.enums.ResponseContentTypeEnum.ResponseContentType
	6,  // 2: google.ads.googleads.v8.services.FeedItemOperation.update_mask:type_name -> google.protobuf.FieldMask
	7,  // 3: google.ads.googleads.v8.services.FeedItemOperation.create:type_name -> google.ads.googleads.v8.resources.FeedItem
	7,  // 4: google.ads.googleads.v8.services.FeedItemOperation.update:type_name -> google.ads.googleads.v8.resources.FeedItem
	8,  // 5: google.ads.googleads.v8.services.MutateFeedItemsResponse.partial_failure_error:type_name -> google.rpc.Status
	4,  // 6: google.ads.googleads.v8.services.MutateFeedItemsResponse.results:type_name -> google.ads.googleads.v8.services.MutateFeedItemResult
	7,  // 7: google.ads.googleads.v8.services.MutateFeedItemResult.feed_item:type_name -> google.ads.googleads.v8.resources.FeedItem
	0,  // 8: google.ads.googleads.v8.services.FeedItemService.GetFeedItem:input_type -> google.ads.googleads.v8.services.GetFeedItemRequest
	1,  // 9: google.ads.googleads.v8.services.FeedItemService.MutateFeedItems:input_type -> google.ads.googleads.v8.services.MutateFeedItemsRequest
	7,  // 10: google.ads.googleads.v8.services.FeedItemService.GetFeedItem:output_type -> google.ads.googleads.v8.resources.FeedItem
	3,  // 11: google.ads.googleads.v8.services.FeedItemService.MutateFeedItems:output_type -> google.ads.googleads.v8.services.MutateFeedItemsResponse
...
func init() { file_google_ads_googleads_v8_services_feed_item_service_proto_init() }
func file_google_ads_googleads_v8_services_feed_item_service_proto_init() {
	if File_google_ads_googleads_v8_services_feed_item_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_feed_item_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_feed_item_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_feed_item_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_feed_item_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_feed_item_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_feed_item_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_feed_item_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_feed_item_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_feed_item_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_feed_item_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_feed_item_service_proto = out.File
	file_google_ads_googleads_v8_services_feed_item_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_feed_item_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_feed_item_service_proto_depIdxs = nil
}
