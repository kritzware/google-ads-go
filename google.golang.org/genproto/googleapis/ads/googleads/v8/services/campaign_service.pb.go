...
func (x *GetCampaignRequest) Reset() {
	*x = GetCampaignRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_service_proto_msgTypes[0]
...
func (*GetCampaignRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateCampaignsRequest) Reset() {
	*x = MutateCampaignsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *CampaignOperation) Reset() {
	*x = CampaignOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CampaignOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCampaignsResponse) Reset() {
	*x = MutateCampaignsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateCampaignResult) Reset() {
	*x = MutateCampaignResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_campaign_service_proto_rawDesc = []byte{
	...
	0x6e, 0x22, 0x43, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x2d, 0x12, 0x2b, 0x2f, 0x76, 0x38, 0x2f, 0x7b,
	...
	0x52, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x33, 0x22, 0x2e, 0x2f, 0x76, 0x38, 0x2f, 0x63, 0x75, 0x73,
...
var (
	file_google_ads_googleads_v8_services_campaign_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_campaign_service_proto_rawDescData = file_google_ads_googleads_v8_services_campaign_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_campaign_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_campaign_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_campaign_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_campaign_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_campaign_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_campaign_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_campaign_service_proto_goTypes = []interface{}{
	(*GetCampaignRequest)(nil),                             // 0: google.ads.googleads.v8.services.GetCampaignRequest
	(*MutateCampaignsRequest)(nil),                         // 1: google.ads.googleads.v8.services.MutateCampaignsRequest
	(*CampaignOperation)(nil),                              // 2: google.ads.googleads.v8.services.CampaignOperation
	(*MutateCampaignsResponse)(nil),                        // 3: google.ads.googleads.v8.services.MutateCampaignsResponse
	(*MutateCampaignResult)(nil),                           // 4: google.ads.googleads.v8.services.MutateCampaignResult
	...
	(*resources.Campaign)(nil),                             // 7: google.ads.googleads.v8.resources.Campaign
	(*status.Status)(nil),                                  // 8: google.rpc.Status
}
var file_google_ads_googleads_v8_services_campaign_service_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v8.services.MutateCampaignsRequest.operations:type_name -> google.ads.googleads.v8.services.CampaignOperation
	5,  // 1: google.ads.googleads.v8.services.MutateCampaignsRequest.response_content_type:type_name -> google.ads.googleads.v8.enums.ResponseContentTypeEnum.ResponseContentType
	6,  // 2: google.ads.googleads.v8.services.CampaignOperation.update_mask:type_name -> google.protobuf.FieldMask
	7,  // 3: google.ads.googleads.v8.services.CampaignOperation.create:type_name -> google.ads.googleads.v8.resources.Campaign
	7,  // 4: google.ads.googleads.v8.services.CampaignOperation.update:type_name -> google.ads.googleads.v8.resources.Campaign
	8,  // 5: google.ads.googleads.v8.services.MutateCampaignsResponse.partial_failure_error:type_name -> google.rpc.Status
	4,  // 6: google.ads.googleads.v8.services.MutateCampaignsResponse.results:type_name -> google.ads.googleads.v8.services.MutateCampaignResult
	7,  // 7: google.ads.googleads.v8.services.MutateCampaignResult.campaign:type_name -> google.ads.googleads.v8.resources.Campaign
	0,  // 8: google.ads.googleads.v8.services.CampaignService.GetCampaign:input_type -> google.ads.googleads.v8.services.GetCampaignRequest
	1,  // 9: google.ads.googleads.v8.services.CampaignService.MutateCampaigns:input_type -> google.ads.googleads.v8.services.MutateCampaignsRequest
	7,  // 10: google.ads.googleads.v8.services.CampaignService.GetCampaign:output_type -> google.ads.googleads.v8.resources.Campaign
	3,  // 11: google.ads.googleads.v8.services.CampaignService.MutateCampaigns:output_type -> google.ads.googleads.v8.services.MutateCampaignsResponse
...
func init() { file_google_ads_googleads_v8_services_campaign_service_proto_init() }
func file_google_ads_googleads_v8_services_campaign_service_proto_init() {
	if File_google_ads_googleads_v8_services_campaign_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_campaign_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_campaign_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_campaign_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_campaign_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_campaign_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_campaign_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_campaign_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_campaign_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_campaign_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_campaign_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_campaign_service_proto = out.File
	file_google_ads_googleads_v8_services_campaign_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_campaign_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_campaign_service_proto_depIdxs = nil
}
...
func (c *campaignServiceClient) GetCampaign(ctx context.Context, in *GetCampaignRequest, opts ...grpc.CallOption) (*resources.Campaign, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v8.services.CampaignService/GetCampaign", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *campaignServiceClient) MutateCampaigns(ctx context.Context, in *MutateCampaignsRequest, opts ...grpc.CallOption) (*MutateCampaignsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v8.services.CampaignService/MutateCampaigns", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CampaignService_GetCampaign_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v8.services.CampaignService/GetCampaign",
	}
...
func _CampaignService_MutateCampaigns_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v8.services.CampaignService/MutateCampaigns",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
