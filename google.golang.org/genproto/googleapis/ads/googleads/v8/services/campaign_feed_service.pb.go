...
func (x *GetCampaignFeedRequest) Reset() {
	*x = GetCampaignFeedRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_feed_service_proto_msgTypes[0]
...
func (*GetCampaignFeedRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_feed_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateCampaignFeedsRequest) Reset() {
	*x = MutateCampaignFeedsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_feed_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignFeedsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_feed_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *CampaignFeedOperation) Reset() {
	*x = CampaignFeedOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_feed_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CampaignFeedOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_feed_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCampaignFeedsResponse) Reset() {
	*x = MutateCampaignFeedsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_feed_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignFeedsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_feed_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateCampaignFeedResult) Reset() {
	*x = MutateCampaignFeedResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_campaign_feed_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignFeedResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_campaign_feed_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_campaign_feed_service_proto_rawDesc = []byte{
	...
	0x22, 0x47, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x31, 0x12, 0x2f, 0x2f, 0x76, 0x38, 0x2f, 0x7b, 0x72,
	...
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x37, 0x22, 0x32, 0x2f, 0x76, 0x38, 0x2f, 0x63, 0x75, 0x73, 0x74,
...
var (
	file_google_ads_googleads_v8_services_campaign_feed_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_campaign_feed_service_proto_rawDescData = file_google_ads_googleads_v8_services_campaign_feed_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_campaign_feed_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_campaign_feed_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_campaign_feed_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_campaign_feed_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_campaign_feed_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_campaign_feed_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_campaign_feed_service_proto_goTypes = []interface{}{
	(*GetCampaignFeedRequest)(nil),                         // 0: google.ads.googleads.v8.services.GetCampaignFeedRequest
	(*MutateCampaignFeedsRequest)(nil),                     // 1: google.ads.googleads.v8.services.MutateCampaignFeedsRequest
	(*CampaignFeedOperation)(nil),                          // 2: google.ads.googleads.v8.services.CampaignFeedOperation
	(*MutateCampaignFeedsResponse)(nil),                    // 3: google.ads.googleads.v8.services.MutateCampaignFeedsResponse
	(*MutateCampaignFeedResult)(nil),                       // 4: google.ads.googleads.v8.services.MutateCampaignFeedResult
	...
	(*resources.CampaignFeed)(nil),                         // 7: google.ads.googleads.v8.resources.CampaignFeed
	(*status.Status)(nil),                                  // 8: google.rpc.Status
}
var file_google_ads_googleads_v8_services_campaign_feed_service_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v8.services.MutateCampaignFeedsRequest.operations:type_name -> google.ads.googleads.v8.services.CampaignFeedOperation
	5,  // 1: google.ads.googleads.v8.services.MutateCampaignFeedsRequest.response_content_type:type_name -> google.ads.googleads.v8.enums.ResponseContentTypeEnum.ResponseContentType
	6,  // 2: google.ads.googleads.v8.services.CampaignFeedOperation.update_mask:type_name -> google.protobuf.FieldMask
	7,  // 3: google.ads.googleads.v8.services.CampaignFeedOperation.create:type_name -> google.ads.googleads.v8.resources.CampaignFeed
	7,  // 4: google.ads.googleads.v8.services.CampaignFeedOperation.update:type_name -> google.ads.googleads.v8.resources.CampaignFeed
	8,  // 5: google.ads.googleads.v8.services.MutateCampaignFeedsResponse.partial_failure_error:type_name -> google.rpc.Status
	4,  // 6: google.ads.googleads.v8.services.MutateCampaignFeedsResponse.results:type_name -> google.ads.googleads.v8.services.MutateCampaignFeedResult
	7,  // 7: google.ads.googleads.v8.services.MutateCampaignFeedResult.campaign_feed:type_name -> google.ads.googleads.v8.resources.CampaignFeed
	0,  // 8: google.ads.googleads.v8.services.CampaignFeedService.GetCampaignFeed:input_type -> google.ads.googleads.v8.services.GetCampaignFeedRequest
	1,  // 9: google.ads.googleads.v8.services.CampaignFeedService.MutateCampaignFeeds:input_type -> google.ads.googleads.v8.services.MutateCampaignFeedsRequest
	7,  // 10: google.ads.googleads.v8.services.CampaignFeedService.GetCampaignFeed:output_type -> google.ads.googleads.v8.resources.CampaignFeed
	3,  // 11: google.ads.googleads.v8.services.CampaignFeedService.MutateCampaignFeeds:output_type -> google.ads.googleads.v8.services.MutateCampaignFeedsResponse
...
func init() { file_google_ads_googleads_v8_services_campaign_feed_service_proto_init() }
func file_google_ads_googleads_v8_services_campaign_feed_service_proto_init() {
	if File_google_ads_googleads_v8_services_campaign_feed_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_campaign_feed_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_campaign_feed_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_campaign_feed_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_campaign_feed_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_campaign_feed_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_campaign_feed_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_campaign_feed_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_campaign_feed_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_campaign_feed_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_campaign_feed_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_campaign_feed_service_proto = out.File
	file_google_ads_googleads_v8_services_campaign_feed_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_campaign_feed_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_campaign_feed_service_proto_depIdxs = nil
}
