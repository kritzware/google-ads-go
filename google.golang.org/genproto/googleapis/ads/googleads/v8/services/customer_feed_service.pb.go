...
func (x *GetCustomerFeedRequest) Reset() {
	*x = GetCustomerFeedRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_customer_feed_service_proto_msgTypes[0]
...
func (*GetCustomerFeedRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_customer_feed_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateCustomerFeedsRequest) Reset() {
	*x = MutateCustomerFeedsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_customer_feed_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerFeedsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_customer_feed_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *CustomerFeedOperation) Reset() {
	*x = CustomerFeedOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_customer_feed_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CustomerFeedOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_customer_feed_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomerFeedsResponse) Reset() {
	*x = MutateCustomerFeedsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_customer_feed_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerFeedsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_customer_feed_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateCustomerFeedResult) Reset() {
	*x = MutateCustomerFeedResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_customer_feed_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerFeedResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_customer_feed_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_customer_feed_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v8_services_customer_feed_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_customer_feed_service_proto_rawDescData = file_google_ads_googleads_v8_services_customer_feed_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_customer_feed_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_customer_feed_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_customer_feed_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_customer_feed_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_customer_feed_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_customer_feed_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_customer_feed_service_proto_goTypes = []interface{}{
	(*GetCustomerFeedRequest)(nil),                         // 0: google.ads.googleads.v8.services.GetCustomerFeedRequest
	(*MutateCustomerFeedsRequest)(nil),                     // 1: google.ads.googleads.v8.services.MutateCustomerFeedsRequest
	(*CustomerFeedOperation)(nil),                          // 2: google.ads.googleads.v8.services.CustomerFeedOperation
	(*MutateCustomerFeedsResponse)(nil),                    // 3: google.ads.googleads.v8.services.MutateCustomerFeedsResponse
	(*MutateCustomerFeedResult)(nil),                       // 4: google.ads.googleads.v8.services.MutateCustomerFeedResult
	...
	(*resources.CustomerFeed)(nil),                         // 7: google.ads.googleads.v8.resources.CustomerFeed
	(*status.Status)(nil),                                  // 8: google.rpc.Status
}
var file_google_ads_googleads_v8_services_customer_feed_service_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v8.services.MutateCustomerFeedsRequest.operations:type_name -> google.ads.googleads.v8.services.CustomerFeedOperation
	5,  // 1: google.ads.googleads.v8.services.MutateCustomerFeedsRequest.response_content_type:type_name -> google.ads.googleads.v8.enums.ResponseContentTypeEnum.ResponseContentType
	6,  // 2: google.ads.googleads.v8.services.CustomerFeedOperation.update_mask:type_name -> google.protobuf.FieldMask
	7,  // 3: google.ads.googleads.v8.services.CustomerFeedOperation.create:type_name -> google.ads.googleads.v8.resources.CustomerFeed
	7,  // 4: google.ads.googleads.v8.services.CustomerFeedOperation.update:type_name -> google.ads.googleads.v8.resources.CustomerFeed
	8,  // 5: google.ads.googleads.v8.services.MutateCustomerFeedsResponse.partial_failure_error:type_name -> google.rpc.Status
	4,  // 6: google.ads.googleads.v8.services.MutateCustomerFeedsResponse.results:type_name -> google.ads.googleads.v8.services.MutateCustomerFeedResult
	7,  // 7: google.ads.googleads.v8.services.MutateCustomerFeedResult.customer_feed:type_name -> google.ads.googleads.v8.resources.CustomerFeed
	0,  // 8: google.ads.googleads.v8.services.CustomerFeedService.GetCustomerFeed:input_type -> google.ads.googleads.v8.services.GetCustomerFeedRequest
	1,  // 9: google.ads.googleads.v8.services.CustomerFeedService.MutateCustomerFeeds:input_type -> google.ads.googleads.v8.services.MutateCustomerFeedsRequest
	7,  // 10: google.ads.googleads.v8.services.CustomerFeedService.GetCustomerFeed:output_type -> google.ads.googleads.v8.resources.CustomerFeed
	3,  // 11: google.ads.googleads.v8.services.CustomerFeedService.MutateCustomerFeeds:output_type -> google.ads.googleads.v8.services.MutateCustomerFeedsResponse
...
func init() { file_google_ads_googleads_v8_services_customer_feed_service_proto_init() }
func file_google_ads_googleads_v8_services_customer_feed_service_proto_init() {
	if File_google_ads_googleads_v8_services_customer_feed_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_customer_feed_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_customer_feed_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_customer_feed_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_customer_feed_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_customer_feed_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_customer_feed_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_customer_feed_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_customer_feed_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_customer_feed_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_customer_feed_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_customer_feed_service_proto = out.File
	file_google_ads_googleads_v8_services_customer_feed_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_customer_feed_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_customer_feed_service_proto_depIdxs = nil
}
