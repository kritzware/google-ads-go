...
func (x *GetAdGroupFeedRequest) Reset() {
	*x = GetAdGroupFeedRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_group_feed_service_proto_msgTypes[0]
...
func (*GetAdGroupFeedRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_group_feed_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateAdGroupFeedsRequest) Reset() {
	*x = MutateAdGroupFeedsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_group_feed_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupFeedsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_group_feed_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *AdGroupFeedOperation) Reset() {
	*x = AdGroupFeedOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_group_feed_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdGroupFeedOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_group_feed_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdGroupFeedsResponse) Reset() {
	*x = MutateAdGroupFeedsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_group_feed_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupFeedsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_group_feed_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateAdGroupFeedResult) Reset() {
	*x = MutateAdGroupFeedResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_ad_group_feed_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupFeedResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_ad_group_feed_service_proto_rawDescGZIP(), []int{4}
}
...
var file_google_ads_googleads_v8_services_ad_group_feed_service_proto_rawDesc = []byte{
	...
	0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x38, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x73, 0x2e, 0x41, 0x64, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x46, 0x65, 0x65, 0x64,
	0x22, 0x46, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x30, 0x12, 0x2e, 0x2f, 0x76, 0x38, 0x2f, 0x7b, 0x72,
	...
	0x02, 0x36, 0x22, 0x31, 0x2f, 0x76, 0x38, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72,
...
var (
	file_google_ads_googleads_v8_services_ad_group_feed_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_ad_group_feed_service_proto_rawDescData = file_google_ads_googleads_v8_services_ad_group_feed_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_ad_group_feed_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_ad_group_feed_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_ad_group_feed_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_ad_group_feed_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_ad_group_feed_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_ad_group_feed_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v8_services_ad_group_feed_service_proto_goTypes = []interface{}{
	(*GetAdGroupFeedRequest)(nil),                          // 0: google.ads.googleads.v8.services.GetAdGroupFeedRequest
	(*MutateAdGroupFeedsRequest)(nil),                      // 1: google.ads.googleads.v8.services.MutateAdGroupFeedsRequest
	(*AdGroupFeedOperation)(nil),                           // 2: google.ads.googleads.v8.services.AdGroupFeedOperation
	(*MutateAdGroupFeedsResponse)(nil),                     // 3: google.ads.googleads.v8.services.MutateAdGroupFeedsResponse
	(*MutateAdGroupFeedResult)(nil),                        // 4: google.ads.googleads.v8.services.MutateAdGroupFeedResult
	...
	(*resources.AdGroupFeed)(nil),                          // 7: google.ads.googleads.v8.resources.AdGroupFeed
	(*status.Status)(nil),                                  // 8: google.rpc.Status
}
var file_google_ads_googleads_v8_services_ad_group_feed_service_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v8.services.MutateAdGroupFeedsRequest.operations:type_name -> google.ads.googleads.v8.services.AdGroupFeedOperation
	5,  // 1: google.ads.googleads.v8.services.MutateAdGroupFeedsRequest.response_content_type:type_name -> google.ads.googleads.v8.enums.ResponseContentTypeEnum.ResponseContentType
	6,  // 2: google.ads.googleads.v8.services.AdGroupFeedOperation.update_mask:type_name -> google.protobuf.FieldMask
	7,  // 3: google.ads.googleads.v8.services.AdGroupFeedOperation.create:type_name -> google.ads.googleads.v8.resources.AdGroupFeed
	7,  // 4: google.ads.googleads.v8.services.AdGroupFeedOperation.update:type_name -> google.ads.googleads.v8.resources.AdGroupFeed
	8,  // 5: google.ads.googleads.v8.services.MutateAdGroupFeedsResponse.partial_failure_error:type_name -> google.rpc.Status
	4,  // 6: google.ads.googleads.v8.services.MutateAdGroupFeedsResponse.results:type_name -> google.ads.googleads.v8.services.MutateAdGroupFeedResult
	7,  // 7: google.ads.googleads.v8.services.MutateAdGroupFeedResult.ad_group_feed:type_name -> google.ads.googleads.v8.resources.AdGroupFeed
	0,  // 8: google.ads.googleads.v8.services.AdGroupFeedService.GetAdGroupFeed:input_type -> google.ads.googleads.v8.services.GetAdGroupFeedRequest
	1,  // 9: google.ads.googleads.v8.services.AdGroupFeedService.MutateAdGroupFeeds:input_type -> google.ads.googleads.v8.services.MutateAdGroupFeedsRequest
	7,  // 10: google.ads.googleads.v8.services.AdGroupFeedService.GetAdGroupFeed:output_type -> google.ads.googleads.v8.resources.AdGroupFeed
	3,  // 11: google.ads.googleads.v8.services.AdGroupFeedService.MutateAdGroupFeeds:output_type -> google.ads.googleads.v8.services.MutateAdGroupFeedsResponse
...
func init() { file_google_ads_googleads_v8_services_ad_group_feed_service_proto_init() }
func file_google_ads_googleads_v8_services_ad_group_feed_service_proto_init() {
	if File_google_ads_googleads_v8_services_ad_group_feed_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_ad_group_feed_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_ad_group_feed_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_ad_group_feed_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_ad_group_feed_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_ad_group_feed_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_ad_group_feed_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_services_ad_group_feed_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_ad_group_feed_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_ad_group_feed_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_ad_group_feed_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_ad_group_feed_service_proto = out.File
	file_google_ads_googleads_v8_services_ad_group_feed_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_ad_group_feed_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_ad_group_feed_service_proto_depIdxs = nil
}
...
func (c *adGroupFeedServiceClient) GetAdGroupFeed(ctx context.Context, in *GetAdGroupFeedRequest, opts ...grpc.CallOption) (*resources.AdGroupFeed, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v8.services.AdGroupFeedService/GetAdGroupFeed", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adGroupFeedServiceClient) MutateAdGroupFeeds(ctx context.Context, in *MutateAdGroupFeedsRequest, opts ...grpc.CallOption) (*MutateAdGroupFeedsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v8.services.AdGroupFeedService/MutateAdGroupFeeds", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AdGroupFeedService_GetAdGroupFeed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v8.services.AdGroupFeedService/GetAdGroupFeed",
	}
...
func _AdGroupFeedService_MutateAdGroupFeeds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v8.services.AdGroupFeedService/MutateAdGroupFeeds",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
