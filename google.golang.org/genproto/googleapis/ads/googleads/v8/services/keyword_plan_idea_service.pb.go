...
type GenerateKeywordIdeasRequest struct {
	...
	// Targeting network.
	KeywordPlanNetwork enums.KeywordPlanNetworkEnum_KeywordPlanNetwork `protobuf:"varint,9,opt,name=keyword_plan_network,json=keywordPlanNetwork,proto3,enum=google.ads.googleads.v8.enums.KeywordPlanNetworkEnum_KeywordPlanNetwork" json:"keyword_plan_network,omitempty"`
	// The keyword annotations to include in response.
	KeywordAnnotation []enums.KeywordPlanKeywordAnnotationEnum_KeywordPlanKeywordAnnotation `protobuf:"varint,17,rep,packed,name=keyword_annotation,json=keywordAnnotation,proto3,enum=google.ads.googleads.v8.enums.KeywordPlanKeywordAnnotationEnum_KeywordPlanKeywordAnnotation" json:"keyword_annotation,omitempty"`
...
func (x *GenerateKeywordIdeasRequest) Reset() {
	*x = GenerateKeywordIdeasRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_msgTypes[0]
...
func (*GenerateKeywordIdeasRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *KeywordAndUrlSeed) Reset() {
	*x = KeywordAndUrlSeed{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*KeywordAndUrlSeed) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *KeywordSeed) Reset() {
	*x = KeywordSeed{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*KeywordSeed) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *SiteSeed) Reset() {
	*x = SiteSeed{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SiteSeed) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *UrlSeed) Reset() {
	*x = UrlSeed{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UrlSeed) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_rawDescGZIP(), []int{4}
}
...
func (x *GenerateKeywordIdeaResponse) Reset() {
	*x = GenerateKeywordIdeaResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GenerateKeywordIdeaResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_rawDescGZIP(), []int{5}
}
...
func (x *GenerateKeywordIdeaResult) Reset() {
	*x = GenerateKeywordIdeaResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GenerateKeywordIdeaResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_rawDescGZIP(), []int{6}
}
...
var file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_rawDesc = []byte{
	...
	0x3d, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x37, 0x22, 0x32, 0x2f, 0x76, 0x38, 0x2f, 0x63, 0x75, 0x73,
	...
	0x64, 0x73, 0x2e, 0x76, 0x38, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x1b,
...
var (
	file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_rawDescData = file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_rawDesc
)

func file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_rawDescData
}

var file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_goTypes = []interface{}{
	(*GenerateKeywordIdeasRequest)(nil),                  // 0: google.ads.googleads.v8.services.GenerateKeywordIdeasRequest
	(*KeywordAndUrlSeed)(nil),                            // 1: google.ads.googleads.v8.services.KeywordAndUrlSeed
	(*KeywordSeed)(nil),                                  // 2: google.ads.googleads.v8.services.KeywordSeed
	(*SiteSeed)(nil),                                     // 3: google.ads.googleads.v8.services.SiteSeed
	(*UrlSeed)(nil),                                      // 4: google.ads.googleads.v8.services.UrlSeed
	(*GenerateKeywordIdeaResponse)(nil),                  // 5: google.ads.googleads.v8.services.GenerateKeywordIdeaResponse
	(*GenerateKeywordIdeaResult)(nil),                    // 6: google.ads.googleads.v8.services.GenerateKeywordIdeaResult
	(enums.KeywordPlanNetworkEnum_KeywordPlanNetwork)(0), // 7: google.ads.googleads.v8.enums.KeywordPlanNetworkEnum.KeywordPlanNetwork
	(enums.KeywordPlanKeywordAnnotationEnum_KeywordPlanKeywordAnnotation)(0), // 8: google.ads.googleads.v8.enums.KeywordPlanKeywordAnnotationEnum.KeywordPlanKeywordAnnotation
	(*common.KeywordPlanAggregateMetrics)(nil),                               // 9: google.ads.googleads.v8.common.KeywordPlanAggregateMetrics
	(*common.HistoricalMetricsOptions)(nil),                                  // 10: google.ads.googleads.v8.common.HistoricalMetricsOptions
	(*common.KeywordPlanAggregateMetricResults)(nil),                         // 11: google.ads.googleads.v8.common.KeywordPlanAggregateMetricResults
	(*common.KeywordPlanHistoricalMetrics)(nil),                              // 12: google.ads.googleads.v8.common.KeywordPlanHistoricalMetrics
	(*common.KeywordAnnotations)(nil),                                        // 13: google.ads.googleads.v8.common.KeywordAnnotations
}
var file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_depIdxs = []int32{
	7,  // 0: google.ads.googleads.v8.services.GenerateKeywordIdeasRequest.keyword_plan_network:type_name -> google.ads.googleads.v8.enums.KeywordPlanNetworkEnum.KeywordPlanNetwork
	8,  // 1: google.ads.googleads.v8.services.GenerateKeywordIdeasRequest.keyword_annotation:type_name -> google.ads.googleads.v8.enums.KeywordPlanKeywordAnnotationEnum.KeywordPlanKeywordAnnotation
	9,  // 2: google.ads.googleads.v8.services.GenerateKeywordIdeasRequest.aggregate_metrics:type_name -> google.ads.googleads.v8.common.KeywordPlanAggregateMetrics
	10, // 3: google.ads.googleads.v8.services.GenerateKeywordIdeasRequest.historical_metrics_options:type_name -> google.ads.googleads.v8.common.HistoricalMetricsOptions
	1,  // 4: google.ads.googleads.v8.services.GenerateKeywordIdeasRequest.keyword_and_url_seed:type_name -> google.ads.googleads.v8.services.KeywordAndUrlSeed
	2,  // 5: google.ads.googleads.v8.services.GenerateKeywordIdeasRequest.keyword_seed:type_name -> google.ads.googleads.v8.services.KeywordSeed
	4,  // 6: google.ads.googleads.v8.services.GenerateKeywordIdeasRequest.url_seed:type_name -> google.ads.googleads.v8.services.UrlSeed
	3,  // 7: google.ads.googleads.v8.services.GenerateKeywordIdeasRequest.site_seed:type_name -> google.ads.googleads.v8.services.SiteSeed
	6,  // 8: google.ads.googleads.v8.services.GenerateKeywordIdeaResponse.results:type_name -> google.ads.googleads.v8.services.GenerateKeywordIdeaResult
	11, // 9: google.ads.googleads.v8.services.GenerateKeywordIdeaResponse.aggregate_metric_results:type_name -> google.ads.googleads.v8.common.KeywordPlanAggregateMetricResults
	12, // 10: google.ads.googleads.v8.services.GenerateKeywordIdeaResult.keyword_idea_metrics:type_name -> google.ads.googleads.v8.common.KeywordPlanHistoricalMetrics
	13, // 11: google.ads.googleads.v8.services.GenerateKeywordIdeaResult.keyword_annotations:type_name -> google.ads.googleads.v8.common.KeywordAnnotations
	0,  // 12: google.ads.googleads.v8.services.KeywordPlanIdeaService.GenerateKeywordIdeas:input_type -> google.ads.googleads.v8.services.GenerateKeywordIdeasRequest
	5,  // 13: google.ads.googleads.v8.services.KeywordPlanIdeaService.GenerateKeywordIdeas:output_type -> google.ads.googleads.v8.services.GenerateKeywordIdeaResponse
...
func init() { file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_init() }
func file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_init() {
	if File_google_ads_googleads_v8_services_keyword_plan_idea_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_msgTypes[1].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_msgTypes[3].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_msgTypes[4].OneofWrappers = []interface{}{}
	file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_msgTypes[6].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_services_keyword_plan_idea_service_proto = out.File
	file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_rawDesc = nil
	file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_goTypes = nil
	file_google_ads_googleads_v8_services_keyword_plan_idea_service_proto_depIdxs = nil
}
...
func (c *keywordPlanIdeaServiceClient) GenerateKeywordIdeas(ctx context.Context, in *GenerateKeywordIdeasRequest, opts ...grpc.CallOption) (*GenerateKeywordIdeaResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v8.services.KeywordPlanIdeaService/GenerateKeywordIdeas", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _KeywordPlanIdeaService_GenerateKeywordIdeas_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v8.services.KeywordPlanIdeaService/GenerateKeywordIdeas",
	}
