...
func (FeedErrorEnum_FeedError) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v8_errors_feed_error_proto_enumTypes[0].Descriptor()
}

func (FeedErrorEnum_FeedError) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v8_errors_feed_error_proto_enumTypes[0]
}
...
func (FeedErrorEnum_FeedError) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_errors_feed_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *FeedErrorEnum) Reset() {
	*x = FeedErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_errors_feed_error_proto_msgTypes[0]
...
func (*FeedErrorEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_errors_feed_error_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v8_errors_feed_error_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v8_errors_feed_error_proto_rawDesc = []byte{
	...
	0xc6, 0x06, 0x0a, 0x0d, 0x46, 0x65, 0x65, 0x64, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x45, 0x6e, 0x75,
	0x6d, 0x22, 0xb4, 0x06, 0x0a, 0x09, 0x46, 0x65, 0x65, 0x64, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12,
	...
	0x5f, 0x46, 0x45, 0x45, 0x44, 0x53, 0x10, 0x17, 0x42, 0xe9, 0x01, 0x0a, 0x22, 0x63, 0x6f, 0x6d,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x38, 0x2e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x42,
	0x0e, 0x46, 0x65, 0x65, 0x64, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50,
...
var (
	file_google_ads_googleads_v8_errors_feed_error_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_errors_feed_error_proto_rawDescData = file_google_ads_googleads_v8_errors_feed_error_proto_rawDesc
)

func file_google_ads_googleads_v8_errors_feed_error_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_errors_feed_error_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_errors_feed_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_errors_feed_error_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_errors_feed_error_proto_rawDescData
}

var file_google_ads_googleads_v8_errors_feed_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v8_errors_feed_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v8_errors_feed_error_proto_goTypes = []interface{}{
	(FeedErrorEnum_FeedError)(0), // 0: google.ads.googleads.v8.errors.FeedErrorEnum.FeedError
	(*FeedErrorEnum)(nil),        // 1: google.ads.googleads.v8.errors.FeedErrorEnum
}
var file_google_ads_googleads_v8_errors_feed_error_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v8_errors_feed_error_proto_init() }
func file_google_ads_googleads_v8_errors_feed_error_proto_init() {
	if File_google_ads_googleads_v8_errors_feed_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_errors_feed_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_errors_feed_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v8_errors_feed_error_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_errors_feed_error_proto_depIdxs,
		EnumInfos:         file_google_ads_googleads_v8_errors_feed_error_proto_enumTypes,
		MessageInfos:      file_google_ads_googleads_v8_errors_feed_error_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_errors_feed_error_proto = out.File
	file_google_ads_googleads_v8_errors_feed_error_proto_rawDesc = nil
	file_google_ads_googleads_v8_errors_feed_error_proto_goTypes = nil
	file_google_ads_googleads_v8_errors_feed_error_proto_depIdxs = nil
}
