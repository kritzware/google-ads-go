...
func (CriterionErrorEnum_CriterionError) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v8_errors_criterion_error_proto_enumTypes[0].Descriptor()
}

func (CriterionErrorEnum_CriterionError) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v8_errors_criterion_error_proto_enumTypes[0]
}
...
func (CriterionErrorEnum_CriterionError) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_errors_criterion_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *CriterionErrorEnum) Reset() {
	*x = CriterionErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v8_errors_criterion_error_proto_msgTypes[0]
...
func (*CriterionErrorEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v8_errors_criterion_error_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v8_errors_criterion_error_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v8_errors_criterion_error_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x95, 0x27, 0x0a, 0x12, 0x43, 0x72, 0x69, 0x74, 0x65, 0x72, 0x69,
	0x6f, 0x6e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0xfe, 0x26, 0x0a, 0x0e,
	...
	0x5f, 0x52, 0x45, 0x56, 0x45, 0x52, 0x53, 0x45, 0x44, 0x10, 0x86, 0x01, 0x42, 0xee, 0x01, 0x0a,
...
var (
	file_google_ads_googleads_v8_errors_criterion_error_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v8_errors_criterion_error_proto_rawDescData = file_google_ads_googleads_v8_errors_criterion_error_proto_rawDesc
)

func file_google_ads_googleads_v8_errors_criterion_error_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v8_errors_criterion_error_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v8_errors_criterion_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v8_errors_criterion_error_proto_rawDescData)
	})
	return file_google_ads_googleads_v8_errors_criterion_error_proto_rawDescData
}

var file_google_ads_googleads_v8_errors_criterion_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v8_errors_criterion_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v8_errors_criterion_error_proto_goTypes = []interface{}{
	(CriterionErrorEnum_CriterionError)(0), // 0: google.ads.googleads.v8.errors.CriterionErrorEnum.CriterionError
	(*CriterionErrorEnum)(nil),             // 1: google.ads.googleads.v8.errors.CriterionErrorEnum
}
var file_google_ads_googleads_v8_errors_criterion_error_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v8_errors_criterion_error_proto_init() }
func file_google_ads_googleads_v8_errors_criterion_error_proto_init() {
	if File_google_ads_googleads_v8_errors_criterion_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v8_errors_criterion_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v8_errors_criterion_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v8_errors_criterion_error_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v8_errors_criterion_error_proto_depIdxs,
		EnumInfos:         file_google_ads_googleads_v8_errors_criterion_error_proto_enumTypes,
		MessageInfos:      file_google_ads_googleads_v8_errors_criterion_error_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v8_errors_criterion_error_proto = out.File
	file_google_ads_googleads_v8_errors_criterion_error_proto_rawDesc = nil
	file_google_ads_googleads_v8_errors_criterion_error_proto_goTypes = nil
	file_google_ads_googleads_v8_errors_criterion_error_proto_depIdxs = nil
}
