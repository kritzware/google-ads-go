...
func (SharedCriterionErrorEnum_SharedCriterionError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_041b9aee373cddbe, []int{0, 0}
}
...
func (*SharedCriterionErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_041b9aee373cddbe, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/errors/shared_criterion_error.proto", fileDescriptor_041b9aee373cddbe)
}

var fileDescriptor_041b9aee373cddbe = []byte{
