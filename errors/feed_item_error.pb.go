...
func (FeedItemErrorEnum_FeedItemError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_99ffa0797295834e, []int{0, 0}
}
...
func (*FeedItemErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_99ffa0797295834e, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/errors/feed_item_error.proto", fileDescriptor_99ffa0797295834e)
}

var fileDescriptor_99ffa0797295834e = []byte{
