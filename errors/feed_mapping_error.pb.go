...
func (FeedMappingErrorEnum_FeedMappingError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_8fe0b067790a1620, []int{0, 0}
}
...
func (*FeedMappingErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_8fe0b067790a1620, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/errors/feed_mapping_error.proto", fileDescriptor_8fe0b067790a1620)
}

var fileDescriptor_8fe0b067790a1620 = []byte{
