...
// source: github.com/kritzware/google-ads-go/errors/not_empty_error.proto
...
func init() {
	proto.RegisterFile("github.com/kritzware/google-ads-go/errors/not_empty_error.proto", fileDescriptor_221b4006f4ee82bb)
}
