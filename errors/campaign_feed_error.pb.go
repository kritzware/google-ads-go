...
func (CampaignFeedErrorEnum_CampaignFeedError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_a882be5720cd929c, []int{0, 0}
}
...
func (*CampaignFeedErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_a882be5720cd929c, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/errors/campaign_feed_error.proto", fileDescriptor_a882be5720cd929c)
}

var fileDescriptor_a882be5720cd929c = []byte{
