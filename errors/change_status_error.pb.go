...
func (ChangeStatusErrorEnum_ChangeStatusError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_9471dd6e24155c32, []int{0, 0}
}
...
func (*ChangeStatusErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_9471dd6e24155c32, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/errors/change_status_error.proto", fileDescriptor_9471dd6e24155c32)
}

var fileDescriptor_9471dd6e24155c32 = []byte{
