...
// source: github.com/kritzware/google-ads-go/errors/operator_error.proto
...
func init() {
	proto.RegisterFile("github.com/kritzware/google-ads-go/errors/operator_error.proto", fileDescriptor_ef7e8edff1e60eda)
}
