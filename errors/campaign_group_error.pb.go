...
func (CampaignGroupErrorEnum_CampaignGroupError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0aa1564b81c0e200, []int{0, 0}
}
...
func (*CampaignGroupErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_0aa1564b81c0e200, []int{0}
}
...
func (m *CampaignGroupErrorEnum) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CampaignGroupErrorEnum.Merge(m, src)
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/errors/campaign_group_error.proto", fileDescriptor_0aa1564b81c0e200)
}

var fileDescriptor_0aa1564b81c0e200 = []byte{
