...
func (CustomerManagerLinkErrorEnum_CustomerManagerLinkError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_f4805bf779f258b5, []int{0, 0}
}
...
func (*CustomerManagerLinkErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_f4805bf779f258b5, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/errors/customer_manager_link_error.proto", fileDescriptor_f4805bf779f258b5)
}

var fileDescriptor_f4805bf779f258b5 = []byte{
