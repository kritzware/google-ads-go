...
// source: github.com/kritzware/google-ads-go/errors/operation_access_denied_error.proto
...
func init() {
	proto.RegisterFile("github.com/kritzware/google-ads-go/errors/operation_access_denied_error.proto", fileDescriptor_fb3b0aac42536863)
}
