...
// source: github.com/kritzware/google-ads-go/errors/campaign_budget_error.proto
...
func init() {
	proto.RegisterFile("github.com/kritzware/google-ads-go/errors/campaign_budget_error.proto", fileDescriptor_9300e3888a22b411)
}
