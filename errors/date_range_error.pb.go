...
// source: github.com/kritzware/google-ads-go/errors/date_range_error.proto
...
func init() {
	proto.RegisterFile("github.com/kritzware/google-ads-go/errors/date_range_error.proto", fileDescriptor_2dc01d50b2259f80)
}
