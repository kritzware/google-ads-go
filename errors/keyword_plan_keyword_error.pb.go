...
func (KeywordPlanKeywordErrorEnum_KeywordPlanKeywordError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_b616028d2be08e03, []int{0, 0}
}
...
func (*KeywordPlanKeywordErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_b616028d2be08e03, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/errors/keyword_plan_keyword_error.proto", fileDescriptor_b616028d2be08e03)
}

var fileDescriptor_b616028d2be08e03 = []byte{
