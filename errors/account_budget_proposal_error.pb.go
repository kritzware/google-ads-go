...
func (AccountBudgetProposalErrorEnum_AccountBudgetProposalError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_3933aa7042306da2, []int{0, 0}
}
...
func (*AccountBudgetProposalErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_3933aa7042306da2, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/errors/account_budget_proposal_error.proto", fileDescriptor_3933aa7042306da2)
}

var fileDescriptor_3933aa7042306da2 = []byte{
