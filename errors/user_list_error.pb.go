...
func (UserListErrorEnum_UserListError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_1b3453f81776e361, []int{0, 0}
}
...
func (*UserListErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_1b3453f81776e361, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/errors/user_list_error.proto", fileDescriptor_1b3453f81776e361)
}

var fileDescriptor_1b3453f81776e361 = []byte{
