...
func (EnumErrorEnum_EnumError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0ba41addc123f3cb, []int{0, 0}
}
...
func (*EnumErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_0ba41addc123f3cb, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/errors/enum_error.proto", fileDescriptor_0ba41addc123f3cb)
}

var fileDescriptor_0ba41addc123f3cb = []byte{
