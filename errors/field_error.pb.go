...
// source: github.com/kritzware/google-ads-go/errors/field_error.proto
...
func init() {
	proto.RegisterFile("github.com/kritzware/google-ads-go/errors/field_error.proto", fileDescriptor_5a936ff4dafd31ed)
}
