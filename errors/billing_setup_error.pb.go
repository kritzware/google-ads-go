...
func (BillingSetupErrorEnum_BillingSetupError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_178b27d6384b6806, []int{0, 0}
}
...
func (*BillingSetupErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_178b27d6384b6806, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/errors/billing_setup_error.proto", fileDescriptor_178b27d6384b6806)
}

var fileDescriptor_178b27d6384b6806 = []byte{
