...
func (KeywordPlanErrorEnum_KeywordPlanError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_cde1d45f7d0384c7, []int{0, 0}
}
...
func (*KeywordPlanErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_cde1d45f7d0384c7, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/errors/keyword_plan_error.proto", fileDescriptor_cde1d45f7d0384c7)
}

var fileDescriptor_cde1d45f7d0384c7 = []byte{
