...
func (KeywordPlanIdeaErrorEnum_KeywordPlanIdeaError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_ede9abcd4982043b, []int{0, 0}
}
...
func (*KeywordPlanIdeaErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_ede9abcd4982043b, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/errors/keyword_plan_idea_error.proto", fileDescriptor_ede9abcd4982043b)
}

var fileDescriptor_ede9abcd4982043b = []byte{
