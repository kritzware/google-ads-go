...
func (MediaFileErrorEnum_MediaFileError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_a2d93b9512bf54ef, []int{0, 0}
}
...
func (*MediaFileErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_a2d93b9512bf54ef, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/errors/media_file_error.proto", fileDescriptor_a2d93b9512bf54ef)
}

var fileDescriptor_a2d93b9512bf54ef = []byte{
