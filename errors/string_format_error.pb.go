...
// source: github.com/kritzware/google-ads-go/errors/string_format_error.proto
...
func init() {
	proto.RegisterFile("github.com/kritzware/google-ads-go/errors/string_format_error.proto", fileDescriptor_5fc8527e9ecfab70)
}
