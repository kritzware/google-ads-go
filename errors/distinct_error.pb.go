...
// source: github.com/kritzware/google-ads-go/errors/distinct_error.proto
...
func init() {
	proto.RegisterFile("github.com/kritzware/google-ads-go/errors/distinct_error.proto", fileDescriptor_f425fa1f40ddce89)
}
