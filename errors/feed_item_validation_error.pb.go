...
func (FeedItemValidationErrorEnum_FeedItemValidationError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_3467e9329ac8bbde, []int{0, 0}
}
...
func (*FeedItemValidationErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_3467e9329ac8bbde, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/errors/feed_item_validation_error.proto", fileDescriptor_3467e9329ac8bbde)
}

var fileDescriptor_3467e9329ac8bbde = []byte{
