...
func (CustomerClientLinkErrorEnum_CustomerClientLinkError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_b1018da6c8f09f8c, []int{0, 0}
}
...
func (*CustomerClientLinkErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_b1018da6c8f09f8c, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/errors/customer_client_link_error.proto", fileDescriptor_b1018da6c8f09f8c)
}

var fileDescriptor_b1018da6c8f09f8c = []byte{
