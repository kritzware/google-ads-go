...
// source: github.com/kritzware/google-ads-go/errors/field_mask_error.proto
...
func init() {
	proto.RegisterFile("github.com/kritzware/google-ads-go/errors/field_mask_error.proto", fileDescriptor_72820e40b31f95b7)
}
