...
func (AdParameterErrorEnum_AdParameterError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_3af7a7a0c8f4a68d, []int{0, 0}
}
...
func (*AdParameterErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_3af7a7a0c8f4a68d, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/errors/ad_parameter_error.proto", fileDescriptor_3af7a7a0c8f4a68d)
}

var fileDescriptor_3af7a7a0c8f4a68d = []byte{
