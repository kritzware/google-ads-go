...
func (*TargetingSetting) Descriptor() ([]byte, []int) {
	return fileDescriptor_3baab94fe8eabc40, []int{0}
}
...
func (*TargetRestriction) Descriptor() ([]byte, []int) {
	return fileDescriptor_3baab94fe8eabc40, []int{1}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/common/targeting_setting.proto", fileDescriptor_3baab94fe8eabc40)
}

var fileDescriptor_3baab94fe8eabc40 = []byte{
