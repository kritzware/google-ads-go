...
func (*TagSnippet) Descriptor() ([]byte, []int) {
	return fileDescriptor_1aad11ffe3792512, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/common/tag_snippet.proto", fileDescriptor_1aad11ffe3792512)
}

var fileDescriptor_1aad11ffe3792512 = []byte{
