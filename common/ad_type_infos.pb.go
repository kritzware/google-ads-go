...
func (*TextAdInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_c02fbbce56790ff0, []int{0}
}
...
func (*ExpandedTextAdInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_c02fbbce56790ff0, []int{1}
}
...
func (*DynamicSearchAdInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_c02fbbce56790ff0, []int{2}
}
...
func (*ResponsiveDisplayAdInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_c02fbbce56790ff0, []int{3}
}
...
func (*CallOnlyAdInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_c02fbbce56790ff0, []int{4}
}
...
func (*ExpandedDynamicSearchAdInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_c02fbbce56790ff0, []int{5}
}
...
func (*HotelAdInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_c02fbbce56790ff0, []int{6}
}
...
func (*ShoppingSmartAdInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_c02fbbce56790ff0, []int{7}
}
...
func (*ShoppingProductAdInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_c02fbbce56790ff0, []int{8}
}
...
func (*GmailAdInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_c02fbbce56790ff0, []int{9}
}
...
func (*GmailTeaser) Descriptor() ([]byte, []int) {
	return fileDescriptor_c02fbbce56790ff0, []int{10}
}
...
func (*DisplayCallToAction) Descriptor() ([]byte, []int) {
	return fileDescriptor_c02fbbce56790ff0, []int{11}
}
...
func (*ImageAdInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_c02fbbce56790ff0, []int{12}
}
...
func (*VideoTrueViewInStreamAdInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_c02fbbce56790ff0, []int{13}
}
...
func (*VideoAdInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_c02fbbce56790ff0, []int{14}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/common/ad_type_infos.proto", fileDescriptor_c02fbbce56790ff0)
}

var fileDescriptor_c02fbbce56790ff0 = []byte{
