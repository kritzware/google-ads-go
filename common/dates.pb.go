...
func (*DateRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_ed817e38b3e3a4ba, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/common/dates.proto", fileDescriptor_ed817e38b3e3a4ba)
}

var fileDescriptor_ed817e38b3e3a4ba = []byte{
