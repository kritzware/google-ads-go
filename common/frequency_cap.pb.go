...
func (*FrequencyCapEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_92f5036dee839ec2, []int{0}
}
...
func (*FrequencyCapKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_92f5036dee839ec2, []int{1}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/common/frequency_cap.proto", fileDescriptor_92f5036dee839ec2)
}

var fileDescriptor_92f5036dee839ec2 = []byte{
