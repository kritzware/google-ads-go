...
func (*KeywordPlanHistoricalMetrics) Descriptor() ([]byte, []int) {
	return fileDescriptor_a4a0af8f3b67dacc, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/common/keyword_plan_common.proto", fileDescriptor_a4a0af8f3b67dacc)
}

var fileDescriptor_a4a0af8f3b67dacc = []byte{
