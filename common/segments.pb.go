...
func (*Segments) Descriptor() ([]byte, []int) {
	return fileDescriptor_de7441e2f6d34df2, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/common/segments.proto", fileDescriptor_de7441e2f6d34df2)
}

var fileDescriptor_de7441e2f6d34df2 = []byte{
