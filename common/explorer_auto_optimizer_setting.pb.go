...
func (*ExplorerAutoOptimizerSetting) Descriptor() ([]byte, []int) {
	return fileDescriptor_551230aa9e865edb, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/common/explorer_auto_optimizer_setting.proto", fileDescriptor_551230aa9e865edb)
}

var fileDescriptor_551230aa9e865edb = []byte{
