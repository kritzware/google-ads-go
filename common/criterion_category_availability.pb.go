...
func (*CriterionCategoryAvailability) Descriptor() ([]byte, []int) {
	return fileDescriptor_96e204306ba9655c, []int{0}
}
...
func (*CriterionCategoryChannelAvailability) Descriptor() ([]byte, []int) {
	return fileDescriptor_96e204306ba9655c, []int{1}
}
...
func (*CriterionCategoryLocaleAvailability) Descriptor() ([]byte, []int) {
	return fileDescriptor_96e204306ba9655c, []int{2}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/common/criterion_category_availability.proto", fileDescriptor_96e204306ba9655c)
}

var fileDescriptor_96e204306ba9655c = []byte{
