...
// source: github.com/kritzware/google-ads-go/protos/google/ads/googleads/v0/services/ad_group_service.proto
...
func (*GetAdGroupRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_223b55be421cddd0, []int{0}
}
...
func (*MutateAdGroupsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_223b55be421cddd0, []int{1}
}
...
func (*AdGroupOperation) Descriptor() ([]byte, []int) {
	return fileDescriptor_223b55be421cddd0, []int{2}
}
...
func (*MutateAdGroupsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_223b55be421cddd0, []int{3}
}
...
func (*MutateAdGroupResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_223b55be421cddd0, []int{4}
}
...
var _AdGroupService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/kritzware/google-ads-go/protos/google/ads/googleads/v0/services/ad_group_service.proto",
}

func init() {
	proto.RegisterFile("github.com/kritzware/google-ads-go/protos/google/ads/googleads/v0/services/ad_group_service.proto", fileDescriptor_223b55be421cddd0)
}

var fileDescriptor_223b55be421cddd0 = []byte{
	// 561 bytes of a gzipped FileDescriptorProto
	,
}
