...
// source: github.com/kritzware/google-ads-go/protos/google/ads/googleads/v0/services/recommendation_service.proto
...
func (*GetRecommendationRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_af65c493fa1e2656, []int{0}
}
...
func (*ApplyRecommendationRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_af65c493fa1e2656, []int{1}
}
...
func (*ApplyRecommendationOperation) Descriptor() ([]byte, []int) {
	return fileDescriptor_af65c493fa1e2656, []int{2}
}
...
func (*ApplyRecommendationOperation_CampaignBudgetParameters) Descriptor() ([]byte, []int) {
	return fileDescriptor_af65c493fa1e2656, []int{2, 0}
}
...
func (*ApplyRecommendationOperation_TextAdParameters) Descriptor() ([]byte, []int) {
	return fileDescriptor_af65c493fa1e2656, []int{2, 1}
}
...
func (m *ApplyRecommendationOperation_TextAdParameters) GetAd() *common.Ad {
	if m != nil {
		return m.Ad
	}
	return nil
...
func (*ApplyRecommendationOperation_KeywordParameters) Descriptor() ([]byte, []int) {
	return fileDescriptor_af65c493fa1e2656, []int{2, 2}
}
...
func (*ApplyRecommendationOperation_TargetCpaOptInParameters) Descriptor() ([]byte, []int) {
	return fileDescriptor_af65c493fa1e2656, []int{2, 3}
}
...
func (*ApplyRecommendationResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_af65c493fa1e2656, []int{3}
}
...
func (*ApplyRecommendationResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_af65c493fa1e2656, []int{4}
}
...
type isApplyRecommendationResult_Result interface {
	isApplyRecommendationResult_Result()
}
...
func (*ApplyRecommendationResult_ResourceName) isApplyRecommendationResult_Result() {}

func (*ApplyRecommendationResult_Status) isApplyRecommendationResult_Result() {}
...
func (m *ApplyRecommendationResult) GetResourceName() string {
	if x, ok := m.GetResult().(*ApplyRecommendationResult_ResourceName); ok {
...
func (m *ApplyRecommendationResult) GetStatus() *status.Status {
	if x, ok := m.GetResult().(*ApplyRecommendationResult_Status); ok {
		return x.Status
	}
	return nil
}
...
func (*ApplyRecommendationResult) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _ApplyRecommendationResult_OneofMarshaler, _ApplyRecommendationResult_OneofUnmarshaler, _ApplyRecommendationResult_OneofSizer, []interface{}{
		(*ApplyRecommendationResult_ResourceName)(nil),
		(*ApplyRecommendationResult_Status)(nil),
	}
}

func _ApplyRecommendationResult_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*ApplyRecommendationResult)
	// result
	switch x := m.Result.(type) {
	case *ApplyRecommendationResult_ResourceName:
		b.EncodeVarint(1<<3 | proto.WireBytes)
		b.EncodeStringBytes(x.ResourceName)
	case *ApplyRecommendationResult_Status:
		b.EncodeVarint(2<<3 | proto.WireBytes)
	...
	case nil:
	default:
		return fmt.Errorf("ApplyRecommendationResult.Result has unexpected type %T", x)
	}
	return nil
}

func _ApplyRecommendationResult_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*ApplyRecommendationResult)
	switch tag {
	case 1: // result.resource_name
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.Result = &ApplyRecommendationResult_ResourceName{x}
		return true, err
	case 2: // result.status
		...
		err := b.DecodeMessage(msg)
		m.Result = &ApplyRecommendationResult_Status{msg}
		return true, err
	default:
		return false, nil
	}
...
func _ApplyRecommendationResult_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*ApplyRecommendationResult)
	// result
	switch x := m.Result.(type) {
	case *ApplyRecommendationResult_ResourceName:
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(len(x.ResourceName)))
		n += len(x.ResourceName)
	case *ApplyRecommendationResult_Status:
...
var _RecommendationService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/kritzware/google-ads-go/protos/google/ads/googleads/v0/services/recommendation_service.proto",
}

func init() {
	proto.RegisterFile("github.com/kritzware/google-ads-go/protos/google/ads/googleads/v0/services/recommendation_service.proto", fileDescriptor_af65c493fa1e2656)
}

var fileDescriptor_af65c493fa1e2656 = []byte{
	// 913 bytes of a gzipped FileDescriptorProto
	,
}
