...
func (TimeTypeEnum_TimeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_db98fd16f58bf0c8, []int{0, 0}
}
...
func (*TimeTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_db98fd16f58bf0c8, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/time_type.proto", fileDescriptor_db98fd16f58bf0c8)
}

var fileDescriptor_db98fd16f58bf0c8 = []byte{
