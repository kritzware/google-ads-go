...
func (AccountBudgetProposalTypeEnum_AccountBudgetProposalType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_e4054eac1d8ee3ce, []int{0, 0}
}
...
func (*AccountBudgetProposalTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_e4054eac1d8ee3ce, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/account_budget_proposal_type.proto", fileDescriptor_e4054eac1d8ee3ce)
}

var fileDescriptor_e4054eac1d8ee3ce = []byte{
