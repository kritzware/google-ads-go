...
func (FeedItemQualityDisapprovalReasonEnum_FeedItemQualityDisapprovalReason) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_530ed7377f60bcff, []int{0, 0}
}
...
func (*FeedItemQualityDisapprovalReasonEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_530ed7377f60bcff, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/feed_item_quality_disapproval_reason.proto", fileDescriptor_530ed7377f60bcff)
}

var fileDescriptor_530ed7377f60bcff = []byte{
