...
func (CustomerMatchUploadKeyTypeEnum_CustomerMatchUploadKeyType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_f09749b2e7a2a22b, []int{0, 0}
}
...
func (*CustomerMatchUploadKeyTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_f09749b2e7a2a22b, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/customer_match_upload_key_type.proto", fileDescriptor_f09749b2e7a2a22b)
}

var fileDescriptor_f09749b2e7a2a22b = []byte{
