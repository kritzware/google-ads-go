...
func (UserListSizeRangeEnum_UserListSizeRange) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_3a40c75ce1845965, []int{0, 0}
}
...
func (*UserListSizeRangeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_3a40c75ce1845965, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/user_list_size_range.proto", fileDescriptor_3a40c75ce1845965)
}

var fileDescriptor_3a40c75ce1845965 = []byte{
