...
func (UserListCombinedRuleOperatorEnum_UserListCombinedRuleOperator) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_034f708ac8797103, []int{0, 0}
}
...
func (*UserListCombinedRuleOperatorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_034f708ac8797103, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/user_list_combined_rule_operator.proto", fileDescriptor_034f708ac8797103)
}

var fileDescriptor_034f708ac8797103 = []byte{
