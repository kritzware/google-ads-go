...
func (CriterionCategoryLocaleAvailabilityModeEnum_CriterionCategoryLocaleAvailabilityMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_e20896859340bb97, []int{0, 0}
}
...
func (*CriterionCategoryLocaleAvailabilityModeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_e20896859340bb97, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/criterion_category_locale_availability_mode.proto", fileDescriptor_e20896859340bb97)
}

var fileDescriptor_e20896859340bb97 = []byte{
