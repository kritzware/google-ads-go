...
func (CampaignSharedSetStatusEnum_CampaignSharedSetStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_5df1df406ee6a377, []int{0, 0}
}
...
func (*CampaignSharedSetStatusEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_5df1df406ee6a377, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/campaign_shared_set_status.proto", fileDescriptor_5df1df406ee6a377)
}

var fileDescriptor_5df1df406ee6a377 = []byte{
