...
func (BudgetPeriodEnum_BudgetPeriod) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_77814120f1745531, []int{0, 0}
}
...
func (*BudgetPeriodEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_77814120f1745531, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/budget_period.proto", fileDescriptor_77814120f1745531)
}

var fileDescriptor_77814120f1745531 = []byte{
