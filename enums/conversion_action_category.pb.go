...
func (ConversionActionCategoryEnum_ConversionActionCategory) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_f52b4a76978656bc, []int{0, 0}
}
...
func (*ConversionActionCategoryEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_f52b4a76978656bc, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/conversion_action_category.proto", fileDescriptor_f52b4a76978656bc)
}

var fileDescriptor_f52b4a76978656bc = []byte{
