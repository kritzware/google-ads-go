...
func (UserListNumberRuleItemOperatorEnum_UserListNumberRuleItemOperator) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_fa4b9e42b3472fb3, []int{0, 0}
}
...
func (*UserListNumberRuleItemOperatorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_fa4b9e42b3472fb3, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/user_list_number_rule_item_operator.proto", fileDescriptor_fa4b9e42b3472fb3)
}

var fileDescriptor_fa4b9e42b3472fb3 = []byte{
