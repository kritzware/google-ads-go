...
func (SharedSetTypeEnum_SharedSetType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_4b0fc53295199bb8, []int{0, 0}
}
...
func (*SharedSetTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_4b0fc53295199bb8, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/shared_set_type.proto", fileDescriptor_4b0fc53295199bb8)
}

var fileDescriptor_4b0fc53295199bb8 = []byte{
