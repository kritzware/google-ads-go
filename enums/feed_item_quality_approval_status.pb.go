...
func (FeedItemQualityApprovalStatusEnum_FeedItemQualityApprovalStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_dedabf77e3905afc, []int{0, 0}
}
...
func (*FeedItemQualityApprovalStatusEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_dedabf77e3905afc, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/feed_item_quality_approval_status.proto", fileDescriptor_dedabf77e3905afc)
}

var fileDescriptor_dedabf77e3905afc = []byte{
