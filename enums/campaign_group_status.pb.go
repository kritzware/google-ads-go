...
func (CampaignGroupStatusEnum_CampaignGroupStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_e4a4f18df0fe1208, []int{0, 0}
}
...
func (*CampaignGroupStatusEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_e4a4f18df0fe1208, []int{0}
}
...
func (m *CampaignGroupStatusEnum) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CampaignGroupStatusEnum.Merge(m, src)
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/campaign_group_status.proto", fileDescriptor_e4a4f18df0fe1208)
}

var fileDescriptor_e4a4f18df0fe1208 = []byte{
