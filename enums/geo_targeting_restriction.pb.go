...
func (GeoTargetingRestrictionEnum_GeoTargetingRestriction) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_b286afe291ca7a3b, []int{0, 0}
}
...
func (*GeoTargetingRestrictionEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_b286afe291ca7a3b, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/geo_targeting_restriction.proto", fileDescriptor_b286afe291ca7a3b)
}

var fileDescriptor_b286afe291ca7a3b = []byte{
