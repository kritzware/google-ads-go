...
func (WebpageConditionOperatorEnum_WebpageConditionOperator) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_5a1dd2c3bd477ace, []int{0, 0}
}
...
func (*WebpageConditionOperatorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_5a1dd2c3bd477ace, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/webpage_condition_operator.proto", fileDescriptor_5a1dd2c3bd477ace)
}

var fileDescriptor_5a1dd2c3bd477ace = []byte{
