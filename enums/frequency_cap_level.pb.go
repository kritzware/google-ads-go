...
func (FrequencyCapLevelEnum_FrequencyCapLevel) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_28da8bcce5499feb, []int{0, 0}
}
...
func (*FrequencyCapLevelEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_28da8bcce5499feb, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/frequency_cap_level.proto", fileDescriptor_28da8bcce5499feb)
}

var fileDescriptor_28da8bcce5499feb = []byte{
