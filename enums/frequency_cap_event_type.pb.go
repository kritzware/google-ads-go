...
func (FrequencyCapEventTypeEnum_FrequencyCapEventType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_efbfc2d312038533, []int{0, 0}
}
...
func (*FrequencyCapEventTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_efbfc2d312038533, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/frequency_cap_event_type.proto", fileDescriptor_efbfc2d312038533)
}

var fileDescriptor_efbfc2d312038533 = []byte{
