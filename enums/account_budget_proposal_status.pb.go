...
func (AccountBudgetProposalStatusEnum_AccountBudgetProposalStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_31d21571f8020c17, []int{0, 0}
}
...
func (*AccountBudgetProposalStatusEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_31d21571f8020c17, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/account_budget_proposal_status.proto", fileDescriptor_31d21571f8020c17)
}

var fileDescriptor_31d21571f8020c17 = []byte{
