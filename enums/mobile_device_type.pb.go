...
func (MobileDeviceTypeEnum_MobileDeviceType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_e8a0b7a9d9304c8a, []int{0, 0}
}
...
func (*MobileDeviceTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_e8a0b7a9d9304c8a, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/mobile_device_type.proto", fileDescriptor_e8a0b7a9d9304c8a)
}

var fileDescriptor_e8a0b7a9d9304c8a = []byte{
