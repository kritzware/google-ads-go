...
func (SearchTermMatchTypeEnum_SearchTermMatchType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_7965fd2f3594f3cd, []int{0, 0}
}
...
func (*SearchTermMatchTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_7965fd2f3594f3cd, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/search_term_match_type.proto", fileDescriptor_7965fd2f3594f3cd)
}

var fileDescriptor_7965fd2f3594f3cd = []byte{
