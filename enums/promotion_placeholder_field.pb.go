...
func (PromotionPlaceholderFieldEnum_PromotionPlaceholderField) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_6ebc27f789789fbe, []int{0, 0}
}
...
func (*PromotionPlaceholderFieldEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_6ebc27f789789fbe, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/promotion_placeholder_field.proto", fileDescriptor_6ebc27f789789fbe)
}

var fileDescriptor_6ebc27f789789fbe = []byte{
