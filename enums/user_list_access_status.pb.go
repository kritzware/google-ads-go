...
func (UserListAccessStatusEnum_UserListAccessStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_3251513cff47d0e6, []int{0, 0}
}
...
func (*UserListAccessStatusEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_3251513cff47d0e6, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/user_list_access_status.proto", fileDescriptor_3251513cff47d0e6)
}

var fileDescriptor_3251513cff47d0e6 = []byte{
