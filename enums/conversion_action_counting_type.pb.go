...
func (ConversionActionCountingTypeEnum_ConversionActionCountingType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_08e0308733589fad, []int{0, 0}
}
...
func (*ConversionActionCountingTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_08e0308733589fad, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/conversion_action_counting_type.proto", fileDescriptor_08e0308733589fad)
}

var fileDescriptor_08e0308733589fad = []byte{
