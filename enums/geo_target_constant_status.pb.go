...
func (GeoTargetConstantStatusEnum_GeoTargetConstantStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_d4b14155902182d3, []int{0, 0}
}
...
func (*GeoTargetConstantStatusEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_d4b14155902182d3, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/geo_target_constant_status.proto", fileDescriptor_d4b14155902182d3)
}

var fileDescriptor_d4b14155902182d3 = []byte{
