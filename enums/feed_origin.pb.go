...
func (FeedOriginEnum_FeedOrigin) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_f14d4faf433a4bcf, []int{0, 0}
}
...
func (*FeedOriginEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_f14d4faf433a4bcf, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/feed_origin.proto", fileDescriptor_f14d4faf433a4bcf)
}

var fileDescriptor_f14d4faf433a4bcf = []byte{
