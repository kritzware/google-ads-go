...
func (KeywordPlanCompetitionLevelEnum_KeywordPlanCompetitionLevel) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_ec400840a79d2b5d, []int{0, 0}
}
...
func (*KeywordPlanCompetitionLevelEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_ec400840a79d2b5d, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/keyword_plan_competition_level.proto", fileDescriptor_ec400840a79d2b5d)
}

var fileDescriptor_ec400840a79d2b5d = []byte{
