...
func (ConversionAttributionEventTypeEnum_ConversionAttributionEventType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_1370839fa3f1b6a1, []int{0, 0}
}
...
func (*ConversionAttributionEventTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_1370839fa3f1b6a1, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/conversion_attribution_event_type.proto", fileDescriptor_1370839fa3f1b6a1)
}

var fileDescriptor_1370839fa3f1b6a1 = []byte{
