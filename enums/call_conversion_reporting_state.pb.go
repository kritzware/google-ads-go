...
func (CallConversionReportingStateEnum_CallConversionReportingState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_4b610740b7ec432e, []int{0, 0}
}
...
func (*CallConversionReportingStateEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_4b610740b7ec432e, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/call_conversion_reporting_state.proto", fileDescriptor_4b610740b7ec432e)
}

var fileDescriptor_4b610740b7ec432e = []byte{
