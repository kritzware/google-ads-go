...
func (HotelDateSelectionTypeEnum_HotelDateSelectionType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_17699a09a8cbc4ef, []int{0, 0}
}
...
func (*HotelDateSelectionTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_17699a09a8cbc4ef, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/hotel_date_selection_type.proto", fileDescriptor_17699a09a8cbc4ef)
}

var fileDescriptor_17699a09a8cbc4ef = []byte{
