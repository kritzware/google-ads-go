...
func (MinuteOfHourEnum_MinuteOfHour) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_6fe6a52b8d440c39, []int{0, 0}
}
...
func (*MinuteOfHourEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_6fe6a52b8d440c39, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/minute_of_hour.proto", fileDescriptor_6fe6a52b8d440c39)
}

var fileDescriptor_6fe6a52b8d440c39 = []byte{
