...
func (SpendingLimitTypeEnum_SpendingLimitType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_20b19bf67fa40c4b, []int{0, 0}
}
...
func (*SpendingLimitTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_20b19bf67fa40c4b, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/spending_limit_type.proto", fileDescriptor_20b19bf67fa40c4b)
}

var fileDescriptor_20b19bf67fa40c4b = []byte{
