...
func (UserInterestTaxonomyTypeEnum_UserInterestTaxonomyType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_e04e3d2df213d8eb, []int{0, 0}
}
...
func (*UserInterestTaxonomyTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_e04e3d2df213d8eb, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/user_interest_taxonomy_type.proto", fileDescriptor_e04e3d2df213d8eb)
}

var fileDescriptor_e04e3d2df213d8eb = []byte{
