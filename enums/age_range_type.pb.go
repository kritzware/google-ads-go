...
func (AgeRangeTypeEnum_AgeRangeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_636b7035419aa909, []int{0, 0}
}
...
func (*AgeRangeTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_636b7035419aa909, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/age_range_type.proto", fileDescriptor_636b7035419aa909)
}

var fileDescriptor_636b7035419aa909 = []byte{
