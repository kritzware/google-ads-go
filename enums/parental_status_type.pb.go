...
func (ParentalStatusTypeEnum_ParentalStatusType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_c10372a54aefea7c, []int{0, 0}
}
...
func (*ParentalStatusTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_c10372a54aefea7c, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/parental_status_type.proto", fileDescriptor_c10372a54aefea7c)
}

var fileDescriptor_c10372a54aefea7c = []byte{
