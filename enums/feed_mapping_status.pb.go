...
func (FeedMappingStatusEnum_FeedMappingStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_c2678841868d2762, []int{0, 0}
}
...
func (*FeedMappingStatusEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_c2678841868d2762, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/feed_mapping_status.proto", fileDescriptor_c2678841868d2762)
}

var fileDescriptor_c2678841868d2762 = []byte{
