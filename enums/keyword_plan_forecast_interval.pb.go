...
func (KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_3006cd39703dad17, []int{0, 0}
}
...
func (*KeywordPlanForecastIntervalEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_3006cd39703dad17, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/keyword_plan_forecast_interval.proto", fileDescriptor_3006cd39703dad17)
}

var fileDescriptor_3006cd39703dad17 = []byte{
