...
func (AppPlaceholderFieldEnum_AppPlaceholderField) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_ef3f89b96bd0a735, []int{0, 0}
}
...
func (*AppPlaceholderFieldEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_ef3f89b96bd0a735, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/app_placeholder_field.proto", fileDescriptor_ef3f89b96bd0a735)
}

var fileDescriptor_ef3f89b96bd0a735 = []byte{
