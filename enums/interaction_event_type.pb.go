...
func (InteractionEventTypeEnum_InteractionEventType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_f32c9387d1a46d03, []int{0, 0}
}
...
func (*InteractionEventTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_f32c9387d1a46d03, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/interaction_event_type.proto", fileDescriptor_f32c9387d1a46d03)
}

var fileDescriptor_f32c9387d1a46d03 = []byte{
