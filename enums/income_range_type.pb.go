...
func (IncomeRangeTypeEnum_IncomeRangeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_5a68246aed0e9c27, []int{0, 0}
}
...
func (*IncomeRangeTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_5a68246aed0e9c27, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/income_range_type.proto", fileDescriptor_5a68246aed0e9c27)
}

var fileDescriptor_5a68246aed0e9c27 = []byte{
