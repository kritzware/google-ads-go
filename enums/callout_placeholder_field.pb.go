...
func (CalloutPlaceholderFieldEnum_CalloutPlaceholderField) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_19cbecbc7acebccf, []int{0, 0}
}
...
func (*CalloutPlaceholderFieldEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_19cbecbc7acebccf, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/callout_placeholder_field.proto", fileDescriptor_19cbecbc7acebccf)
}

var fileDescriptor_19cbecbc7acebccf = []byte{
