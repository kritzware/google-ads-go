...
func (UserListRuleTypeEnum_UserListRuleType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_ab6bdc6957d77178, []int{0, 0}
}
...
func (*UserListRuleTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_ab6bdc6957d77178, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/user_list_rule_type.proto", fileDescriptor_ab6bdc6957d77178)
}

var fileDescriptor_ab6bdc6957d77178 = []byte{
