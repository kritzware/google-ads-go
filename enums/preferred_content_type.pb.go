...
func (PreferredContentTypeEnum_PreferredContentType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_77aec66b6fddff76, []int{0, 0}
}
...
func (*PreferredContentTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_77aec66b6fddff76, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/preferred_content_type.proto", fileDescriptor_77aec66b6fddff76)
}

var fileDescriptor_77aec66b6fddff76 = []byte{
