...
func (UserListTypeEnum_UserListType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_10990db22a045937, []int{0, 0}
}
...
func (*UserListTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_10990db22a045937, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/user_list_type.proto", fileDescriptor_10990db22a045937)
}

var fileDescriptor_10990db22a045937 = []byte{
