...
func (WebpageConditionOperandEnum_WebpageConditionOperand) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_bb30d5cf3c48daa9, []int{0, 0}
}
...
func (*WebpageConditionOperandEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_bb30d5cf3c48daa9, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/webpage_condition_operand.proto", fileDescriptor_bb30d5cf3c48daa9)
}

var fileDescriptor_bb30d5cf3c48daa9 = []byte{
