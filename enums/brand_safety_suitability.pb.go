...
func (BrandSafetySuitabilityEnum_BrandSafetySuitability) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_74afa050660274a2, []int{0, 0}
}
...
func (*BrandSafetySuitabilityEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_74afa050660274a2, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/brand_safety_suitability.proto", fileDescriptor_74afa050660274a2)
}

var fileDescriptor_74afa050660274a2 = []byte{
