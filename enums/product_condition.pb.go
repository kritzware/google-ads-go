...
func (ProductConditionEnum_ProductCondition) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_c9e1b701be07f340, []int{0, 0}
}
...
func (*ProductConditionEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_c9e1b701be07f340, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/product_condition.proto", fileDescriptor_c9e1b701be07f340)
}

var fileDescriptor_c9e1b701be07f340 = []byte{
