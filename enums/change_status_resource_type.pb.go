...
func (ChangeStatusResourceTypeEnum_ChangeStatusResourceType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_01a72a15c4339408, []int{0, 0}
}
...
func (*ChangeStatusResourceTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_01a72a15c4339408, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/change_status_resource_type.proto", fileDescriptor_01a72a15c4339408)
}

var fileDescriptor_01a72a15c4339408 = []byte{
