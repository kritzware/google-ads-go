...
func (MimeTypeEnum_MimeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_9bdfbc65c31746be, []int{0, 0}
}
...
func (*MimeTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_9bdfbc65c31746be, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/mime_type.proto", fileDescriptor_9bdfbc65c31746be)
}

var fileDescriptor_9bdfbc65c31746be = []byte{
