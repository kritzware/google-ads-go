...
func (RealEstatePlaceholderFieldEnum_RealEstatePlaceholderField) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_c04d0eb05cf0a60d, []int{0, 0}
}
...
func (*RealEstatePlaceholderFieldEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_c04d0eb05cf0a60d, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/real_estate_placeholder_field.proto", fileDescriptor_c04d0eb05cf0a60d)
}

var fileDescriptor_c04d0eb05cf0a60d = []byte{
