...
func (ProductTypeLevelEnum_ProductTypeLevel) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_e043cc8b365cce4a, []int{0, 0}
}
...
func (*ProductTypeLevelEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_e043cc8b365cce4a, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/product_type_level.proto", fileDescriptor_e043cc8b365cce4a)
}

var fileDescriptor_e043cc8b365cce4a = []byte{
