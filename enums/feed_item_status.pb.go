...
func (FeedItemStatusEnum_FeedItemStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_78ca1db834374f34, []int{0, 0}
}
...
func (*FeedItemStatusEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_78ca1db834374f34, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v0/enums/feed_item_status.proto", fileDescriptor_78ca1db834374f34)
}
